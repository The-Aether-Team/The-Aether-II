...
[![CircleCI](https://circleci.com/gh/The-Aether-Team/The-Aether-II/tree/1.21.11-develop.svg?style=shield)](https://app.circleci.com/pipelines/github/The-Aether-Team/The-Aether-II?branch=1.21.11-develop)
### Release builds
...
repositories {
  ...
  maven { url = "https://packages.aether-mod.net/The-Aether-II" }
}
```
...
[![Code license (LGPL v3.0)](https://img.shields.io/badge/code%20license-LGPL%20v3.0-green.svg?style=flat-square)](https://github.com/The-Aether-Team/The-Aether-II/blob/1.21.11-develop/LICENSE.txt)
...
All of our code contribution credits can be found [here](https://github.com/The-Aether-Team/The-Aether-II/blob/1.21.11-develop/docs/CREDITS.txt). If you contributed to the project and do not see your name, please contact us.
