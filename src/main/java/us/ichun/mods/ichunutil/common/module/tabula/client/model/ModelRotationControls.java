...
public class ModelRotationControls extends ModelBase
{
	...
	public ModelRotationControls()
	{
		...
		this.setRotateAngle(this.shape1_2, 0.0F, 3.141592653589793F, 0.0F);
		this.shape1_1 = new ModelRenderer(this, 0, 0);
		this.shape1_1.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.shape1_1.addBox(-2.5F, -0.5F, 5.04F, 5, 1, 1, 0.0F);
		this.setRotateAngle(this.shape1_1, 0.0F, 2.356194490192345F, 0.0F);
		...
		this.setRotateAngle(this.shape1_7, 0.0F, 0.7853981633974483F, 0.0F);
		...
		this.setRotateAngle(this.shape1_6, 0.0F, 1.5707963267948966F, 0.0F);
		...
		this.setRotateAngle(this.shape1_5, 0.0F, 5.497787143782138F, 0.0F);
		...
		this.setRotateAngle(this.shape1_4, 0.0F, 4.71238898038469F, 0.0F);
		...
		this.setRotateAngle(this.shape1_3, 0.0F, 3.9269908169872414F, 0.0F);
	...
	public void destroy()
	{
		if (ModelRendererAccessor.isCompiled(this.shape1))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1);
		}
		if (ModelRendererAccessor.isCompiled(this.shape1_1))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1_1);
		}
		if (ModelRendererAccessor.isCompiled(this.shape1_2))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1_2);
		}
		if (ModelRendererAccessor.isCompiled(this.shape1_3))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1_3);
		}
		if (ModelRendererAccessor.isCompiled(this.shape1_4))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1_4);
		}
		if (ModelRendererAccessor.isCompiled(this.shape1_5))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1_5);
		}
		if (ModelRendererAccessor.isCompiled(this.shape1_6))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1_6);
		}
		if (ModelRendererAccessor.isCompiled(this.shape1_7))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape1_7);
		}
	}
}
