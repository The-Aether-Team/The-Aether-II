...
public class ModelSizeControls extends ModelBase
{
	...
	public ModelSizeControls()
	{
		...
		this.setRotateAngle(this.shape2_1, 1.0471975511965976F, 1.5707963267948966F, 0.0F);
		...
		this.setRotateAngle(this.shape2, 1.0471975511965976F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.shape2_3, 1.0471975511965976F, 4.71238898038469F, 0.0F);
		...
		this.setRotateAngle(this.shape2_2, 1.0471975511965976F, 3.141592653589793F, 0.0F);
	...
	public void destroy()
	{
		...
		if (ModelRendererAccessor.isCompiled(this.shape2))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape2);
		}
		if (ModelRendererAccessor.isCompiled(this.shape2_1))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape2_1);
		}
		if (ModelRendererAccessor.isCompiled(this.shape2_2))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape2_2);
		}
		if (ModelRendererAccessor.isCompiled(this.shape2_3))
		{
			ModelRendererAccessor.deleteDisplayLists(this.shape2_3);
		}
	}
}
