...
public class AetherIIDataAttachments {
    ...
    // Living
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<DamageSystemAttachment>> DAMAGE_SYSTEM = ATTACHMENTS.register("damage_system", () -> AttachmentType.serializable(DamageSystemAttachment::new).build());
