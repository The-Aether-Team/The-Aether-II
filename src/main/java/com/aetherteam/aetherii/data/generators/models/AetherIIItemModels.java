...
public class AetherIIItemModels extends AetherIIItemModelSubProvider {
    ...
    public void run() {
        ...
        this.generateFlatItem(AetherIIItems.BUTTERFLY_SPAWN_EGG.get(), ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(AetherIIItems.BEETLE_SPAWN_EGG.get(), ModelTemplates.FLAT_ITEM);
