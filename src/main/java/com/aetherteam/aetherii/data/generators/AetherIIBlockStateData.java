...
public class AetherIIBlockStateData extends AetherIIBlockStateProvider {
    ...
    public void registerStatesAndModels() {
        ...
        // Arctic
        this.block(AetherIIBlocks.ARCTIC_SNOW_BLOCK.get(), AetherIIBlocks.ARCTIC_SNOW.get());
        this.snowLayer(AetherIIBlocks.ARCTIC_SNOW.get(), AetherIIBlocks.ARCTIC_SNOW.get());
        ...
        // Grasses
        this.shortGrass(AetherIIBlocks.SHORT_AETHER_GRASS.get());
        this.shortGrass(AetherIIBlocks.MEDIUM_AETHER_GRASS.get());
        this.shortGrass(AetherIIBlocks.TALL_AETHER_GRASS.get());
        ...
        // Bushes
        this.bush(AetherIIBlocks.AETHER_BUSH.get());
        ...
        // Potted Bushes
        this.pottedBush(AetherIIBlocks.POTTED_AETHER_BUSH.get(), "natural/");
