...
public class AetherIIBlockLoot extends AetherIIBlockLootSubProvider {
    ...
    public void generate() {
        ...
        this.add(AetherIIBlocks.CRUDE_SCATTERGLASS.get(), block -> this.createSingleItemTableWithSilkTouch(block, AetherIIItems.SCATTERGLASS_SHARD.get(), UniformGenerator.between(1.0F, 2.0F)));
        ...
        this.add(AetherIIBlocks.BRYALINN_MOSS_VINES.get(), (block) -> createShearsOnlyDrop(block));
        ...
        // Arctic
        this.add(AetherIIBlocks.ARCTIC_SNOW_BLOCK.get(), block -> this.createSingleItemTableWithSilkTouch(block, AetherIIItems.ARCTIC_SNOWBALL.get(), ConstantValue.exactly(4.0F)));
        ...
        this.add(AetherIIBlocks.SHAYELINN_MOSS_VINES.get(), (block) -> createShearsOnlyDrop(block));
        ...
        this.add(AetherIIBlocks.AMBRELINN_MOSS_VINES.get(), (block) -> createShearsOnlyDrop(block));
        ...
        this.add(AetherIIBlocks.AMBEROOT_DEPOSIT.get(), (wood) -> this.droppingAmberoot(wood, AetherIIBlocks.AMBEROOT_LOG.get(), AetherIIItems.GOLDEN_AMBER.get()));
        ...
        // Grasses
        this.add(AetherIIBlocks.SHORT_AETHER_GRASS.get(), (block) -> createShearsOnlyDrop(block));
        this.add(AetherIIBlocks.MEDIUM_AETHER_GRASS.get(), (block) -> createShearsOnlyDrop(block));
        this.add(AetherIIBlocks.TALL_AETHER_GRASS.get(), (block) -> createShearsOnlyDrop(block));
        this.add(AetherIIBlocks.AETHER_FERN.get(), (block) -> createShearsOnlyDrop(block));
        this.add(AetherIIBlocks.SHIELD_FERN.get(), (block) -> createShearsOnlyDrop(block));
        ...
        this.add(AetherIIBlocks.BLADE_POA.get(), (block) -> createShearsOnlyDrop(block));
        ...
        this.add(AetherIIBlocks.AMBROSIUM_CAMPFIRE.get(), (block) -> this.createSilkTouchDispatchTable(block, this.applyExplosionCondition(block, LootItem.lootTableItem(AetherIIItems.AMBROSIUM_SHARD.get()).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))));
