...
public class AetherIIBlockLoot extends AetherIIBlockLootSubProvider {
    ...
    public void generate() {
        ...
        this.add(AetherIIBlocks.AMBEROOT_LEAVES.get(), (leaves) -> this.droppingWithChancesAndSkyrootSticksWithLizard(leaves, AetherIIBlocks.AMBEROOT_SAPLING.get(), BlockLootAccessor.aether_ii$getNormalLeavesSaplingChances()));
        ...
        this.dropSelf(AetherIIBlocks.GUARDIAN_CORTEX.get());
        this.dropSelf(AetherIIBlocks.BASE_GUARDIAN_CORTEX_WOOD.get());
        ...
        this.dropSelf(AetherIIBlocks.INFECTED_CORTEX.get());
        this.dropSelf(AetherIIBlocks.BASE_INFECTED_CORTEX_WOOD.get());
        ...
        this.dropWhenSilkTouch(AetherIIBlocks.ROTTEN_UNDERGROWTH_VINES.get());
        ...
        this.dropNone(AetherIIBlocks.CLOUDWOOL_BEDROLL.get());
