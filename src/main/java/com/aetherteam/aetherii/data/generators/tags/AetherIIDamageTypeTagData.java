...
public class AetherIIDamageTypeTagData extends KeyTagProvider<DamageType> {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(DamageTypeTags.NO_KNOCKBACK).add(AetherIIDamageTypes.PLAYER_AOE_NO_KNOCKBACK, AetherIIDamageTypes.WOUND, AetherIIDamageTypes.FRACTURE, AetherIIDamageTypes.TOXIN, AetherIIDamageTypes.VENOM, AetherIIDamageTypes.IMMOLATION, AetherIIDamageTypes.ALKAHEST);
