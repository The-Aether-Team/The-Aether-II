...
public class AetherIIBlockTagData extends BlockTagsProvider {
    public AetherIIBlockTagData(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, ExistingFileHelper existingFileHelper) {
    ...
    public void addTags(HolderLookup.Provider provider) {
        new AetherIIBlockItemTagProvider() {
            ...
            protected AetherIIBlockItemTagProvider.BlockTagAppender tag(TagKey<Block> blockKey, TagKey<Item> itemKey) {
                return new AetherIIBlockItemTagProvider.BlockTagAppender(AetherIIBlockTagData.this.getOrCreateRawBuilder(blockKey));
            }
        }.run();
        ...
        this.tag(AetherIITags.Blocks.GRAVITITE_ABILITY_BLACKLIST).add(
                ...
                commonBlockTag("relocation_not_supported")
        );
        ...
        this.tag(minecraftBlockTag("prevents_nearby_leaf_decay")).add(
                AetherIIBlocks.WOVEN_SKYROOT_STICKS.get()
        );
        this.tag(BlockTags.DIRT).addTags(
                AetherIITags.Blocks.AETHER_DIRT
        );
        this.tag(minecraftBlockTag("moss_blocks")).addTags(
                AetherIITags.Blocks.AETHER_MOSS_BLOCKS
        );
        this.tag(minecraftBlockTag("grass_blocks")).addTags(
                AetherIITags.Blocks.AETHER_GRASS_BLOCKS
        );
        this.tag(minecraftBlockTag("bars")).addTags(
                AetherIITags.Blocks.ARKENIUM_BARS
        );
        ...
        this.tag(minecraftBlockTag("bee_attractive")).add(
        ...
        this.tag(minecraftBlockTag("edible_for_sheep")).add(
                AetherIIBlocks.SHORT_AETHER_GRASS.get(),
                AetherIIBlocks.MEDIUM_AETHER_GRASS.get(),
                AetherIIBlocks.TALL_AETHER_GRASS.get(),
                AetherIIBlocks.AETHER_FERN.get()
        );
        this.tag(minecraftBlockTag("can_glide_through")).add(
                AetherIIBlocks.SKYROOT_LADDER.get(),
                AetherIIBlocks.BRYALINN_MOSS_VINES.get(),
                AetherIIBlocks.SHAYELINN_MOSS_VINES.get(),
                AetherIIBlocks.AMBRELINN_MOSS_VINES.get(),
        ...
        this.tag(minecraftBlockTag("happy_ghast_avoids")).add(
        ...
        this.tag(minecraftBlockTag("supports_vegetation")).add(
                AetherIIBlocks.AETHER_FARMLAND.get()
        );
        this.tag(minecraftBlockTag("supports_crops")).add(
                AetherIIBlocks.AETHER_FARMLAND.get()
        );
        this.tag(minecraftBlockTag("supports_sugar_cane_adjacently")).add(
                AetherIIBlocks.FROSTED_ICE.get(),
                AetherIIBlocks.FROSTED_ARCTIC_ICE.get()
        );
        this.tag(minecraftBlockTag("supports_lily_pad")).add(
                AetherIIBlocks.ARCTIC_ICE.get(),
                AetherIIBlocks.FROSTED_ICE.get(),
                AetherIIBlocks.FROSTED_ARCTIC_ICE.get()
        );
        this.tag(minecraftBlockTag("cannot_support_snow_layer")).add(
                AetherIIBlocks.WOVEN_SKYROOT_STICKS.get(),
                AetherIIBlocks.ICESTONE.get(),
                AetherIIBlocks.ARCTIC_ICE.get(),
                AetherIIBlocks.FRAGILE_ARCTIC_ICE.get(),
        ...
        this.tag(minecraftBlockTag("overrides_mushroom_light_requirement")).add(
                AetherIIBlocks.MYCELIAL_AETHER_DIRT.get(),
                AetherIIBlocks.FERROSITE_SAND.get(),
                AetherIIBlocks.FERROSITE_MUD.get(),
                AetherIIBlocks.GUARDIAN_ROOTS.get()
        ...
        this.tag(minecraftBlockTag("grows_crops")).add(
                AetherIIBlocks.AETHER_FARMLAND.get()
        );
        ...
        // Common
        this.tag(commonBlockTag("relocation_not_supported"));
        this.tag(commonBlockTag("natural_logs")).addTags(
                AetherIITags.Blocks.AETHER_NATURAL_LOGS
        );
        this.tag(commonBlockTag("villager_farmlands")).add(
                AetherIIBlocks.AETHER_FARMLAND.get()
        );
    }
