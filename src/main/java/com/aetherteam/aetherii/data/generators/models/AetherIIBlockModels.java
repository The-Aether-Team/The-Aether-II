...
public class AetherIIBlockModels extends AetherIIBlockModelSubProvider {
    ...
    public void run() {
        ...
        this.createBarsAndItem(AetherIIBlocks.ARKENIUM_BARS.get());
        this.createBarsAndItem(AetherIIBlocks.FLORAL_ARKENIUM_BARS.get());
        this.createBarsAndItem(AetherIIBlocks.PATTERNED_ARKENIUM_BARS.get());
        this.createBarsAndItem(AetherIIBlocks.CURVED_ARKENIUM_BARS.get());
