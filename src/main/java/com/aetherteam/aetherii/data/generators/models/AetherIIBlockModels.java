...
public class AetherIIBlockModels extends AetherIIBlockModelSubProvider {
    ...
    public void run() {
        ...
        this.createBarsWithDifferentEdge(AetherIIBlocks.ARKENIUM_BARS.get(), AetherIIBlocks.ARKENIUM_BARS.get(), "_edge");
        ...
        this.createBarsWithDifferentEdge(AetherIIBlocks.CURVED_ARKENIUM_BARS.get(), AetherIIBlocks.CURVED_ARKENIUM_BARS.get(), "");
