...
Movement faster than sneaking will alert Crystaline type mobs.""");
    ...
    private void addSubtitles() {
        ...
        this.addSubtitle("entity", "detonation_sentry.ambient", "Detonation Sentry rattles");
    ...
    public void addSpawnEggItem(RegistryObject<? extends SpawnEggItem> key, String name) {
        this.addItem(key, name);
    }

    public void addSpawnEggItem(RegistryObject<? extends SpawnEggItem> key) {
        String id = key.getId().getPath().replace("_spawn_egg", "");
        this.add(key.get(), this.entityTypes.get(id).concat(" Spawn Egg"));
    }

    public void addMuralTitle(RegistryObject<Mural> key, String title) {
