...
public class AetherIILanguageData extends AetherIILanguageProvider {
    ...
    private void addAdvancements() {
        ...
        this.addAdvancementDesc("cloud_skiff", "Craft a Cloud Skiff for better movement on the Cloud Sea");
        this.addAdvancementDesc("aercloud_glider", "Craft an Aercloud Glider for better mid-air movement");
        ...
        this.addAdvancementDesc("skyroot_lizard", "Stab a Skyroot Lizard on a Skyroot Stick");
        ...
        this.addAdvancementDesc("glint", "Earn at least 64 Glint Coins");
