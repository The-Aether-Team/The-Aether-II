...
public class AetherIIChestLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.CHESTS_DUNGEONS_MUSIC_DISCS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_AETHER_TUNE))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_ASCENDING_DAWN))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_AERWHALE))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_APPROACHES))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_DEMISE))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_CHINCHILLA))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_HIGH))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_REVOLUTIONS))
                        .add(LootItem.lootTableItem(AetherIIItems.COMPACT_DISC_CHASE))
                )
        );
