    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.CHESTS_CAMP_FARMER, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.HOLYSTONE_TROWEL).setWeight(6))
        ...
        builder.accept(AetherIILoot.CHESTS_WATCHTOWER, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_WATCHTOWER_CROSSBOW))
        ...
        builder.accept(AetherIILoot.CHESTS_WATCHTOWER_CROSSBOW, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SCATTERGLASS_SHARD).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_GEMSTONE))
                )
        ...
        builder.accept(AetherIILoot.CHESTS_DUNGEONS_SENTRY_RUINS_COMMON, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 6.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.ARKENIUM_PLATE).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
        ...
        builder.accept(AetherIILoot.CHESTS_DUNGEONS_SENTRY_RUINS_MATERIAL_DEPOSIT, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 4.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_GEMSTONE).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.CORROBONITE_CRYSTAL).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ARKENIUM_PLATE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.GLINT_GEMSTONE))
        ...
        builder.accept(AetherIILoot.CHESTS_DUNGEONS_SENTRY_RUINS_COLD_STORAGE, LootTable.lootTable()
                ...
                .add(LootItem.lootTableItem(AetherIIItems.CORROBONITE_CRYSTAL).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                .add(LootItem.lootTableItem(AetherIIItems.ARKENIUM_PLATE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                .add(LootItem.lootTableItem(AetherIIItems.GLINT_GEMSTONE))
                .add(LootItem.lootTableItem(AetherIIItems.GRAVITITE_PLATE).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                )
        );
