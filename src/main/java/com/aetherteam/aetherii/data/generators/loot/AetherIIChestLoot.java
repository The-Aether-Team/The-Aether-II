    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.VASES_VERADEXIAN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.CRYSTAL_WING).setWeight(13).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
        ...
        builder.accept(AetherIILoot.CHESTS_VERADEXIAN_LIBRARY, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.CRYSTAL_WING))
                )
        ...
        builder.accept(AetherIILoot.CHESTS_VERADEXIAN_LIBRARY_VAULTS, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.CRYSTAL_WING).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
        ...
        builder.accept(AetherIILoot.VASES_BREXALLEN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.CRYSTAL_WING).setWeight(12).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
        ...
        builder.accept(AetherIILoot.CHESTS_BREXALLEN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 6.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.AMBROSIUM_SHARD).setWeight(10).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIBlocks.AMBROSIUM_TORCH).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.CRYSTAL_WING).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIBlocks.ICESTONE).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AetherIIItems.GLINT_COIN).setWeight(12).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_PENDANT).setWeight(6))
