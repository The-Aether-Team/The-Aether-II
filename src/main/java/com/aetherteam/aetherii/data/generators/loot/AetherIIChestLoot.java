    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.VASES_UNDERCLOUD_MINESHAFT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.FOSSILIZED_ZANITE).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.CRYSTAL_WING).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.CLOUDTWINE).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.COCKATRICE_FEATHER).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.ENCHANTED_SWET_JELLY).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ENCHANTED_BLUEBERRY).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.FOSSILIZED_GLINT).setWeight(4))
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIBlocks.AMBROSIUM_TORCH).setWeight(12).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.AMBROSIUM_SHARD).setWeight(9).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIBlocks.ICESTONE).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.FOSSILIZED_ZANITE).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.CRYSTAL_WING).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                )
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AetherIIItems.GLINT_COIN).setWeight(16).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 3.0F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_PENDANT).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.SKYROOT_WATER_BUCKET).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.COLD_AERCLOUD_GLIDER).setWeight(2))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_DUNGEONS_MUSIC_DISCS))
                )
