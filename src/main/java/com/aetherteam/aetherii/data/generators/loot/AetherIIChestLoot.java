    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.VASES_VERADEXIAN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(8).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.6F, 0.9F))))
        ...
        builder.accept(AetherIILoot.VASES_BREXALLEN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(8).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.2F, 0.7F))))
        ...
        builder.accept(AetherIILoot.CHESTS_BREXALLEN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 6.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(3).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.15F, 0.8F))))
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_PENDANT).setWeight(4))
        ...
        builder.accept(AetherIILoot.VASES_UNDERCLOUD_MINESHAFT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(4).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.2F, 0.7F))))
                        .add(LootItem.lootTableItem(AetherIIItems.FOSSILIZED_GLINT).setWeight(4))
        ...
        builder.accept(AetherIILoot.VASES_ANCIENT_HENGE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(15).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.3F, 0.9F))))
