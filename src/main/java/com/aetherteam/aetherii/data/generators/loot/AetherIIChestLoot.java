    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.CHESTS_DUNGEONS_SENTRY_RUINS_RARE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE_HELMET).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE_CHESTPLATE).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE_LEGGINGS).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE_BOOTS).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE_GLOVES).setWeight(2))
        ...
        builder.accept(AetherIILoot.CHESTS_DUNGEONS_SENTRY_RUINS_MATERIAL_DEPOSIT, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_GEMSTONE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
