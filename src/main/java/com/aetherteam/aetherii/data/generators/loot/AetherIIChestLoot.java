...
public class AetherIIChestLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.CHESTS_VERADEXIAN_LIBRARY_ABANDONED_BAGS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 4.0F))
                        .add(LootItem.lootTableItem(AetherIIBlocks.AMBROSIUM_TORCH).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 4.0F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SCATTERGLASS_BOLT).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.BEAST_PELT_BUNDLE))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.BLUEBERRY).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ORANGE).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.WYNDBERRY).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
        ...
        builder.accept(AetherIILoot.CHESTS_VERADEXIAN_LIBRARY_COCKATRICE_NESTS, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 2.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_SHORTSWORD))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_PIKE))
