    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.VASES_VERADEXIAN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(11).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.05F, 0.15F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.4F, 0.7F))))
                )
        );
        builder.accept(AetherIILoot.CHESTS_VERADEXIAN_LIBRARY, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SKYROOT_BUCKET))
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.05F, 0.2F))))
                )
        ...
        builder.accept(AetherIILoot.CHESTS_VERADEXIAN_LIBRARY_VAULTS, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(2).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.1F, 0.3F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.3F, 0.5F))))
                )
        );
        ...
        builder.accept(AetherIILoot.VASES_BREXALLEN_RUINS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(8).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.2F, 0.4F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.6F, 0.8F))))
                )
        );
        builder.accept(AetherIILoot.CHESTS_BREXALLEN_RUINS, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(5).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.2F, 0.4F))))
        ...
        builder.accept(AetherIILoot.VASES_UNDERCLOUD_MINESHAFT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.CLOUDTWINE).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.COCKATRICE_FEATHER).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(5).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.15F, 0.4F))))
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.RESONANT_STONE).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_PENDANT).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(2).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.15F, 0.4F))))
                        .add(LootItem.lootTableItem(AetherIIItems.SKYROOT_WATER_BUCKET))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_DUNGEONS_MUSIC_DISCS))
                )
        ...
        builder.accept(AetherIILoot.VASES_ANCIENT_HENGE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SHIFTING_GLASS).setWeight(10).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.25F, 0.5F))))
