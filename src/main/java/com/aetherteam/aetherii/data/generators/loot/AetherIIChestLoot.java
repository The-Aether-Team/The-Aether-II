...
public class AetherIIChestLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> builder) {
        ...
        builder.accept(AetherIILoot.CHESTS_WATCHTOWER, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherIIBlocks.BRETTL_ROPE).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
        ...
        builder.accept(AetherIILoot.VASES_UNDERCLOUD_MINESHAFT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIBlocks.BRETTL_ROPE).setWeight(9).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_STORAGE))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_SUPPLIES))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_EQUIPMENT))
                )
        );
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_STORAGE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SCATTERGLASS_SHARD).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIBlocks.HOLYSTONE_ROCK).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.AMBROSIUM_SHARD).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
                        .add(LootItem.lootTableItem(AetherIIBlocks.ICESTONE).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.FOSSILIZED_ZANITE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIBlocks.ICHORITE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_SUPPLIES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SATIVAL_BULB).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.BLUEBERRY).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ORANGE).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.WYNDBERRY).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                )

                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIBlocks.BRETTL_ROPE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.CLOUDTWINE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.BEAST_PELT).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                )

                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 1.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.BANDAGE))
                        .add(LootItem.lootTableItem(AetherIIItems.SPLINT))
                        .add(LootItem.lootTableItem(AetherIIItems.ANTIVENOM_VIAL))
                )

                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(2))
                        .add(LootItem.lootTableItem(AetherIIBlocks.AMBROSIUM_TORCH).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
                        .add(LootItem.lootTableItem(AetherIIBlocks.RUSTIC_ARKENIUM_LANTERN))
                        .add(LootItem.lootTableItem(AetherIIBlocks.CLOUDWOOL_BEDROLL))
                )
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_EQUIPMENT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE).setWeight(12).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.HOLYSTONE_SHORTSWORD).setWeight(5))
                        .add(LootItem.lootTableItem(AetherIIItems.HOLYSTONE_PIKE).setWeight(5))
                        .add(LootItem.lootTableItem(AetherIIItems.HOLYSTONE_HAMMER).setWeight(5))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_GEMSTONE).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_PICKAXE).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_PENDANT))
                        .add(LootItem.lootTableItem(AetherIIItems.ICESTONE_PENDANT))
                )
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.COLD_AERCLOUD_GLIDER).setWeight(4))
                        .add(LootItem.lootTableItem(AetherIIItems.PURPLE_AERCLOUD_GLIDER).setWeight(2))
                        .add(LootItem.lootTableItem(AetherIIItems.BLUE_AERCLOUD_GLIDER).setWeight(2))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.AMBROSIUM_SHARD).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.GOLDEN_AMBER).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.SWET_GEL).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                )
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_BRIDGES_BASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 4.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.GOLDEN_AMBER).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(Items.QUARTZ).setWeight(2).apply(SetComponentsFunction.setComponent(DataComponents.ITEM_NAME, Component.translatable("item.aether_ii.aether_quartz"))).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE).setWeight(12).apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 6.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.HOLYSTONE_SHORTSWORD).setWeight(5))
                        .add(LootItem.lootTableItem(AetherIIItems.HOLYSTONE_PIKE).setWeight(5))
                        .add(LootItem.lootTableItem(AetherIIItems.HOLYSTONE_HAMMER).setWeight(5))
                        .add(LootItem.lootTableItem(AetherIIItems.ZANITE_GEMSTONE).setWeight(2))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SWET_JELLY).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.BLUEBERRY).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ORANGE).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.WYNDBERRY).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                )
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_BRIDGES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_BRIDGES_BASE))
                )
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_RARE)
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_BRIDGES_TREASURE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(NestedLootTable.lootTableReference(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_BRIDGES_BASE))
                )
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_RARE, LootTable.lootTable()
                .withPool(
                        LootPool.lootPool()
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_ABANDONED_BAGS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 4.0F))
                        .add(LootItem.lootTableItem(AetherIIBlocks.AMBROSIUM_TORCH).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.AMBROSIUM_SHARD).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.SCATTERGLASS_BOLT).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 4.0F))))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.BURRUKAI_PLATE_SHIELD))
                )

                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SATIVAL_BULB).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.BLUEBERRY).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.ORANGE).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.WYNDBERRY).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.HEALING_STONE).apply(SetComponentsFunction.setComponent(AetherIIDataComponents.HEALING_STONE_CHARGES.get(), 1)))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherIIItems.SCATTERGLASS_VIAL).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.WATER_VIAL).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIItems.VALKYRIE_TEA))
                        .add(LootItem.lootTableItem(AetherIIItems.ANTIVENOM_VIAL))
                        .add(LootItem.lootTableItem(AetherIIItems.SKYROOT_BUCKET))
                        .add(LootItem.lootTableItem(AetherIIItems.SKYROOT_WATER_BUCKET))
                )
        ...
        builder.accept(AetherIILoot.CHESTS_UNDERCLOUD_MINESHAFT_COCKATRICE_NESTS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 6.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherIIItems.SKYROOT_STICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherIIBlocks.SKYROOT_TWIG).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherIIBlocks.HOLYSTONE_ROCK).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                )
