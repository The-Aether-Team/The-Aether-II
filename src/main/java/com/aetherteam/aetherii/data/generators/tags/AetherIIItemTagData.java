...
public class AetherIIItemTagData extends ItemTagsProvider {
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        this.copy(AetherIITags.Blocks.HOLYSTONE_MASONRY_BLOCKS, AetherIITags.Items.HOLYSTONE_MASONRY_BLOCKS);
        this.copy(AetherIITags.Blocks.AGIOSITE_MASONRY_BLOCKS, AetherIITags.Items.AGIOSITE_MASONRY_BLOCKS);
