...
public class AetherIIRecipeData extends AetherIIRecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        this.alkahestPurification(RecipeCategory.COMBAT, WeightedList.<ItemStack>builder() //todo
                ...
                .add(AetherIIItems.COMPACT_DISC_AETHER_TUNE.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_ASCENDING_DAWN.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_AERWHALE.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_APPROACHES.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_DEMISE.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_CHINCHILLA.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_HIGH.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_REVOLUTIONS.toStack(), 1)
                .add(AetherIIItems.COMPACT_DISC_CHASE.toStack(), 1)
