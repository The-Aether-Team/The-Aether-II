...
import com.aetherteam.aetherii.item.components.BundleContents;
...
public class AetherIIRecipeData extends AetherIIRecipeProvider {
    public AetherIIRecipeData(PackOutput output, HolderLookup.Provider provider) {
    ...
    protected void buildRecipes() {
        ...
        List<Item> wool = List.of(
                AetherIIBlocks.BLACK_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.BLUE_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.BROWN_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.CYAN_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.GRAY_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.GREEN_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.LIGHT_BLUE_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.LIGHT_GRAY_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.LIME_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.MAGENTA_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.ORANGE_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.PINK_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.PURPLE_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.RED_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.YELLOW_CLOUDWOOL.get().asItem(),
                AetherIIBlocks.WHITE_CLOUDWOOL.get().asItem()
        );
        List<Item> carpet = List.of(
                AetherIIBlocks.BLACK_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.BLUE_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.BROWN_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.CYAN_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.GRAY_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.GREEN_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.LIGHT_BLUE_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.LIGHT_GRAY_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.LIME_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.MAGENTA_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.ORANGE_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.PINK_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.PURPLE_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.RED_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.YELLOW_CLOUDWOOL_CARPET.get().asItem(),
                AetherIIBlocks.WHITE_CLOUDWOOL_CARPET.get().asItem()
        );
        List<Item> bed = List.of(
                AetherIIBlocks.BLACK_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.BLUE_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.BROWN_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.CYAN_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.GRAY_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.GREEN_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.LIGHT_BLUE_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.LIGHT_GRAY_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.LIME_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.MAGENTA_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.ORANGE_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.PINK_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.PURPLE_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.RED_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.YELLOW_SKYROOT_BED.get().asItem(),
                AetherIIBlocks.WHITE_SKYROOT_BED.get().asItem()
        );
        ...
        // Special
        SpecialRecipeBuilder.special(LootRepairRecipe.SERIALIZER).save(this.output, this.name("loot_repairing").toString());
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.COARSE_AETHER_DIRT.get(), 4)
                .define('D', AetherIIBlocks.AETHER_DIRT.get())
                .define('G', AetherIIBlocks.SHIMMERING_SILT.get())
                .pattern("DG")
                .pattern("GD")
        ...
        // Underground
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.UNSTABLE_HOLYSTONE.get(), 2)
                .define('S', AetherIIBlocks.HOLYSTONE.get())
                .define('R', AetherIIBlocks.HOLYSTONE_ROCK.get())
                .pattern("SR")
                .pattern("RS")
                .unlockedBy(getHasName(AetherIIBlocks.HOLYSTONE), has(AetherIIBlocks.HOLYSTONE))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.UNSTABLE_UNDERSHALE.get(), 2)
                .define('S', AetherIIBlocks.UNDERSHALE.get())
                .define('R', AetherIIBlocks.HOLYSTONE_ROCK.get())
                .pattern("SR")
                .pattern("RS")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.MOSSY_HOLYSTONE.get())
                ...
                .requires(AetherIIBlocks.BRYALINN_MOSS_VINES.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.MOSSY_HOLYSTONE.get())
                .group("mossy_holystone")
                .requires(AetherIIBlocks.HOLYSTONE.get())
                .requires(AetherIIBlocks.BRYALINN_MOSS_BLOCK.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.ARCTIC_SNOW.get(), 6)
                .define('#', AetherIIBlocks.ARCTIC_SNOW_BLOCK.get())
                .pattern("###")
                .unlockedBy("has_snowball", has(AetherIIItems.ARCTIC_SNOWBALL))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.FRAGILE_ARCTIC_ICE.get(), 2)
                .define('S', AetherIIBlocks.ARCTIC_ICE.get())
                .define('B', AetherIIItems.ARCTIC_SNOWBALL.get())
                .pattern("SB")
                .pattern("BS")
        ...
        // Nest Blocks
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.WOVEN_SKYROOT_STICKS.get(), 2)
                .define('#', AetherIIItems.SKYROOT_STICK.get())
                .pattern("##")
                .pattern("##")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.SKYROOT_STICK.get(), 2)
                .requires(AetherIIBlocks.WOVEN_SKYROOT_STICKS.get())
                .unlockedBy("has_woven_skyroot_sticks", has(AetherIIBlocks.WOVEN_SKYROOT_STICKS))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.ANIMAL_STASH.get())
                .define('#', AetherIIBlocks.WOVEN_SKYROOT_STICKS.get())
                .define('M', AetherIIBlocks.BRYALINN_MOSS_BLOCK.get())
                .pattern("M#M")
                .pattern("# #")
                .pattern("###")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIBlocks.MOSSY_WISPROOT_LOG_BASE.get(), 1)
                .requires(AetherIIBlocks.WISPROOT_LOG.get())
                .requires(AetherIIBlocks.BRYALINN_MOSS_VINES.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIBlocks.MOSSY_WISPROOT_LOG.get(), 1)
                ...
                .unlockedBy("has_vines", has(AetherIIBlocks.BRYALINN_MOSS_VINES))
                .save(this.output);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIBlocks.MOSSY_WISPROOT_WOOD.get(), 1)
                .requires(AetherIIBlocks.WISPROOT_WOOD.get())
                .requires(AetherIIBlocks.BRYALINN_MOSS_VINES.get())
                .requires(AetherIIBlocks.BRYALINN_MOSS_VINES.get())
                .unlockedBy("has_vines", has(AetherIIBlocks.BRYALINN_MOSS_VINES))
                .save(this.output);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.AMBEROOT_PLANKS.get())
                .group("planks_from_artisanry")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_HOLYSTONE.get(), 8)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.UNDERSHALE_BRICKS.get())
                .group("bricks_from_artisanry")
        ...
        // Sentry Bricks
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.SENTRY_BRICKS.get())
                .group("bricks_from_artisanry")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.ICHORITE_BRICKS.get())
                .group("bricks_from_artisanry")
        ...
        // Marbled Ichorite
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.MARBLED_ICHORITE.get(), 2)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.MARBLED_ICHORITE.get())
                .group("bricks_from_artisanry")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.QUICKSOIL_GLASS.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.CRUDE_SCATTERGLASS.get())
                .group("glass_from_artisanry")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.SCATTERGLASS.get())
                .group("glass_from_artisanry")
        ...
        // Glass Panes
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.QUICKSOIL_GLASS_PANE.get(), 16).define('#', AetherIIBlocks.QUICKSOIL_GLASS.get()).pattern("###").pattern("###").unlockedBy("has_quicksoil_glass", has(AetherIIBlocks.QUICKSOIL_GLASS.get())).save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.CRUDE_SCATTERGLASS_PANE.get(), 16).define('#', AetherIIBlocks.CRUDE_SCATTERGLASS.get()).pattern("###").pattern("###").unlockedBy("has_crude_scatterglass", has(AetherIIBlocks.CRUDE_SCATTERGLASS.get())).save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.SCATTERGLASS_PANE.get(), 16).define('#', AetherIIBlocks.SCATTERGLASS.get()).pattern("###").pattern("###").unlockedBy("has_scatterglass", has(AetherIIBlocks.SCATTERGLASS.get())).save(this.output);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.QUICKSOIL_GLASS_PANE.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.CRUDE_SCATTERGLASS_PANE.get())
                .group("glass_pane_from_artisanry")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.SCATTERGLASS_PANE.get())
                .group("glass_pane_from_artisanry")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.LUCENT_GUARDIAN_ROOTS.get(), 4)
                .define('#', AetherIIBlocks.GUARDIAN_ROOTS.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.GUARDIAN_LAMP.get())
        ...
        // Wool
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.CLOUDTWINE.get(), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIBlocks.CLOUDWOOL.get())
                .define('#', AetherIIItems.CLOUDTWINE.get())
                .pattern("##")
                .pattern("##")
        ...
        this.colorBlockWithDye(dyes, wool, AetherIIBlocks.CLOUDWOOL.get().asItem(), "wool");
        this.washDyedBlock(wool, AetherIIBlocks.CLOUDWOOL.get().asItem(), "wool");

        // Carpet
        this.colorBlockWithDye(dyes, carpet, AetherIIBlocks.CLOUDWOOL_CARPET.get().asItem(), "carpet");
        this.washDyedBlock(carpet, AetherIIBlocks.CLOUDWOOL_CARPET.get().asItem(), "carpet");
        ...
        // Roofing
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIBlocks.CLOUDWOOL_ROOFING.get(), 8)
                .define('#', AetherIIBlocks.CLOUDWOOL.get())
                .pattern("##")
                .pattern("##")
        ...
        // Skyroot Beds
        this.colorBlockWithDye(dyes, bed, AetherIIBlocks.SKYROOT_BED.get().asItem(), "bed");
        this.washDyedBlock(bed, AetherIIBlocks.SKYROOT_BED.get().asItem(), "bed");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.ARKENIUM_BARS.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.RUSTIC_ARKENIUM_BARS.get())
                .group("bars_from_artisanry")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.SWET_GEL.get(), 4).requires(AetherIIBlocks.GEL_BLOCK.get()).group("swet_gel").unlockedBy(getHasName(AetherIIBlocks.GEL_BLOCK), this.has(AetherIIBlocks.GEL_BLOCK)).save(output, this.name("swet_gel"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.GEL_BLOCK.get()).define('#', AetherIIItems.SWET_GEL.get()).pattern("##").pattern("##").unlockedBy(getHasName(AetherIIItems.SWET_GEL.get()), this.has(AetherIIItems.SWET_GEL.get())).save(output, this.name(getSimpleRecipeName(AetherIIBlocks.GEL_BLOCK)));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.AMBROSIUM_TORCH.get(), 4)
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.ARKENIUM_LANTERN.get())
                .define('#', AetherIIItems.ARKENIUM_CHIP.get())
                .define('/', AetherIIBlocks.AMBROSIUM_TORCH.get())
                .pattern("###")
                .pattern("#/#")
                .pattern("###")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.ARKENIUM_CHAIN.get(), 3)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.HOLYSTONE_FURNACE.get())
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.HOLYSTONE_SMOKER.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.AMBER_HOURGLASS.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.ALTAR.get())
                .define('U', AetherIIBlocks.UNDERSHALE.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.ARKENIUM_FORGE.get())
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.ALKAHEST_PURIFIER.get())
                .define('A', AetherIITags.Items.INGOTS_ARKENIUM)
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.AMBROSIUM_CAMPFIRE.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.SKYROOT_CHEST.get())
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.SKYROOT_BARREL.get())
                .define('#', AetherIITags.Items.PLANKS_CRAFTING)
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.SENTRY_CRATE.get())
                .define('#', AetherIIBlocks.SENTRY_BRICKS.get())
                .define('A', AetherIITags.Items.INGOTS_ARKENIUM)
                .pattern("#A#")
                .pattern("# #")
                .pattern("###")
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.HOLYSTONE_VASE.get())
                .define('#', AetherIIBlocks.HOLYSTONE.get())
                .pattern(" # ")
                .pattern("# #")
                .pattern(" # ")
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.VERADEXIAN_VASE.get())
                .define('#', AetherIIBlocks.SMOOTH_ICHORITE.get())
                .define('Q', Items.QUARTZ)
                .pattern("Q#Q")
                .pattern("# #")
                .pattern(" # ")
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.BREXALLEN_VASE.get())
                .define('#', AetherIIBlocks.UNDERSHALE.get())
                .define('A', AetherIIBlocks.AGIOSITE.get())
                .pattern("A#A")
                .pattern("# #")
                .pattern(" # ")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.SKYROOT_LADDER.get(), 3)
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIBlocks.CLOUDWOOL_BEDROLL.get(), 2)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, Items.ITEM_FRAME, 1)
                .define('/', AetherIITags.Items.RODS_SKYROOT)
                .define('#', AetherIIItems.BEAST_PELT.get())
                .pattern("///")
                .pattern("/#/")
                .pattern("///")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, Blocks.JUKEBOX)
                .define('#', AetherIITags.Items.PLANKS_CRAFTING)
                .define('G', AetherIIItems.GRAVITITE_PLATE.get())
                .pattern("###")
                .pattern("#G#")
                .pattern("###")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, AetherIIBlocks.HOLYSTONE_LEVER.get())
                .define('#', AetherIIBlocks.HOLYSTONE.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, Items.ARMOR_STAND)
                .define('/', AetherIITags.Items.RODS_SKYROOT)
                .define('_', AetherIIBlocks.HOLYSTONE_SLAB.get())
                .pattern("///")
                .pattern(" / ")
                .pattern("/_/")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, Blocks.DAYLIGHT_DETECTOR)
                .define('Q', Items.QUARTZ)
                .define('G', AetherIIBlocks.SCATTERGLASS.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.ZANITE_SHEARS.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.DART_SHOOTER.get())
                .define('A', AetherIIItems.GOLDEN_AMBER.get())
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.AMBER_DARTS.get(), 4)
                .define('A', AetherIIItems.GOLDEN_AMBER.get())
                .define('/', AetherIITags.Items.RODS_SKYROOT)
                .pattern("A  ")
                .pattern(" /A")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.SCATTERGLASS_BOLT.get(), 4)
                .define('S', AetherIIItems.SCATTERGLASS_SHARD.get())
                .define('/', AetherIITags.Items.RODS_SKYROOT)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.NEPTUNE_HELMET.get(), 1)
                .define('N', AetherIIItems.NEPTUNE_SCALE.get())
                .define('#', AetherIIItems.ZANITE_HELMET.get())
                .pattern("NNN")
                .pattern("N#N")
                .pattern("NNN")
                .unlockedBy("neptune", has(AetherIIItems.NEPTUNE_SCALE))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.NEPTUNE_CHESTPLATE.get(), 1)
                .define('N', AetherIIItems.NEPTUNE_SCALE.get())
                .define('#', AetherIIItems.ZANITE_CHESTPLATE.get())
                .pattern("NNN")
                .pattern("N#N")
                .pattern("NNN")
                .unlockedBy("neptune", has(AetherIIItems.NEPTUNE_SCALE))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.NEPTUNE_LEGGINGS.get(), 1)
                .define('N', AetherIIItems.NEPTUNE_SCALE.get())
                .define('#', AetherIIItems.ZANITE_LEGGINGS.get())
                .pattern("NNN")
                .pattern("N#N")
                .pattern("NNN")
                .unlockedBy("neptune", has(AetherIIItems.NEPTUNE_SCALE))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.NEPTUNE_BOOTS.get(), 1)
                .define('N', AetherIIItems.NEPTUNE_SCALE.get())
                .define('#', AetherIIItems.ZANITE_BOOTS.get())
                .pattern("NNN")
                .pattern("N#N")
                .pattern("NNN")
                .unlockedBy("neptune", has(AetherIIItems.NEPTUNE_SCALE))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.NEPTUNE_GLOVES.get(), 1)
                .define('N', AetherIIItems.NEPTUNE_SCALE.get())
                .define('#', AetherIIItems.ZANITE_GLOVES.get())
                .pattern("NNN")
                .pattern("N#N")
                .pattern("NNN")
                .unlockedBy("neptune", has(AetherIIItems.NEPTUNE_SCALE))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.SENTRY_BOOTS.get(), 1)
                .define('S', AetherIIItems.SENTRY_SERVO.get())
                .define('#', AetherIIItems.ZANITE_BOOTS.get())
                .pattern("SSS")
                .pattern("S#S")
                .pattern("SSS")
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.HAMMER_OF_DEMOLITION.get(), 1)
                .define('S', AetherIIItems.SENTRY_SERVO.get())
                .define('#', AetherIIItems.ZANITE_HAMMER.get())
                .pattern("SSS")
                .pattern("S#S")
                .pattern("SSS")
                .unlockedBy("sentry", has(AetherIIItems.SENTRY_SERVO))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AetherIIItems.KINETIC_THRUSTERS.get(), 1)
                .define('S', AetherIIItems.SENTRY_SERVO.get())
                .define('#', AetherIIItems.ZANITE_GEMSTONE.get())
                .pattern("SSS")
                .pattern("S#S")
                .pattern("SSS")
                .unlockedBy("sentry", has(AetherIIItems.SENTRY_SERVO))
        ...
        // Accessories
        this.makePendantWithTag(getter, AetherIIItems.ZANITE_PENDANT, AetherIITags.Items.GEMS_ZANITE, Ingredient.of(AetherIIItems.CLOUDTWINE.get()), "zanite").save(this.output);
        this.makePendant(getter, AetherIIItems.ICESTONE_PENDANT, AetherIIBlocks.ICESTONE.get().asItem(), Ingredient.of(AetherIIItems.CLOUDTWINE.get())).save(this.output);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.SKYROOT_STICK.get(), 2)
                .group("sticks")
                .requires(AetherIIBlocks.SKYROOT_TWIG.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.MOA_FEED.get(), 3)
                .requires(AetherIIItems.SKYROOT_PINECONE.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.SCATTERGLASS_SHARD.get(), 4)
                .requires(AetherIIBlocks.CRUDE_SCATTERGLASS.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.PAPER, 3)
                .define('#', AetherIIItems.BRETTL_CANE.get())
                .pattern("###")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.BRETTL_ROPE.get(), 2)
                .define('#', AetherIIItems.BRETTL_GRASS.get())
                .pattern("  #")
                .pattern(" # ")
                .pattern("#  ")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.BOOK)
                ...
                .requires(AetherIIItems.BEAST_PELT.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.SKYROOT_BUCKET.get(), 1)
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.ARKENIUM_CANISTER.get(), 2)
                .define('#', AetherIITags.Items.INGOTS_ARKENIUM)
                .define('S', AetherIIBlocks.SCATTERGLASS.get())
                .pattern("#S#")
                .pattern("#S#")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.MUSIC_PLAYER.get())
                .define('A', AetherIIItems.GOLDEN_AMBER.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.QUARTZ)
                .requires(strictIngredient(new ItemStackTemplate(Items.QUARTZ, 1, DataComponentPatch.builder().set(DataComponents.ITEM_NAME, Component.translatable("item.aether_ii.aether_quartz")).build())))
        ...
        this.hourglassUncraftingIngredient(RecipeCategory.MISC,
                ...
                AetherIIItems.BEAST_PELT, List.of(this.hourglass(1, 100)),
                Items.AIR, List.of(),
                strictIngredient(new ItemStackTemplate(AetherIIItems.BEAST_PELT_BUNDLE.get(), 1, DataComponentPatch.builder().set(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY).build())), 0.0F, this.has(AetherIIItems.BEAST_PELT_BUNDLE)).group("misc_tools").save(this.output, this.name("uncraft_beast_pelt_bundle"));
        this.hourglassUncraftingItem(RecipeCategory.MISC,
                Items.AIR, List.of(),
        ...
        for (Moa.FeatherColor featherColor : Moa.FeatherColor.values()) {
            ...
            ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, featherDye, 1)
                    .requires(componentIngredient(AetherIIDataComponents.FEATHER_COLOR, featherColor, AetherIIItems.MOA_FEATHER.get()))
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.SWET_JELLY.get(), 1)
                .requires(AetherIIItems.SWET_GEL.get())
                .requires(AetherIIItems.SWET_SUGAR.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.BLUEBERRY_MOA_FEED.get(), 1)
                .requires(AetherIIItems.MOA_FEED.get())
                .requires(AetherIIItems.BLUEBERRY.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, AetherIIItems.ENCHANTED_MOA_FEED.get(), 1)
                .requires(AetherIIItems.MOA_FEED.get())
                .requires(AetherIIItems.ENCHANTED_BLUEBERRY.get())
                .unlockedBy("has_feed", has(AetherIIItems.MOA_FEED))
                .save(this.output);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.AERBUNNY_BELL.get())
                .define('#', AetherIITags.Items.GEMS_ZANITE)
                .define('A', AetherIIItems.RESONANT_STONE.get())
                .pattern(" # ")
                .pattern("#A#")
                .pattern(" # ")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, AetherIIItems.BEAST_PELT_BUNDLE.get())
                .define('-', AetherIIItems.CLOUDTWINE.get())
                .define('#', AetherIIItems.BEAST_PELT.get())
                .pattern("-")
                .pattern("#")
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.BRETTL_LASSO.get())
                .define('#', AetherIIItems.BRETTL_ROPE.get())
                .pattern(" ##")
                .pattern(" ##")
                .pattern("#  ")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.MOA_SADDLE.get())
                ...
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.MOA_SADDLEBAG.get())
                .define('C', AetherIIBlocks.SKYROOT_CHEST.get())
                .define('#', AetherIIItems.BEAST_PELT.get())
                .define('/', AetherIIItems.CLOUDTWINE.get())
                .pattern("###")
                .pattern("/C/")
                .unlockedBy("has_beast_pelt", has(AetherIIItems.BEAST_PELT))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.LARGE_MOA_SADDLEBAG.get())
                .define('C', AetherIIBlocks.SKYROOT_CHEST.get())
                .define('#', AetherIIItems.BEAST_PELT.get())
                .define('/', AetherIIItems.CLOUDTWINE.get())
                .pattern("###")
                ...
                .unlockedBy("has_beast_pelt", has(AetherIIItems.BEAST_PELT))
                .save(this.output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AetherIIItems.CLOUD_SKIFF.get())
                .define('A', AetherIIBlocks.COLD_AERCLOUD.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, new ItemStackTemplate(AetherIIItems.SPLINT.get()))
                .requires(AetherIITags.Items.RODS_SKYROOT)
                .requires(AetherIITags.Items.CLOUDWOOL)
                .unlockedBy("has_cloudwool", has(AetherIITags.Items.CLOUDWOOL))
                .save(this.output);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, new ItemStackTemplate(AetherIIItems.BANDAGE.get()))
                .requires(AetherIIItems.CLOUDTWINE.get())
                .requires(AetherIITags.Items.CLOUDWOOL)
                .unlockedBy("has_cloudwool", has(AetherIITags.Items.CLOUDWOOL))
                .save(this.output);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, new ItemStackTemplate(AetherIIItems.ANTIVENOM_VIAL.get()))
                ...
                .save(this.output);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, new ItemStackTemplate(AetherIIItems.ANTITOXIN_VIAL.get()))
                .requires(AetherIIItems.WATER_VIAL.get())
                .requires(AetherIIItems.AECHOR_PETAL.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, new ItemStackTemplate(AetherIIItems.VALKYRIE_TEA.get()))
                .requires(AetherIIItems.WATER_VIAL.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, new ItemStackTemplate(AetherIIItems.HEALING_STONE, 1, DataComponentPatch.builder().set(AetherIIDataComponents.HEALING_STONE_CHARGES.get(), 1).build()))
                .define('A', AetherIITags.Items.GEMS_AMBROSIUM)
                .define('H', AetherIITags.Items.STONE_CRAFTING)
                .pattern("HAH")
                .pattern("AAA")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYROOT_LEAF_PILE.get(), 1).requires(AetherIIBlocks.SKYROOT_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYPLANE_LEAF_PILE.get(), 1).requires(AetherIIBlocks.SKYPLANE_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYBIRCH_LEAF_PILE.get(), 1).requires(AetherIIBlocks.SKYBIRCH_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYPINE_LEAF_PILE.get(), 1).requires(AetherIIBlocks.SKYPINE_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_WISPROOT_LEAF_PILE.get(), 1).requires(AetherIIBlocks.WISPROOT_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_WISPTOP_LEAF_PILE.get(), 1).requires(AetherIIBlocks.WISPTOP_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_GREATROOT_LEAF_PILE.get(), 1).requires(AetherIIBlocks.GREATROOT_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_GREATOAK_LEAF_PILE.get(), 1).requires(AetherIIBlocks.GREATOAK_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_GREATBOA_LEAF_PILE.get(), 1).requires(AetherIIBlocks.GREATBOA_LEAF_PILE.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYROOT_LEAVES.get(), 1).requires(AetherIIBlocks.SKYROOT_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYPLANE_LEAVES.get(), 1).requires(AetherIIBlocks.SKYPLANE_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYBIRCH_LEAVES.get(), 1).requires(AetherIIBlocks.SKYBIRCH_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_SKYPINE_LEAVES.get(), 1).requires(AetherIIBlocks.SKYPINE_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_WISPROOT_LEAVES.get(), 1).requires(AetherIIBlocks.WISPROOT_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_WISPTOP_LEAVES.get(), 1).requires(AetherIIBlocks.WISPTOP_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_GREATROOT_LEAVES.get(), 1).requires(AetherIIBlocks.GREATROOT_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_GREATOAK_LEAVES.get(), 1).requires(AetherIIBlocks.GREATOAK_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, AetherIIBlocks.IRRADIATED_GREATBOA_LEAVES.get(), 1).requires(AetherIIBlocks.GREATBOA_LEAVES.get()).requires(AetherIIItems.IRRADIATED_DUST.get())
    ...
    public static class Runner implements DataProvider {
        ...
        public CompletableFuture<?> run(CachedOutput output) {
            return this.registries.thenCompose(provider -> new AetherIIRecipeData(this.packOutput, provider).run(output));
        }
