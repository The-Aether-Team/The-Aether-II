...
public class AetherIIDataMapData extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        ...
        this.addCompost(compostables, AetherIIBlocks.SKY_ROOTS, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.BRYALINN_MOSS_BLOCK, 0.65F);
        this.addCompost(compostables, AetherIIBlocks.BRYALINN_MOSS_CARPET, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.BRYALINN_MOSS_COVER, 0.5F);
        this.addCompost(compostables, AetherIIBlocks.BRYALINN_MOSS_VINES, 0.5F);
        this.addCompost(compostables, AetherIIBlocks.BRYALINN_MOSS_FLOWERS, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.MAGNETIC_SHROOM, 0.65F);
        this.addCompost(compostables, AetherIIBlocks.MAGNETIC_SHROOM_BLOCK, 0.85F);
        this.addCompost(compostables, AetherIIBlocks.SPOTTED_MAGNETIC_SHROOM_BLOCK, 0.85F);
        this.addCompost(compostables, AetherIIBlocks.MAGNETIC_SHROOM_STEM, 0.65F);
        this.addCompost(compostables, AetherIIBlocks.SHAYELINN_MOSS_BLOCK, 0.65F);
        this.addCompost(compostables, AetherIIBlocks.SHAYELINN_MOSS_CARPET, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.SHAYELINN_MOSS_COVER, 0.5F);
        this.addCompost(compostables, AetherIIBlocks.SHAYELINN_MOSS_VINES, 0.5F);
        this.addCompost(compostables, AetherIIBlocks.AMBRELINN_MOSS_BLOCK, 0.65F);
        this.addCompost(compostables, AetherIIBlocks.AMBRELINN_MOSS_CARPET, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.AMBRELINN_MOSS_COVER, 0.5F);
        this.addCompost(compostables, AetherIIBlocks.AMBRELINN_MOSS_VINES, 0.5F);
        this.addCompost(compostables, AetherIIBlocks.TARAHESP_FLOWERS, 0.3F);
        ...
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_SKYROOT_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_SKYPLANE_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_SKYBIRCH_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_SKYPINE_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_WISPROOT_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_WISPTOP_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_GREATROOT_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_GREATOAK_LEAVES, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.IRRADIATED_GREATBOA_LEAVES, 0.3F);
        ...
        this.addCompost(compostables, AetherIIBlocks.PLURACIAN, 0.65F);
        this.addCompost(compostables, AetherIIBlocks.SATIVAL_SHOOT, 0.65F);
        this.addCompost(compostables, AetherIIBlocks.HOLPUPEA, 0.3F);
        ...
        this.addCompost(compostables, AetherIIBlocks.VALKYRIE_SPROUT, 0.5F);
        this.addCompost(compostables, AetherIIBlocks.BRETTL_FLOWER, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.SKYROOT_TWIG, 0.3F);
        this.addCompost(compostables, AetherIIBlocks.BRETTL_GRASS_BUNDLE, 0.85F);
        this.addCompost(compostables, AetherIIItems.SKYROOT_PINECONE, 0.3F);
        this.addCompost(compostables, AetherIIItems.VALKYRIE_WINGS, 0.3F);
        this.addCompost(compostables, AetherIIItems.BRETTL_CANE, 0.3F);
        this.addCompost(compostables, AetherIIItems.BRETTL_GRASS, 0.3F);
        this.addCompost(compostables, AetherIIItems.ARILUM_BULBS, 0.5F);
