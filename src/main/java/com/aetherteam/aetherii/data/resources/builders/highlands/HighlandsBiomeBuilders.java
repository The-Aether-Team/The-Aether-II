...
public class HighlandsBiomeBuilders {
    ...
    public static BiomeSource buildHighlandsBiomeSource(HolderGetter<Biome> biomes) {
        ...
        return MultiNoiseBiomeSource.createFromList(new Climate.ParameterList<>(List.of(
                ...
                //Highfields
                Pair.of(new Climate.ParameterPoint(tempHighfields1, Climate.Parameter.span(-1.0F, -0.25F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.SHROUDED_FOREST)),
                Pair.of(new Climate.ParameterPoint(tempHighfields1, Climate.Parameter.span(-0.25F, 0.15F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.VERDANT_WOODS)),
                Pair.of(new Climate.ParameterPoint(tempHighfields1, Climate.Parameter.span(0.15F, 1.0F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.FLOURISHING_FIELD)),

                Pair.of(new Climate.ParameterPoint(tempHighfields2, Climate.Parameter.span(-1.0F, -0.1F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.VERDANT_WOODS)),
                Pair.of(new Climate.ParameterPoint(tempHighfields2, Climate.Parameter.span(-0.1F, 0.3F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.FLOURISHING_FIELD)),
                Pair.of(new Climate.ParameterPoint(tempHighfields2, Climate.Parameter.span(0.3F, 1.0F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.SHROUDED_FOREST)),

                Pair.of(new Climate.ParameterPoint(tempHighfields3, Climate.Parameter.span(-1.0F, -0.25F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.FLOURISHING_FIELD)),
                Pair.of(new Climate.ParameterPoint(tempHighfields3, Climate.Parameter.span(-0.25F, 0.2F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.VERDANT_WOODS)),
                Pair.of(new Climate.ParameterPoint(tempHighfields3, Climate.Parameter.span(0.2F, 1.0F), erosionDefault, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.SHROUDED_FOREST)),

                //Magnetic Hills
                Pair.of(new Climate.ParameterPoint(tempMagnetic1, Climate.Parameter.span(-1.0F, -0.2F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.VIOLET_HIGHWOODS)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic1, Climate.Parameter.span(-0.2F, 0.15F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.MAGNETIC_SCAR)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic1, Climate.Parameter.span(0.15F, 1.0F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.GLISTENING_SWAMP)),

                Pair.of(new Climate.ParameterPoint(tempMagnetic2, Climate.Parameter.span(-1.0F, -0.15F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.MAGNETIC_SCAR)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic2, Climate.Parameter.span(-0.15F, 0.2F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.TURQUOISE_FOREST)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic2, Climate.Parameter.span(0.2F, 1.0F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.VIOLET_HIGHWOODS)),

                Pair.of(new Climate.ParameterPoint(tempMagnetic3, Climate.Parameter.span(-1.0F, -0.2F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.GLISTENING_SWAMP)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic3, Climate.Parameter.span(-0.2F, 0.1F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.MAGNETIC_SCAR)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic3, Climate.Parameter.span(0.1F, 0.3F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.TURQUOISE_FOREST)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic3, Climate.Parameter.span(0.3F, 1.0F), erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.GLISTENING_SWAMP)),

                Pair.of(new Climate.ParameterPoint(tempIrradiated, fullRange, erosionMagnetic, fullRange, fullRange, fullRange, 0),
                        biomes.getOrThrow(AetherIIBiomes.MAGNETIC_SCAR)),
