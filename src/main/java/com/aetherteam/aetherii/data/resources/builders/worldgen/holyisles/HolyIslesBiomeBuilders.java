...
public class HolyIslesBiomeBuilders {
    ...
    private static Music music() {
        return new Music(sound(AetherIISoundEvents.MUSIC_AETHER), 3600, 10800, false);
    }

    private static Holder<SoundEvent> sound(RegistryObject<SoundEvent> sound) {
        return sound.getHolder().orElseGet(() -> Holder.direct(sound.get()));
    }
    ...
    public static Biome flourishingFieldBiome(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers, float temperature, float downfall) {
        return makeHighfieldsBiome(Optional.of(HolyIslesPlacedFeatures.FLOURISHING_FIELD_TREES), new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
                        .addCarver(GenerationStep.Carving.AIR, AetherIICarvers.HOLY_ISLES_CAVE)
                ...
                new MobSpawnSettings.Builder().creatureGenerationProbability(0.218F)
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.HIGHFIELDS_TAEGORE.get(), 14, 1, 2))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.HIGHFIELDS_BURRUKAI.get(), 14, 1, 1))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.HIGHFIELDS_KIRRID.get(), 14, 1, 2))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.PHYG.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.FLYING_COW.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.SHEEPUFF.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.AERBUNNY.get(), 14, 1, 3)),
    ...
    public static Biome makeHighfieldsBiome(Optional<ResourceKey<PlacedFeature>> tree, BiomeGenerationSettings.Builder builder, MobSpawnSettings.Builder spawnSettingsBuilder, float temperature, float downfall) {
        ...
        return highfieldsDefinition(
                ...
                spawnSettingsBuilder
                        ...
                        .addSpawn(AetherIIMobCategory.AETHER_AMBIENT, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.GLITTERWING.get(), 1, 1, 2))
                        .addSpawn(AetherIIMobCategory.AETHER_AMBIENT, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.SHROUDWING.get(), 1, 1, 2))
                        .addSpawn(AetherIIMobCategory.AETHER_WATER_SURFACE_CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.PRISMALLARD.get(), 1, 1, 3))
                        .addSpawn(AetherIIMobCategory.AETHER_PLANT_HAZARD, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.AECHOR_PLANT.get(), 5, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_PLANT_HAZARD, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.CARRION_SPROUT.get(), 3, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_SKY_HAZARD, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ZEPHYR.get(), 1, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_AERWHALE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.AERWHALE.get(), 1, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_DARKNESS_HAZARD, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.BLUE_SWET.get(), 2, 1, 2))
                        .addSpawn(AetherIIMobCategory.AETHER_DARKNESS_HAZARD, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.GOLDEN_SWET.get(), 1, 1, 2))
                        .addSpawn(AetherIIMobCategory.AETHER_DARKNESS_HAZARD, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.SKEPHID.get(), 1, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_BLIGHT_MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.COCKATRICE.get(), 4, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_BLIGHT_MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.TEMPEST.get(), 1, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_DARKNESS_MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ARKENIUM_TALUTON.get(), 3, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_DARKNESS_MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.GRAVITITE_TALUTON.get(), 4, 1, 1))
                        .build(),
                builder.build(),
    ...
    public static Biome magneticScarBiome(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers, float temperature, float downfall) {
        return makeMagneticBiome(Optional.of(HolyIslesPlacedFeatures.MAGNETIC_SCAR_TREES), new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
                        ...
                        .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, HolyIslesPlacedFeatures.GRASS_FIELD),
                new MobSpawnSettings.Builder().creatureGenerationProbability(0.218F)
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.MAGNETIC_TAEGORE.get(), 14, 1, 2))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.MAGNETIC_BURRUKAI.get(), 14, 1, 1))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.MAGNETIC_KIRRID.get(), 14, 1, 2))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.PHYG.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.FLYING_COW.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.SHEEPUFF.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.AERBUNNY.get(), 14, 1, 3)),
    ...
    public static Biome frigidSierraBiome(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers, float temperature, float downfall) {
        return makeArcticBiome(Optional.of(HolyIslesPlacedFeatures.FRIGID_SIERRA_TREES), new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
                ...
                new MobSpawnSettings.Builder().creatureGenerationProbability(0.208F)
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ARCTIC_TAEGORE.get(), 14, 1, 2))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ARCTIC_BURRUKAI.get(), 14, 1, 1))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ARCTIC_KIRRID.get(), 14, 1, 2))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.PHYG.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.FLYING_COW.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.SHEEPUFF.get(), 1, 2, 4))
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.AERBUNNY.get(), 14, 1, 3)),
    ...
    public static Biome makeIrradiatedBiome(Optional<ResourceKey<PlacedFeature>> tree, BiomeGenerationSettings.Builder builder, float temperature, float downfall) {
        ...
        builder = builder.addCarver(GenerationStep.Carving.AIR, AetherIICarvers.HOLY_ISLES_CAVE).addFeature(GenerationStep.Decoration.RAW_GENERATION, HolyIslesPlacedFeatures.CLOUDBED)
                .addFeature(GenerationStep.Decoration.LAKES, HolyIslesPlacedFeatures.WATER_POND)
                .addFeature(GenerationStep.Decoration.LAKES, HolyIslesPlacedFeatures.WATER_POND_UNDERGROUND)
                .addFeature(GenerationStep.Decoration.LAKES, HolyIslesPlacedFeatures.ALKAHEST_POOL_RARE)
                .addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, HolyIslesPlacedFeatures.SKYROOT_TWIGS)
        ...
        return irradiatedDefinition(
                ...
                spawnSettingsBuilder
                        ...
                        .addMobCharge(AetherIIEntityTypes.TEMPEST.get(), 0.65, 0.13)
                        .addMobCharge(AetherIIEntityTypes.COCKATRICE.get(), 0.6, 0.12)
                        .addSpawn(AetherIIMobCategory.AETHER_SKY_HAZARD, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ZEPHYR.get(), 1, 1, 2))
                        .addSpawn(AetherIIMobCategory.AETHER_BLIGHT_MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.TEMPEST.get(), 1, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_DARKNESS_MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ARKENIUM_TALUTON.get(), 3, 1, 1))
                        .addSpawn(AetherIIMobCategory.AETHER_DARKNESS_MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.GRAVITITE_TALUTON.get(), 4, 1, 1))
                        .build(),
    ...
    public static Biome makeHeastveilCavernsBiome(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers, float temperature, float downfall) {
        ...
        return highfieldsDefinition(
                ...
                spawnSettingsBuilder
                        ...
                        .build(),
                generationSettingsBuilder
                        .addCarver(GenerationStep.Carving.AIR, AetherIICarvers.HESTVEIL_CAVE)
                        .addFeature(GenerationStep.Decoration.RAW_GENERATION, HolyIslesPlacedFeatures.CLOUDBED)
