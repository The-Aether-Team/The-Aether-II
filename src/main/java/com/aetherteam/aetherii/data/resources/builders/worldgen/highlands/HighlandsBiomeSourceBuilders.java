...
public class HighlandsBiomeSourceBuilders {
    public static BiomeSource buildHighlandsBiomeSource(HolderGetter<Biome> biomes) {
        ...
        return MultiNoiseBiomeSource.createFromList(new Climate.ParameterList<>(List.of(
                ...
                Pair.of(new Climate.ParameterPoint(tempArctic, fullRange, fullRange, erosionDefault, depthHestveilCaverns, Climate.Parameter.span(0.2F, 0.3F), 0), biomes.getOrThrow(HighlandsBiomes.FROZEN_LAKES)),
                ...
                Pair.of(new Climate.ParameterPoint(tempHighfields, fullRange, fullRange, erosionDefault, depthHestveilCaverns, Climate.Parameter.span(0.2F, 0.3F), 0), biomes.getOrThrow(HighlandsBiomes.SHIMMERING_BASIN)),
                ...
                Pair.of(new Climate.ParameterPoint(tempHighfields1, Climate.Parameter.span(0.2F, 1.0F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.FLOURISHING_FIELD)),
                Pair.of(new Climate.ParameterPoint(tempHighfields1, Climate.Parameter.span(1.0F, 2.0F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.SHROUDED_FOREST)),

                Pair.of(new Climate.ParameterPoint(tempHighfields2, Climate.Parameter.span(-1.0F, -0.15F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.VERDANT_WOODS)),
                Pair.of(new Climate.ParameterPoint(tempHighfields2, Climate.Parameter.span(-0.15F, 1.0F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.FLOURISHING_FIELD)),
                Pair.of(new Climate.ParameterPoint(tempHighfields2, Climate.Parameter.span(1.0F, 2.0F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.SHROUDED_FOREST)),

                Pair.of(new Climate.ParameterPoint(tempHighfields3, Climate.Parameter.span(-1.0F, -0.25F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.FLOURISHING_FIELD)),
                Pair.of(new Climate.ParameterPoint(tempHighfields3, Climate.Parameter.span(-0.25F, 0.1F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.VERDANT_WOODS)),
                Pair.of(new Climate.ParameterPoint(tempHighfields3, Climate.Parameter.span(0.1F, 0.25F), fullRange, erosionDefault, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.FLOURISHING_FIELD)),
                ...
                Pair.of(new Climate.ParameterPoint(Climate.Parameter.span(-1.5F, 0.6F), fullRange, fullRange, erosionMagnetic, depthHestveilCaverns, Climate.Parameter.span(0.2F, 0.3F), 0), biomes.getOrThrow(HighlandsBiomes.GLISTENING_SWAMP)),
                ...
                Pair.of(new Climate.ParameterPoint(tempMagnetic2, Climate.Parameter.span(-1.0F, -0.15F), fullRange, erosionMagnetic, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.TURQUOISE_FOREST)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic2, Climate.Parameter.span(-0.15F, 0.2F), fullRange, erosionMagnetic, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.MAGNETIC_SCAR)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic2, Climate.Parameter.span(0.2F, 1.0F), fullRange, erosionMagnetic, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.VIOLET_HIGHWOODS)),

                Pair.of(new Climate.ParameterPoint(tempMagnetic3, Climate.Parameter.span(-1.0F, -0.1F), fullRange, erosionMagnetic, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.MAGNETIC_SCAR)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic3, Climate.Parameter.span(-0.1F, 0.3F), fullRange, erosionMagnetic, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.TURQUOISE_FOREST)),
                Pair.of(new Climate.ParameterPoint(tempMagnetic3, Climate.Parameter.span(0.3F, 1.0F), fullRange, erosionMagnetic, depthDefault, ridgeLand, 0), biomes.getOrThrow(HighlandsBiomes.MAGNETIC_SCAR)),

                Pair.of(new Climate.ParameterPoint(tempIrradiated, fullRange, fullRange, erosionMagnetic, depthDefault, fullRange, 0), biomes.getOrThrow(HighlandsBiomes.MAGNETIC_SCAR)),

                // Irradiated
                Pair.of(new Climate.ParameterPoint(tempIrradiated, Climate.Parameter.span(-1.0F, -0.15F), fullRange, erosionDefault, depthDefault, fullRange, 0), biomes.getOrThrow(HighlandsBiomes.BATTLEGROUND_WASTES)),
                Pair.of(new Climate.ParameterPoint(tempIrradiated, Climate.Parameter.span(-0.15F, 0.2F), fullRange, erosionDefault, depthDefault, fullRange, 0), biomes.getOrThrow(HighlandsBiomes.CONTAMINATED_JUNGLE)),
                ...
                //Caves
                Pair.of(new Climate.ParameterPoint(fullRange, fullRange, fullRange, fullRange, depthHestveilCaverns, Climate.Parameter.span(-1.0F, 0.2F), 0), biomes.getOrThrow(HighlandsBiomes.HESTVEIL_CAVERNS))
        )));
    }
}