...
public class InfectedGuardianTreePools {
    ...
    public static final ResourceKey<StructureTemplatePool> LAYOUT_ROOMS_A = AetherIIPools.createKey("infected_guardian_tree/layout/rooms"); //todo
    public static final ResourceKey<StructureTemplatePool> LAYOUT_ROOMS_B = AetherIIPools.createKey("infected_guardian_tree/layout/rooms_/b");
    public static final ResourceKey<StructureTemplatePool> LAYOUT_ROOMS_C = AetherIIPools.createKey("infected_guardian_tree/layout/rooms_/c");
    public static final ResourceKey<StructureTemplatePool> LAYOUT_ROOMS_D = AetherIIPools.createKey("infected_guardian_tree/layout/rooms_/d");
    public static final ResourceKey<StructureTemplatePool> LAYOUT_ROOMS_E = AetherIIPools.createKey("infected_guardian_tree/layout/rooms_/e");

    public static final ResourceKey<StructureTemplatePool> LAYOUT_CHALLENGE_ROOMS_A = AetherIIPools.createKey("infected_guardian_tree/layout/challenge_rooms"); //todo
    public static final ResourceKey<StructureTemplatePool> LAYOUT_CHALLENGE_ROOMS_B = AetherIIPools.createKey("infected_guardian_tree/layout/challenge_rooms_/b");
    public static final ResourceKey<StructureTemplatePool> LAYOUT_CHALLENGE_ROOMS_C = AetherIIPools.createKey("infected_guardian_tree/layout/challenge_rooms_/c");
    public static final ResourceKey<StructureTemplatePool> LAYOUT_CHALLENGE_ROOMS_D = AetherIIPools.createKey("infected_guardian_tree/layout/challenge_rooms_/d");
    public static final ResourceKey<StructureTemplatePool> LAYOUT_CHALLENGE_ROOMS_E = AetherIIPools.createKey("infected_guardian_tree/layout/challenge_rooms_/e");
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> context) {
        ...
        context.register(LAYOUT_LOBBIES_FLOOR_1, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_01_a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_01_b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_01_c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_01_d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_01_e"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_01_f"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_02_a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_02_b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_02_c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_02_d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_02_e"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_1/lobby_02_f"), 1)
                ),
        ...
        context.register(LAYOUT_LOBBIES_FLOOR_2, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_01_a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_01_b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_01_c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_01_d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_01_e"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_01_f"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_02_a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_02_b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_02_c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_02_d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_02_e"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/lobbies/floor_2/lobby_02_f"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(LAYOUT_ROOMS_A, new StructureTemplatePool(
                ...
                ImmutableList.of(
                        ...
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_a-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_a-b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_a-c"), 1),
                        ...
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/dead_ends/dead_end_mixed"), 7)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(LAYOUT_ROOMS_B, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_b-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_b-b"), 1),
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_b-c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_b-d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_b-e"), 1),

                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_b-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_b-b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_b-c"), 1),
        ...
        context.register(LAYOUT_ROOMS_C, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_c-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_c-b"), 1),
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_c-c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_c-d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_c-e"), 1),

                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_c-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_c-b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_c-c"), 1),
        ...
        context.register(LAYOUT_ROOMS_D, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_d-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_d-b"), 1),
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_d-c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_d-d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_d-e"), 1),

                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_d-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_d-b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_d-c"), 1),
        ...
        context.register(LAYOUT_ROOMS_E, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_e-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_e-b"), 1),
                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_e-c"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_e-d"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/room_e-e"), 1),

                        //Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_e-a"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_e-b"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/additional_rooms/challenge_room_e-c"), 1),
        ...
        context.register(LAYOUT_PATH_MEDIUM_1_EYE, new StructureTemplatePool(
                ...
                ImmutableList.of(
                        ...
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/layouts/paths/medium/1_eye/path_02_a_m"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        ...
        context.register(STAIRCASES_FLOOR_1, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/staircases/floor_1/staircase_01"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/staircases/floor_1/staircase_02"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/staircases/floor_1/staircase_03"), 1),
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/staircases/floor_1/staircase_04"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        ...
        context.register(ROOMS_0_0_A_B, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/rooms/0-0-a-b_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(ROOMS_0_E_A_A, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/rooms/0-e-a-a_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        ...
        context.register(CHALLENGE_ROOMS_E_B_0_B, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/challenge_rooms/e-b-0-bc_01"), 1)
                ),
        ...
        context.register(BOSS_ROOM, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/boss_room"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        ...
        context.register(CORRIDORS_A_A, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/a-a_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_A_B, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/a-b_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_A_C, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/a-c_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_A_D, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/a-d_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_A_E, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/a-e_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_B_B, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/b-b_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_B_C, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/b-c_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_B_D, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/b-d_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_B_E, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/b-e_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_C_C, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/c-c_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_C_D, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/c-d_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_C_E, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/c-e_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_D_D, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/d-d_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_D_E, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/d-e_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
        context.register(CORRIDORS_E_E, new StructureTemplatePool(
                fallback,
                ImmutableList.of(
                        Pair.of(AetherIIPools.aetherPoolUnderground("infected_guardian_tree/corridors/e-e_01"), 1)
                ),
                StructureTemplatePool.Projection.RIGID)
        );
