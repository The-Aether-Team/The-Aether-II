    ...
    public static Biome makeHighfieldsBiome(Optional<ResourceKey<PlacedFeature>> tree, BiomeGenerationSettings.Builder builder, MobSpawnSettings.Builder spawnSettingsBuilder, float temperature, float downfall) {
        ...
        return fullDefinition(
                ...
                spawnSettingsBuilder
                        ...
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.ARKENIUM_TALOTON.get(), 1, 1, 1))
                        .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AetherIIEntityTypes.GRAVITITE_TALOTON.get(), 1, 1, 1))
                        .build(),
                builder.build(),
