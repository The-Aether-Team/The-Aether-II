...
public class AetherIIJukeboxSongs {
    ...
    public static void bootstrap(BootstrapContext<JukeboxSong> context) {
        register(context, AETHER_TUNE, (Holder.Reference<SoundEvent>) AetherIISoundEvents.ITEM_ENGRAVED_DISC_AETHER_TUNE.getDelegate(), 149, 1);
        ...
        register(context, CHASE, (Holder.Reference<SoundEvent>) AetherIISoundEvents.ITEM_ENGRAVED_DISC_CHASE.getDelegate(), 97, 9);
    }
