...
public class AetherIIMurals {
    ...
    public static final Registry<Mural> MURALS_REGISTRY = MURALS.makeRegistry((builder) -> builder
        .sync(true)
        .defaultKey(ResourceLocation.fromNamespaceAndPath(AetherII.MODID, "test"))
    );
