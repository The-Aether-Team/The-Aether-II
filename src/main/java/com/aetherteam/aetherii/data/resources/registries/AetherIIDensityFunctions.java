...
public class AetherIIDensityFunctions {
    ...
    public static void bootstrap(BootstapContext<DensityFunction> context) {
        ...
        context.register(CLOUDBED_BASE, new PerlinNoiseFunction(new NormalNoise.NoiseParameters(0, 1, 1, 1, 1, 1), 0.00375D, 0.0D, 42));
        context.register(CLOUDBED_Y_OFFSET, new PerlinNoiseFunction(new NormalNoise.NoiseParameters(0, 1, 1), 0.0025D, 0.0D, 95));
