...
public class AetherIIDensityFunctions extends AetherIIDensityFunctionBuilders {
    public static void bootstrap(BootstrapContext<DensityFunction> context) {
        ...
        context.register(VEGETATION_RARE, DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.3, noise.getOrThrow(AetherIINoises.VEGETATION_RARE)));
        ...
        context.register(FINAL_ISLANDS, buildFinalDensity(function));
