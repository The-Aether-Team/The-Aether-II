...
public class AetherIIDensityFunctions extends AetherIIDensityFunctionBuilders {
    public static void bootstrap(BootstrapContext<DensityFunction> context) {
        ...
        context.register(STRUCTURES_DECAY, DensityFunctions.add(new PerlinNoiseFunction(new NormalNoise.NoiseParameters(-3, 0.75F, 1.0, 0.75, 0.0, 0.0, 0.0, 0.0), 1.5D, 0.75D, 500), DensityFunctions.constant(-0.1D)));
        context.register(STRUCTURES_DECAY_REDUCED, DensityFunctions.add(new PerlinNoiseFunction(new NormalNoise.NoiseParameters(-3, 0.75F, 1.0, 0.75, 0.0, 0.0, 0.0, 0.0), 1.5D, 0.75D, 500), DensityFunctions.constant(-0.15D)));
