...
public class AetherIIBestiaryEntries {
    ...
    public static final Map<Holder<EntityType<?>>, List<BestiaryEntry.LootDisplay>> LOOT = Map.ofEntries(
            ...
            Map.entry(AetherIIEntityTypes.HIGHFIELDS_BURRUKAI, List.of(BestiaryEntry.LootDisplay.item(AetherIIItems.BURRUKAI_RIB_CUT, 1.0, 1, 3), BestiaryEntry.LootDisplay.item(AetherIIItems.BURRUKAI_PLATE, 1.0, 1, 3))),
            Map.entry(AetherIIEntityTypes.MAGNETIC_BURRUKAI, List.of(BestiaryEntry.LootDisplay.item(AetherIIItems.BURRUKAI_RIB_CUT, 1.0, 1, 3), BestiaryEntry.LootDisplay.item(AetherIIItems.BURRUKAI_PLATE, 1.0, 1, 3))),
            Map.entry(AetherIIEntityTypes.ARCTIC_BURRUKAI, List.of(BestiaryEntry.LootDisplay.item(AetherIIItems.BURRUKAI_RIB_CUT, 1.0, 1, 3), BestiaryEntry.LootDisplay.item(AetherIIItems.BURRUKAI_PLATE, 1.0, 1, 3))),
