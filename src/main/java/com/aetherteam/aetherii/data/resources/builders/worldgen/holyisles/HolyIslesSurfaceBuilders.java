...
public class HolyIslesSurfaceBuilders {
    ...
    private static final Function<HolderGetter<DensityFunction>, SurfaceRules.RuleSource> MOSSY_HOLYSTONE = (function) -> new DensityFunctionRule(List.of(new DensityFunctionRule.DensityTest(AetherIIBlocks.MOSSY_HOLYSTONE.get().defaultBlockState(), -1.0, 0.0)), AetherIIDensityFunctions.getFunction(function, AetherIIDensityFunctions.STRATA_MOSSY_HOLYSTONE));
    private static final Function<HolderGetter<DensityFunction>, SurfaceRules.RuleSource> MOSSY_UNDERSHALE = (function) -> new DensityFunctionRule(List.of(new DensityFunctionRule.DensityTest(AetherIIBlocks.MOSSY_UNDERSHALE.get().defaultBlockState(), -0.3, 0.0)), AetherIIDensityFunctions.getFunction(function, AetherIIDensityFunctions.STRATA_MOSSY_HOLYSTONE));
    ...
    private static final Function<HolderGetter<DensityFunction>, SurfaceRules.RuleSource> ARCTIC_PACKED_ICE = (function) -> new DensityFunctionRule(List.of(new DensityFunctionRule.DensityTest(AetherIIBlocks.ARCTIC_PACKED_ICE.get().defaultBlockState(), 0.0, 0.5)), AetherIIDensityFunctions.getFunction(function, AetherIIDensityFunctions.STRATA_ARCTIC_PACKED_ICE));
    ...
    public static SurfaceRules.RuleSource surfaceRules(HolderGetter<DensityFunction> function) {
        ...
        return SurfaceRules.sequence(
                ...
                SurfaceRules.ifTrue(SurfaceRules.verticalGradient("mossy_undershale", VerticalAnchor.absolute(89), VerticalAnchor.absolute(101)), SurfaceRules.ifTrue(SurfaceRules.isBiome(HolyIslesBiomes.FLOURISHING_FIELD), MOSSY_UNDERSHALE.apply(function))),
                SurfaceRules.ifTrue(SurfaceRules.verticalGradient("mossy_undershale", VerticalAnchor.absolute(89), VerticalAnchor.absolute(101)), SurfaceRules.ifTrue(SurfaceRules.isBiome(HolyIslesBiomes.VERDANT_WOODS), MOSSY_UNDERSHALE.apply(function))),
                SurfaceRules.ifTrue(SurfaceRules.verticalGradient("mossy_undershale", VerticalAnchor.absolute(89), VerticalAnchor.absolute(101)), SurfaceRules.ifTrue(SurfaceRules.isBiome(HolyIslesBiomes.SHROUDED_FOREST), MOSSY_UNDERSHALE.apply(function))),
                SurfaceRules.ifTrue(SurfaceRules.verticalGradient("mossy_undershale", VerticalAnchor.absolute(89), VerticalAnchor.absolute(101)), SurfaceRules.ifTrue(SurfaceRules.isBiome(HolyIslesBiomes.SHIMMERING_BASIN), MOSSY_UNDERSHALE.apply(function))),
