...
public class AetherIIStructures {
    ...
    public static void bootstrap(BootstrapContext<Structure> context) {
        ...
        context.register(OUTPOST, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(OutpostPools.OUTPOST), Optional.empty(), 10, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of(), DimensionPadding.ZERO, LiquidSettings.IGNORE_WATERLOGGING));
        ...
        context.register(INFECTED_GUARDIAN_TREE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(InfectedGuardianTreePools.TRUNK_BASE), Optional.empty(), 20, ConstantHeight.of(VerticalAnchor.absolute(-3)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 196, 128, 156, true, List.of(), DimensionPadding.ZERO, LiquidSettings.IGNORE_WATERLOGGING));
    }
}