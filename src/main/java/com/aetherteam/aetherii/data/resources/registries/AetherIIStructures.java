...
public class AetherIIStructures {
    ...
    public static void bootstrap(BootstrapContext<Structure> context) {
        ...
        context.register(INFECTED_GUARDIAN_TREE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(InfectedGuardianTreePools.TRUNK_BASE), Optional.empty(), 20, ConstantHeight.of(VerticalAnchor.absolute(-3)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 128, 112, 156, true, List.of(), DimensionPadding.ZERO, LiquidSettings.IGNORE_WATERLOGGING));
    }
}