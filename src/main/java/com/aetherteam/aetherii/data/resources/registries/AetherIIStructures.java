...
public class AetherIIStructures {
    ...
    public static void bootstrap(BootstrapContext<Structure> context) {
        ...
        context.register(INFECTED_GUARDIAN_TREE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(InfectedGuardianTreePools.START_ROOM), Optional.empty(), 20, ConstantHeight.of(VerticalAnchor.absolute(-20)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 156, true, List.of(), DimensionPadding.ZERO, LiquidSettings.IGNORE_WATERLOGGING));
