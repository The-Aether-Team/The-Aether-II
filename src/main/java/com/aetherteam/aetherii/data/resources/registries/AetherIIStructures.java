...
public class AetherIIStructures {
    ...
    public static void bootstrap(BootstrapContext<Structure> context) {
        ...
        context.register(UNDERCLOUD_MINESHAFT, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(UndercloudMineshaftPools.HUB), Optional.empty(), 8, UniformHeight.of(VerticalAnchor.absolute(32), VerticalAnchor.absolute(80)), Optional.empty(), new JigsawStructure.MaxDistance(48, 32), 24, 96, true, List.of(), DimensionPadding.ZERO, LiquidSettings.IGNORE_WATERLOGGING));
