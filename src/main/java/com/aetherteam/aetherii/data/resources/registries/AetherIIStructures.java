...
public class AetherIIStructures {
    ...
    public static void bootstrap(BootstrapContext<Structure> context) {
        ...
        context.register(INFECTED_GUARDIAN_TREE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(InfectedGuardianTreePools.ENTRANCE), Optional.empty(), 12, ConstantHeight.of(VerticalAnchor.absolute(-16)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 128, 128, 160, List.of(), DimensionPadding.ZERO, LiquidSettings.IGNORE_WATERLOGGING));
    }
}