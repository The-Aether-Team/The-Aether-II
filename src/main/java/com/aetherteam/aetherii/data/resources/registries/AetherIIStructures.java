...
public class AetherIIStructures {
    ...
    public static void bootstrap(BootstapContext<Structure> context) {
        ...
        context.register(OUTPOST, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(OutpostPools.OUTPOST), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(-1)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        ...
        context.register(CAMP_HIGHFIELDS, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(CampPools.HIGHFIELDS_CENTER), Optional.empty(), 20, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        context.register(CAMP_MAGNETIC, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(CampPools.MAGNETIC_CENTER), Optional.empty(), 20, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        context.register(CAMP_ARCTIC, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(CampPools.ARCTIC_CENTER), Optional.empty(), 20, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        ...
        context.register(WATCHTOWER, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(WatchtowerPools.WATCHTOWER), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        ...
        context.register(ANIMAL_DEN, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(AnimalDenPools.ANIMAL_DEN), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(-2)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 10, 128, 256, false, List.of()));
        ...
        context.register(VERADEXIAN_RUINS_TEMPERATE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(VeradexianRuinPools.RUIN_CENTERS_TEMPERATE), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        context.register(VERADEXIAN_RUINS_ARCTIC, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(VeradexianRuinPools.RUIN_CENTERS_ARCTIC), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        context.register(VERADEXIAN_LIBRARY_TEMPERATE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(VeradexianLibraryPools.ENTRANCE_TEMPERATE), Optional.empty(), 5, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        context.register(VERADEXIAN_LIBRARY_ARCTIC, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(VeradexianLibraryPools.ENTRANCE_ARCTIC), Optional.empty(), 5, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        context.register(VERADEXIAN_AQUEDUCT, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(VeradexianAqueductPools.AQUEDUCT), Optional.empty(), 5, ConstantHeight.of(VerticalAnchor.absolute(120)), Optional.empty(), 48, 96, 256, false, List.of()));
        ...
        context.register(BREXALLEN_RUINS, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(BrexallenRuinPools.RUIN_CENTERS), Optional.empty(), 3, UniformHeight.of(VerticalAnchor.absolute(32), VerticalAnchor.absolute(80)), Optional.empty(), 32, 24, 112, false, List.of()));
        ...
        context.register(UNDERCLOUD_MINESHAFT, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(UndercloudMineshaftPools.HUB), Optional.empty(), 8, UniformHeight.of(VerticalAnchor.absolute(32), VerticalAnchor.absolute(80)), Optional.empty(), 64, 24, 96, true, List.of()));
        ...
        context.register(ANCIENT_HENGE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(AncientHengePools.CENTER), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        ...
        context.register(IRRADIATED_BUNKER_REMNANTS, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(IrradiatedRemnantsPools.IRRADIATED_BUNKER_REMNANTS), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        context.register(IRRADIATED_SETTLEMENT_REMNANTS, new AetherJigsawStructure(
                AetherIIStructureBuilders.structure(biomes.getOrThrow(AetherIITags.Biomes.HAS_STRUCTURE_IRRADIATED_REMNANTS), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
                templatePools.getOrThrow(IrradiatedRemnantsPools.IRRADIATED_SETTLEMENT_REMNANTS), Optional.empty(), 3, ConstantHeight.of(VerticalAnchor.absolute(0)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 32, 128, 256, false, List.of()));
        ...
        context.register(INFECTED_GUARDIAN_TREE, new AetherJigsawStructure(
                ...
                templatePools.getOrThrow(InfectedGuardianTreePools.ENTRANCE), Optional.empty(), 13, ConstantHeight.of(VerticalAnchor.absolute(-3)), Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 156, 0, 384, false, List.of())); //placeholder values
    }
}
