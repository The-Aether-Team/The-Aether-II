    ...
    public static void bootstrap(BootstrapContext<StructureProcessorList> context) {
        ...
        register(context, UNDERCLOUD_MINESHAFT, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        ...
                        new ProcessorRule(new RandomBlockMatchTest(AetherIIBlocks.AMBROSIUM_TORCH.get(), 0.875F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AetherIIBlocks.AMBROSIUM_WALL_TORCH.get(), 0.875F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
