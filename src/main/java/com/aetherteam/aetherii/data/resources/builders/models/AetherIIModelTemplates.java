...
public class AetherIIModelTemplates {
    ...
    public static final ModelTemplate AMBROSIUM_CAMPFIRE = create("template_ambrosium_campfire", AetherIITextureSlots.STONE, AetherIITextureSlots.LOG, TextureSlot.PARTICLE);
