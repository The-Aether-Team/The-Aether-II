...
public class AetherIIModelTemplates {
    ...
    public static final ModelTemplate PORTAL_NS = ModelTemplates.create("nether_portal_ns", "_ns", AetherIITextureSlots.PORTAL, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("translucent")).build();
    public static final ModelTemplate PORTAL_EW = ModelTemplates.create("nether_portal_ew", "_ew", AetherIITextureSlots.PORTAL, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("translucent")).build();
    ...
    public static final ModelTemplate LEAVES = ModelTemplates.create("leaves", TextureSlot.ALL).extend().renderType(Identifier.withDefaultNamespace("cutout_mipped")).build();
    public static final ModelTemplate TRANSLUCENT_INNER_FACES = ModelTemplates.create("cube", TextureSlot.PARTICLE, TextureSlot.NORTH, TextureSlot.SOUTH, TextureSlot.EAST, TextureSlot.WEST, TextureSlot.UP, TextureSlot.DOWN).extend()
            .renderType(Identifier.withDefaultNamespace("translucent"))
            .element((builder) -> builder
    ...
    public static final ModelTemplate LADDER = ModelTemplates.create("ladder", TextureSlot.TEXTURE, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    ...
    public static final ModelTemplate POINTED_STONE_BLOCK = ModelTemplates.create("pointed_dripstone", TextureSlot.CROSS).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();

    public static final ModelTemplate TEMPLATE_EMISSIVE_CUBE_ALL =  AetherIIModelTemplates.create("emissive_cube_all", TextureSlot.ALL, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_CUBE_COLUMN =  AetherIIModelTemplates.create("emissive_cube_column", TextureSlot.SIDE, TextureSlot.END, AetherIITextureSlots.EMISSIVE_SIDE, AetherIITextureSlots.EMISSIVE_END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_CUBE_COLUMN_HORIZONTAL =  AetherIIModelTemplates.create("emissive_cube_column_horizontal", "_horizontal", TextureSlot.SIDE, TextureSlot.END, AetherIITextureSlots.EMISSIVE_SIDE, AetherIITextureSlots.EMISSIVE_END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_STAIRS_STRAIGHT = create("emissive_stairs", TextureSlot.ALL, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_STAIRS_INNER = create("emissive_inner_stairs", "_inner", TextureSlot.ALL, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_STAIRS_OUTER = create("emissive_outer_stairs", "_outer", TextureSlot.ALL, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_SLAB_BOTTOM = create("emissive_slab", TextureSlot.ALL, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_SLAB_TOP = create("emissive_slab_top", "_top", TextureSlot.ALL, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    ...
    public static final ModelTemplate EMISSIVE_COLUMN_WALL_POST = create("template_emissive_column_wall_post", "_post", TextureSlot.END, TextureSlot.SIDE, AetherIITextureSlots.EMISSIVE_END, AetherIITextureSlots.EMISSIVE_SIDE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate EMISSIVE_COLUMN_WALL_LOW_SIDE = create("template_emissive_column_wall_side", "_side", TextureSlot.END, TextureSlot.SIDE, AetherIITextureSlots.EMISSIVE_END, AetherIITextureSlots.EMISSIVE_SIDE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate EMISSIVE_COLUMN_WALL_TALL_SIDE = create("template_emissive_column_wall_side_tall", "_side_tall", TextureSlot.END, TextureSlot.SIDE, AetherIITextureSlots.EMISSIVE_END, AetherIITextureSlots.EMISSIVE_SIDE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    ...
    public static final ModelTemplate TEMPLATE_EMISSIVE_BUTTON =  AetherIIModelTemplates.create("template_emissive_button", TextureSlot.TEXTURE, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_BUTTON_PRESSED =  AetherIIModelTemplates.create("template_emissive_button_pressed", "_pressed", TextureSlot.TEXTURE, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TEMPLATE_EMISSIVE_BUTTON_INVENTORY =  AetherIIModelTemplates.create("template_emissive_button_inventory", "_inventory", TextureSlot.TEXTURE, AetherIITextureSlots.EMISSIVE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    ...
    public static final ModelTemplate MOSS_VINE = create("moss_vine", AetherIITextureSlots.VINE, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate ASYMMETRICAL_CROSS_EVEN = create("asymmetrical_cross_even", TextureSlot.CROSS, AetherIITextureSlots.CROSS_OTHER, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate ASYMMETRICAL_CROSS_EVEN_MIRRORED = create("asymmetrical_cross_even_mirrored", "_mirrored", TextureSlot.CROSS, AetherIITextureSlots.CROSS_OTHER, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate ASYMMETRICAL_CROSS_ODD = create("asymmetrical_cross_odd", TextureSlot.CROSS, AetherIITextureSlots.CROSS_OTHER, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate ASYMMETRICAL_CROSS_ODD_MIRRORED = create("asymmetrical_cross_odd_mirrored", "_mirrored", TextureSlot.CROSS, AetherIITextureSlots.CROSS_OTHER, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate POTTED_ASYMMETRICAL_CROSS_EVEN = create("flower_pot_asymmetrical_cross_even", TextureSlot.CROSS, AetherIITextureSlots.CROSS_OTHER).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate POTTED_ASYMMETRICAL_CROSS_ODD = create("flower_pot_asymmetrical_cross_odd", TextureSlot.CROSS, AetherIITextureSlots.CROSS_OTHER).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate LILICHIME = create("template_lilichime", TextureSlot.STEM, AetherIITextureSlots.PETALS, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate PLURACIAN = create("template_pluracian", TextureSlot.STEM, AetherIITextureSlots.LEAVES1, AetherIITextureSlots.LEAVES2, AetherIITextureSlots.PETAL_TOP, AetherIITextureSlots.PETAL_BOTTOM, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate POTTED_LILICHIME = create("flower_pot_lilichime", TextureSlot.STEM, AetherIITextureSlots.PETALS).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate POTTED_PLURACIAN = create("flower_pot_pluracian", TextureSlot.STEM, AetherIITextureSlots.LEAVES1, AetherIITextureSlots.LEAVES2, AetherIITextureSlots.PETAL_TOP, AetherIITextureSlots.PETAL_BOTTOM).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate POTTED_BUSH_BLOCK = create("flower_pot_bush_block", TextureSlot.STEM, AetherIITextureSlots.BUSH).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate BRYALINN_MOSS_FLOWERS_1 = create("template_bryalinn_moss_flowers_1", "_1", TextureSlot.FLOWERBED, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate BRYALINN_MOSS_FLOWERS_2 = create("template_bryalinn_moss_flowers_2", "_2", TextureSlot.FLOWERBED, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate BRYALINN_MOSS_FLOWERS_3 = create("template_bryalinn_moss_flowers_3", "_3", TextureSlot.FLOWERBED, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate BRYALINN_MOSS_FLOWERS_4 = create("template_bryalinn_moss_flowers_4", "_4", TextureSlot.FLOWERBED, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate HOLPUPEA_1 = create("template_holpupea_1", "_1", TextureSlot.FLOWERBED, TextureSlot.STEM, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate HOLPUPEA_2 = create("template_holpupea_2", "_2", TextureSlot.FLOWERBED, TextureSlot.STEM, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate HOLPUPEA_3 = create("template_holpupea_3", "_3", TextureSlot.FLOWERBED, TextureSlot.STEM, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate HOLPUPEA_4 = create("template_holpupea_4", "_4", TextureSlot.FLOWERBED, TextureSlot.STEM, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TARAHESP_FLOWERS_1 = create("template_tarahesp_flowers_1", "_1", AetherIITextureSlots.TARAHESP_FLOWERS_PURPLE, AetherIITextureSlots.TARAHESP_FLOWERS_WHITE, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TARAHESP_FLOWERS_2 = create("template_tarahesp_flowers_2", "_2", AetherIITextureSlots.TARAHESP_FLOWERS_PURPLE, AetherIITextureSlots.TARAHESP_FLOWERS_WHITE, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TARAHESP_FLOWERS_3 = create("template_tarahesp_flowers_3", "_3", AetherIITextureSlots.TARAHESP_FLOWERS_PURPLE, AetherIITextureSlots.TARAHESP_FLOWERS_WHITE, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate TARAHESP_FLOWERS_4 = create("template_tarahesp_flowers_4", "_4", AetherIITextureSlots.TARAHESP_FLOWERS_PURPLE, AetherIITextureSlots.TARAHESP_FLOWERS_WHITE, TextureSlot.PARTICLE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    ...
    public static final ModelTemplate CARPET_CUTOUT = ModelTemplates.create("carpet", TextureSlot.WOOL).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate MOSSY_CARPET_SIDE_CUTOUT = ModelTemplates.create("mossy_carpet_side", TextureSlot.SIDE).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_BOTTOM_LEFT = create("door_bottom_left", "_bottom_left", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_BOTTOM_LEFT_OPEN = create("door_bottom_left_open", "_bottom_left_open", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_BOTTOM_RIGHT = create("door_bottom_right", "_bottom_right", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_BOTTOM_RIGHT_OPEN = create("door_bottom_right_open", "_bottom_right_open", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_TOP_LEFT = create("door_top_left", "_top_left", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_TOP_LEFT_OPEN = create("door_top_left_open", "_top_left_open", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_TOP_RIGHT = create("door_top_right", "_top_right", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate DOOR_TOP_RIGHT_OPEN = create("door_top_right_open", "_top_right_open", TextureSlot.FRONT, TextureSlot.SIDE, TextureSlot.END).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    ...
    public static final ModelTemplate AMBER_HOURGLASS = create("template_amber_hourglass", TextureSlot.CROSS, TextureSlot.TOP, TextureSlot.SIDE, TextureSlot.BOTTOM, TextureSlot.INNER_TOP, AetherIITextureSlots.INNER_BOTTOM).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();
    ...
    public static final ModelTemplate LOCKED_BLOCK_INVENTORY = createItem("locked_block_inventory", AetherIITextureSlots.FACE, AetherIITextureSlots.OVERLAY).extend().renderType(Identifier.withDefaultNamespace("cutout")).build();

    public static final ModelTemplate TRANSLUCENT_FLAT_ITEM = ModelTemplates.FLAT_ITEM.extend().renderType(Identifier.withDefaultNamespace("translucent")).build();
