...
public class AetherIIModelTemplates {
    ...
    public static final ModelTemplate TINTED_GRASS = ModelTemplates.create("block", TextureSlot.BOTTOM, TextureSlot.PARTICLE, TextureSlot.TOP, AetherIITextureSlots.TOP_1, AetherIITextureSlots.TOP_2, AetherIITextureSlots.TOP_3, TextureSlot.SIDE, AetherIITextureSlots.SIDE_OVERLAY_1, AetherIITextureSlots.SIDE_OVERLAY_2, AetherIITextureSlots.SIDE_OVERLAY_3).extend()
            ...
            .element((builder) -> builder
                    ...
                    .face(Direction.UP, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(TextureSlot.TOP).tintindex(1).cullface(Direction.UP))
                    ...
                    .from(0.0F, 0.0F, 0.0F).to(16.0F, 16.0F, 16.0F)
                    .face(Direction.UP, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.TOP_1).tintindex(1).cullface(Direction.UP))
                    .face(Direction.NORTH, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_1).tintindex(1).cullface(Direction.NORTH))
                    .face(Direction.SOUTH, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_1).tintindex(1).cullface(Direction.SOUTH))
                    .face(Direction.WEST, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_1).tintindex(1).cullface(Direction.WEST))
                    .face(Direction.EAST, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_1).tintindex(1).cullface(Direction.EAST))
            ).element((builder) -> builder
                    .from(0.0F, 0.0F, 0.0F).to(16.0F, 16.0F, 16.0F)
                    .face(Direction.UP, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.TOP_2).tintindex(2).cullface(Direction.UP))
                    .face(Direction.NORTH, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_2).tintindex(2).cullface(Direction.NORTH))
                    .face(Direction.SOUTH, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_2).tintindex(2).cullface(Direction.SOUTH))
                    .face(Direction.WEST, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_2).tintindex(2).cullface(Direction.WEST))
                    .face(Direction.EAST, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_2).tintindex(2).cullface(Direction.EAST))
            ).element((builder) -> builder
                    .from(0.0F, 0.0F, 0.0F).to(16.0F, 16.0F, 16.0F)
                    .face(Direction.UP, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.TOP_3).tintindex(3).cullface(Direction.UP))
                    .face(Direction.NORTH, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_3).tintindex(3).cullface(Direction.NORTH))
                    .face(Direction.SOUTH, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_3).tintindex(3).cullface(Direction.SOUTH))
                    .face(Direction.WEST, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_3).tintindex(3).cullface(Direction.WEST))
                    .face(Direction.EAST, (faceBuilder) -> faceBuilder.uvs(0, 0, 16, 16).texture(AetherIITextureSlots.SIDE_OVERLAY_3).tintindex(3).cullface(Direction.EAST))
            ).build();
