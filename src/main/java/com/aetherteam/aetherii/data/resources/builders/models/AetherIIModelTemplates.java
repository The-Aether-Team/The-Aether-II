...
public class AetherIIModelTemplates {
    ...
    public static final ModelTemplate MULTIFACE = create("multiface_block", TextureSlot.TEXTURE, TextureSlot.PARTICLE).extend().renderType(ResourceLocation.withDefaultNamespace("cutout")).build();
