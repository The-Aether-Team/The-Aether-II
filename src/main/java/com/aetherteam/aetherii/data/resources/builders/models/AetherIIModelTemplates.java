...
public class AetherIIModelTemplates {
    ...
    public static final ModelTemplate AMBER_HOURGLASS = create("template_amber_hourglass", TextureSlot.CROSS, TextureSlot.TOP, TextureSlot.SIDE, TextureSlot.BOTTOM, TextureSlot.INNER_TOP, AetherIITextureSlots.INNER_BOTTOM).extend().renderType(ResourceLocation.withDefaultNamespace("cutout")).build();
