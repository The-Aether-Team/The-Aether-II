...
public class AetherIIModelTemplates {
    ...
    public static final ModelTemplate AETHER_CLOVER = create("template_aether_clover", TextureSlot.STEM, TextureSlot.FLOWERBED, TextureSlot.PARTICLE).extend().renderType(ResourceLocation.withDefaultNamespace("cutout")).build();
    public static final ModelTemplate AETHER_CLOVER_TALL = create("template_aether_clover_tall", TextureSlot.STEM, TextureSlot.FLOWERBED, TextureSlot.PARTICLE).extend().renderType(ResourceLocation.withDefaultNamespace("cutout")).build();
