...
public class AetherIIPools {
    ...
    public static Function<StructureTemplatePool.Projection, AetherPoolElement> aetherPoolUnderground(String id) {
        return pool -> new AetherPoolElement(Either.left(ResourceLocation.fromNamespaceAndPath(AetherII.MODID, id)), EMPTY, pool, Optional.of(LiquidSettings.IGNORE_WATERLOGGING), 0, 384, false);
    }
