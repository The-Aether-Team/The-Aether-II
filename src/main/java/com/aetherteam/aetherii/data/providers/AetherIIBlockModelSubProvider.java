...
public class AetherIIBlockModelSubProvider extends BlockModelGenerators {
    ...
    public void createTrunk(Block trunk, Block log) {
        ...
        MultiPartGenerator model = MultiPartGenerator.multiPart(trunk)
                ...
                .with(Condition.condition().term(TrunkBlock.NORTH_CONNECTION, TrunkBlock.TrunkConnection.NORMAL), Variant.variant().with(VariantProperties.MODEL, side).with(VariantProperties.UV_LOCK, true))
                .with(Condition.condition().term(TrunkBlock.EAST_CONNECTION, TrunkBlock.TrunkConnection.NORMAL), Variant.variant().with(VariantProperties.MODEL, side).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true))
                .with(Condition.condition().term(TrunkBlock.SOUTH_CONNECTION, TrunkBlock.TrunkConnection.NORMAL), Variant.variant().with(VariantProperties.MODEL, side).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, true))
                .with(Condition.condition().term(TrunkBlock.WEST_CONNECTION, TrunkBlock.TrunkConnection.NORMAL), Variant.variant().with(VariantProperties.MODEL, side).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true))
                .with(Condition.condition().term(TrunkBlock.NORTH_CONNECTION, TrunkBlock.TrunkConnection.TALL), Variant.variant().with(VariantProperties.MODEL, sideTall).with(VariantProperties.UV_LOCK, true))
                .with(Condition.condition().term(TrunkBlock.EAST_CONNECTION,TrunkBlock.TrunkConnection.TALL), Variant.variant().with(VariantProperties.MODEL, sideTall).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true))
                .with(Condition.condition().term(TrunkBlock.SOUTH_CONNECTION, TrunkBlock.TrunkConnection.TALL), Variant.variant().with(VariantProperties.MODEL, sideTall).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, true))
                .with(Condition.condition().term(TrunkBlock.WEST_CONNECTION, TrunkBlock.TrunkConnection.TALL), Variant.variant().with(VariantProperties.MODEL, sideTall).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true))
