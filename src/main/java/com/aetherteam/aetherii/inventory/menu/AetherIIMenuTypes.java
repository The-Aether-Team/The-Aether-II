...
public class AetherIIMenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<HolystoneSmokerMenu>> HOLYSTONE_SMOKER = register("holystone_smoker", HolystoneSmokerMenu::new);
    ...
    public static void registerMenuScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(AetherIIMenuTypes.HOLYSTONE_SMOKER.get(), HolystoneSmokerScreen::new);
        ...
        event.register(AetherIIMenuTypes.ALKAHEST_PURIFIER.get(), AlkahestPurifierScreen::new);
    }
}