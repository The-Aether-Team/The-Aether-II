...
public class AetherIICreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_BUILDING_BLOCKS = CREATIVE_MODE_TABS.register("building_blocks", () -> CreativeModeTab.builder()
            .withTabsBefore(CreativeModeTabs.SPAWN_EGGS)
            .withTabsAfter(new ResourceLocation(AetherII.MODID, "colored_blocks"))
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_COLORED_BLOCKS = CREATIVE_MODE_TABS.register("colored_blocks", () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_NATURAL_BLOCKS = CREATIVE_MODE_TABS.register("natural_blocks", () -> CreativeModeTab.builder()
            .withTabsBefore(new ResourceLocation(AetherII.MODID, "colored_blocks"))
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_FUNCTIONAL_BLOCKS = CREATIVE_MODE_TABS.register("functional_blocks", () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_DUNGEON_BLOCKS =
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_TOOLS_AND_UTILITIES = CREATIVE_MODE_TABS.register("tools_and_utilities", () -> CreativeModeTab.builder()
            .withTabsBefore(new ResourceLocation(AetherII.MODID, "functional_blocks"))
            .withTabsAfter(new ResourceLocation(AetherII.MODID, "combat_and_equipment"))
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_COMBAT_AND_EQUIPMENT = CREATIVE_MODE_TABS.register("combat_and_equipment", () -> CreativeModeTab.builder()
            .withTabsBefore(new ResourceLocation(AetherII.MODID, "tools_and_utilities"))
            .withTabsAfter(new ResourceLocation(AetherII.MODID, "consumables"))
            ...
            .displayItems((features, output) -> {
                ...
                output.accept(componentStack(AetherIIItems.AMBER_DARTS, 1, DataComponentPatch.builder().set(AetherIIDataComponents.BUILDUP_CONTENTS.get(), new BuildupContents(EffectBuildupPresets.VULNERABILITY)).build()));
                output.accept(componentStack(AetherIIItems.AMBER_DARTS, 1, DataComponentPatch.builder().set(AetherIIDataComponents.BUILDUP_CONTENTS.get(), new BuildupContents(EffectBuildupPresets.TOXIN)).build()));
                output.accept(componentStack(AetherIIItems.AMBER_DARTS, 1, DataComponentPatch.builder().set(AetherIIDataComponents.BUILDUP_CONTENTS.get(), new BuildupContents(EffectBuildupPresets.VENOM)).build()));
                output.accept(componentStack(AetherIIItems.AMBER_DARTS, 1, DataComponentPatch.builder().set(AetherIIDataComponents.BUILDUP_CONTENTS.get(), new BuildupContents(EffectBuildupPresets.AMBROSIUM_POISONING)).build()));
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_CONSUMABLES = CREATIVE_MODE_TABS.register("consumables", () -> CreativeModeTab.builder()
            ...
            .displayItems((features, output) -> {
                ...
                output.accept(componentStack(AetherIIItems.HEALING_STONE, 1, DataComponentPatch.builder().set(AetherIIDataComponents.HEALING_STONE_CHARGES.get(), 5).build()));
            }).build());

    public static final RegistryObject<CreativeModeTab> AETHER_II_INGREDIENTS = CREATIVE_MODE_TABS.register("ingredients", () -> CreativeModeTab.builder()
            .withTabsBefore(new ResourceLocation(AetherII.MODID, "consumables"))
...
//                output.accept(AetherIIItems.EYE_OF_THE_MIMIC.get());
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_II_SPAWN_EGGS = CREATIVE_MODE_TABS.register("spawn_eggs", () -> CreativeModeTab.builder()
    ...
    public static ItemStack getMoaBook() {
        final String selector = "entity @e[type=" + AetherIIEntityIds.MOA.location() + ",limit=1,sort=nearest] ";
        ...
        try {
            ItemStack book = new UtilityBookBuilder()
                    ...
                    .build();
            book.setHoverName(Component.literal("Moa Book").withStyle(Rarity.EPIC.getStyleModifier()).withStyle(style -> style.withItalic(false)));
            CompoundTag display = book.getOrCreateTagElement("display");
            ListTag lore = new ListTag();
            lore.add(StringTag.valueOf(Component.Serializer.toJson(Component.literal("Contains buttons to modify"))));
            lore.add(StringTag.valueOf(Component.Serializer.toJson(Component.literal("the nearest Moa's features"))));
    ...
    private static ItemStack componentStack(RegistryObject<? extends Item> item, int count, DataComponentPatch patch) {
