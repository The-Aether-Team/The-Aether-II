...
public class AetherIICreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> AETHER_II_EQUIPMENT_AND_UTILITIES = CREATIVE_MODE_TABS.register("equipment_and_utilities", () -> CreativeModeTab.builder()
            ...
            .displayItems((features, output) -> {
                ...
                output.accept(AetherIIItems.COMPACT_DISC_AERWHALE.get());
                output.accept(AetherIIItems.COMPACT_DISC_APPROACHES.get());
                output.accept(AetherIIItems.COMPACT_DISC_DEMISE.get());
                output.accept(AetherIIItems.COMPACT_DISC_CHINCHILLA.get());
                output.accept(AetherIIItems.COMPACT_DISC_HIGH.get());
                output.accept(AetherIIItems.COMPACT_DISC_REVOLUTIONS.get());
                output.accept(AetherIIItems.COMPACT_DISC_CHASE.get());
