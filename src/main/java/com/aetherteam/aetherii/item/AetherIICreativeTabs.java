...
public class AetherIICreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> AETHER_II_NATURAL_BLOCKS = CREATIVE_MODE_TABS.register("natural_blocks", () -> CreativeModeTab.builder()
            ...
            .displayItems((features, output) -> {
                ...
                output.accept(AetherIIBlocks.SKYROOT_LEAF_LITTER.get());
                output.accept(AetherIIBlocks.SKYPLANE_LEAF_LITTER.get());
                output.accept(AetherIIBlocks.SKYBIRCH_LEAF_LITTER.get());
                output.accept(AetherIIBlocks.SKYPINE_LEAF_LITTER.get());
                output.accept(AetherIIBlocks.WISPROOT_LEAF_LITTER.get());
                output.accept(AetherIIBlocks.WISPTOP_LEAF_LITTER.get());
                output.accept(AetherIIBlocks.GREATROOT_LEAF_LITTER.get());
