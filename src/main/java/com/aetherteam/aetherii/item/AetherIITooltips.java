    ...
    public static final TooltipTemplate CURATIVE = (stack, context, tooltipComponents, tooltipFlag) -> {
        ...
        if (consumable != null) {
            ...
            if (!removeEffects.isEmpty()) {
                ...
                tooltipComponents.add(Component.translatable("aether_ii.tooltip.item.curative.removes", removeComponents.withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.GREEN));
            }
            if (!reduceEffects.isEmpty()) {
                ...
                tooltipComponents.add(Component.translatable("aether_ii.tooltip.item.curative.reduces", reduceComponents.withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.DARK_GREEN));
            }
        }
    };
