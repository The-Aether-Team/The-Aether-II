...
public class SolidCanisterItem extends BlockItem implements DispensibleContainerItem {
    ...
    @Override
    public boolean emptyContents(@org.jetbrains.annotations.Nullable Player player, Level level, BlockPos pos, @org.jetbrains.annotations.Nullable BlockHitResult blockHitResult) {
