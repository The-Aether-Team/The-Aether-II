...
public class SkyrootMobBucketItem extends MobBucketItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (result.getResult() == InteractionResult.SUCCESS && result.getObject().is(Items.BUCKET)) {
            return new InteractionResultHolder<>(InteractionResult.SUCCESS, new ItemStack(AetherIIItems.SKYROOT_BUCKET.get()));
        }
        return result;
    }
}
