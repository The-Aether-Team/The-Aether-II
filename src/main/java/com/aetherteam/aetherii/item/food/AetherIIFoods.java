...
public class AetherIIFoods {
    ...
    public static final FoodProperties ENCHANTED_BLUEBERRY = new FoodProperties.Builder().fast().nutrition(6).saturationMod(0.8F).build();
    ...
    public static final FoodProperties BURRUKAI_RIBS = new FoodProperties.Builder().nutrition(8).saturationMod(0.8F).meat().build();
    public static final FoodProperties BURRUKAI_RIB_CUT = new FoodProperties.Builder().nutrition(4).saturationMod(0.3F).meat().build();
