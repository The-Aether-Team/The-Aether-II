...
public enum ReinforcementTier implements StringRepresentable, TooltipProvider {
    ...
    public static Component createReinforcementComponent(int tier) {
        return Component.translatable("aether_ii.tooltip.item.reinforcement", Component.translatable("enchantment.level." + tier)).withStyle(style -> style.withColor(14408667));
    }
