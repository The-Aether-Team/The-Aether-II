...
public class AetherIIDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Accessory>> ACCESSORY = DATA_COMPONENT_TYPES.register("accessory", () -> DataComponentType.<Accessory>builder().persistent(Accessory.CODEC).networkSynchronized(Accessory.STREAM_CODEC).build());
