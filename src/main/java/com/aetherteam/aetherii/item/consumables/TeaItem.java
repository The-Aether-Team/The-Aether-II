...
public class TeaItem extends Item {
    ...
    public TeaItem(ItemUseAnimation useAnimation, int useDuration, Holder<MobEffect> effect, Properties properties) {
        this(useAnimation, useDuration, () -> ItemStack.EMPTY, effect, properties);
    }

    public TeaItem(ItemUseAnimation useAnimation, int useDuration, Supplier<ItemStack> remainderItem, Holder<MobEffect> effect, Properties properties) {
        super(properties);
