...
public class TeaItem extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entityLiving) {
        ...
        assert player != null;
        player.getData(AetherIIDataAttachments.EFFECTS_SYSTEM).addBuildup(preset, 999); //TODO
        player.getData(AetherIIDataAttachments.EFFECTS_SYSTEM).addBuildup(preset, 1);
