...
public class UtilityBookBuilder {
    ...
    protected final ArrayList<Filterable<Component>> pages = new ArrayList<>();
    @Nullable
    ...
    public ItemStack build() {
        ...
        book.set(DataComponents.WRITTEN_BOOK_CONTENT, new WrittenBookContent(Filterable.passThrough(this.title), this.author, this.generation, this.pages, false));
        return book;
    }
