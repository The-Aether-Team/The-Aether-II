...
public class RusticArkeniumLanternBlock extends LitLanternBlock {
    private static final VoxelShape SHAPE_STANDING = Shapes.or(Block.column(8.0, 0.0, 1.0), Block.column(6.0, 1.0, 9.0), Block.column(8.0, 7.0, 8.0), Block.column(4.0, 9.0, 12.0));
