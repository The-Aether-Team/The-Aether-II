...
public interface FreezingBehavior<T> {
     ...
     */
    default int freezeBlockAt(Level level, BlockPos pos, BlockPos origin, BlockState oldBlockState, BlockState newBlockState, CommandFunction.CacheableFunction function, T source, int flag) {
