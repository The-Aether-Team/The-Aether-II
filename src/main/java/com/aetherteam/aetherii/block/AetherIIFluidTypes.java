...
public class AetherIIFluidTypes {
    ...
    public static final DeferredHolder<FluidType, FluidType> ACID_TYPE = FLUID_TYPES.register("acid", () -> new FluidType(FluidType.Properties.create()
                    ...
                    .sound(SoundActions.BUCKET_FILL, AetherIISoundEvents.ITEM_ARKENIUM_CANISTER_FILL_ACID.get())
                    .sound(SoundActions.BUCKET_EMPTY, AetherIISoundEvents.ITEM_ARKENIUM_CANISTER_EMPTY_ACID.get())
                    .lightLevel(8)
