...
public class AetherIIWoodTypes {
    ...
    public static final BlockSetType AMBEROOT_BLOCK_SET = new BlockSetType(new ResourceLocation(AetherII.MODID, "amberoot").toString());
    public static final WoodType AMBEROOT = new WoodType(new ResourceLocation(AetherII.MODID, "amberoot").toString(), AMBEROOT_BLOCK_SET);
}