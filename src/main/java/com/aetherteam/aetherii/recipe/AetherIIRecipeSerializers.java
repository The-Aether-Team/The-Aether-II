...
public class AetherIIRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<MasonryRecipe>> MASONRY = RECIPE_SERIALIZERS.register("masonry", MasonryRecipe.Serializer::new);
}
