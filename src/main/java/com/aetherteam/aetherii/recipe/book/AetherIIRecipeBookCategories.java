...
public class AetherIIRecipeBookCategories {
    ...
    public static final DeferredHolder<RecipeBookCategory, RecipeBookCategory> AMBER_HOURGLASS_ITEMS = RECIPE_BOOK_CATEGORIES.register("amber_hourglass_items", RecipeBookCategory::new);
    public static final DeferredHolder<RecipeBookCategory, RecipeBookCategory> AMBER_HOURGLASS_BLOCKS = RECIPE_BOOK_CATEGORIES.register("amber_hourglass_blocks", RecipeBookCategory::new);
    ...
    public static void registerRecipeBookSearchCategories(RegisterRecipeBookSearchCategoriesEvent event) {
        event.register(AMBER_HOURGLASS_SEARCH, AMBER_HOURGLASS_BLOCKS.get(), AMBER_HOURGLASS_ITEMS.get(), AMBER_HOURGLASS_UNCRAFTING.get());
