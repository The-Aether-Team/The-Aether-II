...
public class IrradiationRecipe extends AbstractBlockStateRecipe implements MatchEventRecipe {
    public static final RecipeSerializer<IrradiationRecipe> SERIALIZER = new BlockStateRecipeSerializer<>(IrradiationRecipe::new);

    public IrradiationRecipe(ResourceLocation id, BlockStateIngredient ingredient, BlockPropertyPair result, @Nullable CommandFunction.CacheableFunction function) {
        super(AetherIIRecipeTypes.DUST_IRRADIATION.get(), id, ingredient, result, function);
    }
