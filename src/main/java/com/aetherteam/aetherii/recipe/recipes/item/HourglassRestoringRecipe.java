...
public class HourglassRestoringRecipe implements Recipe<SingleRecipeInput> {
    ...
    public HourglassRestoringRecipe(String group, AmberHourglassBookCategory category, Ingredient ingredient, NonNullList<ItemStack> results, float experience, int processingTime) {
        this.group = group;
    ...
    public ItemStack assemble(SingleRecipeInput singleRecipeInput, HolderLookup.Provider provider) {
        return this.results.getFirst(); //todo; 3 item output with random variation.
    }
    ...
    public static class Serializer implements RecipeSerializer<HourglassRestoringRecipe> {
        ...
        public Serializer() {
            this.codec = RecordCodecBuilder.mapCodec(instance -> instance.group(
                    ...
                    NonNullList.codecOf(ItemStack.CODEC).fieldOf("results").forGetter(HourglassRestoringRecipe::results),
        ...
        public HourglassRestoringRecipe fromNetwork(RegistryFriendlyByteBuf buffer) {
            ...
            NonNullList<ItemStack> results = ByteBufCodecs.fromCodecWithRegistries(NonNullList.codecOf(ItemStack.CODEC)).decode(buffer);
        ...
        public void toNetwork(RegistryFriendlyByteBuf buffer, HourglassRestoringRecipe recipe) {
            ...
            ByteBufCodecs.fromCodecWithRegistries(NonNullList.codecOf(ItemStack.CODEC)).encode(buffer, recipe.results);
