...
public abstract class AbstractBiomeParameterRecipe extends AbstractBlockStateRecipe {
    ...
    public AbstractBiomeParameterRecipe(RecipeType<? extends AbstractBiomeParameterRecipe> type, ResourceLocation id, Optional<Either<ResourceKey<Biome>, TagKey<Biome>>> biome, BlockStateIngredient ingredient, BlockPropertyPair result, @Nullable CommandFunction.CacheableFunction function) {
