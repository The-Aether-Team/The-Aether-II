...
public class AetherIISurfaceRules {
    ...
    public static DeferredHolder<MapCodec<? extends SurfaceRules.RuleSource>, MapCodec<DensityFunctionPlacementRule>> NOISE_PALETTE_3D = MATERIAL_RULES.register("noise_palette_3d", DensityFunctionPlacementRule.KEY_CODEC::codec);
}