...
public class AetherIITreeDecoratorTypes {
    ...
    public static final DeferredHolder<TreeDecoratorType<?>, TreeDecoratorType<GroundFeatureDecorator>> LEAF_PILE = TREE_DECORATORS.register("leaf_pile", () -> new TreeDecoratorType<>(GroundFeatureDecorator.CODEC));
