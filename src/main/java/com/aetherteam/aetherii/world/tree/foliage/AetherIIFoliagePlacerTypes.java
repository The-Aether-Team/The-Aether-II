...
public class AetherIIFoliagePlacerTypes {
    ...
    public static final DeferredHolder<FoliagePlacerType<?>, FoliagePlacerType<NestSkyrootFoliagePlacer>> NEST_SKYROOT_FOLIAGE_PLACER = FOLIAGE_PLACERS.register("nest_skyroot_foliage_placer", () -> new FoliagePlacerType<>(NestSkyrootFoliagePlacer.CODEC));
