...
public record SentryRuinsProcessorSettings(Holder<StructureProcessorList> roomSettings, Holder<StructureProcessorList> tunnelSettings, Holder<StructureProcessorList> bossSettings) {
    public static final MapCodec<SentryRuinsProcessorSettings> CODEC = RecordCodecBuilder.mapCodec(builder -> builder.group(
        ...
        StructureProcessorType.LIST_CODEC.fieldOf("tunnel_processors").forGetter(SentryRuinsProcessorSettings::tunnelSettings),
