...
public class AetherIIStructureProcessorTypes {
    ...
    public static final DeferredHolder<StructureProcessorType<?>, StructureProcessorType<DensityFunctionGradientProcessor>> DENSITY_FUNCTION_GRADIENT = STRUCTURE_PROCESSOR_TYPES.register("density_function_gradient", () -> () -> DensityFunctionGradientProcessor.CODEC);
