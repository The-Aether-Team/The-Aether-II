...
public class AetherIIStructureProcessorTypes {
    ...
    public static final DeferredHolder<StructureProcessorType<?>, StructureProcessorType<DensityFunctionDegradationProcessor>> DENSITY_FUNCTION_DEGRADATION = STRUCTURE_PROCESSOR_TYPES.register("density_function_degradation", () -> () -> DensityFunctionDegradationProcessor.CODEC);
