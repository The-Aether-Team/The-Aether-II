                    ...
                    if (state.getBlock() instanceof CopyBlock copyBlock) {
                        ...
                        if (tag != null) {
                            ...
                            if (copyState.isPresent() && copyState.equals(Optional.of(inputState))) {
                                CompoundTag outputTag = modifiedBlockInfo.nbt() != null ? modifiedBlockInfo.nbt().copy() : tag.copy();
                                storeBlockState(outputTag, "copy_state", outputState);
                                return new StructureTemplate.StructureBlockInfo(modifiedBlockInfo.pos(), copyBlock.defaultBlockState().setValue(CopyBlock.EMPTY, false), outputTag);
                            }
                        }
                    }
                }
