...
public class AetherIIStructurePieceTypes {
    ...
    public static final DeferredHolder<StructurePieceType, StructurePieceType> GUARDIAN_TREE_STRUCTURE_COVER = register("GTStructureCover", GuardianTreeStructureCover::new);
