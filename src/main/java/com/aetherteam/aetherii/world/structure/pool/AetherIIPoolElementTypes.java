...
public class AetherIIPoolElementTypes {
    ...
    public static final DeferredHolder<StructurePoolElementType<?>, StructurePoolElementType<AetherMineshaftPoolElement>> AETHER_MINESHAFT = POOL_ELEMENTS.register("aether_mineshaft_pool_element", () -> () -> AetherMineshaftPoolElement.CODEC);
}