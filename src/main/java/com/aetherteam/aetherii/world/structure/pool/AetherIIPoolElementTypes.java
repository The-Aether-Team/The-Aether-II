...
public class AetherIIPoolElementTypes {
    ...
    public static final DeferredHolder<StructurePoolElementType<?>, StructurePoolElementType<AetherPoolElement>> ROTATABLE = POOL_ELEMENTS.register("rotatable_pool_element", () -> () -> AetherPoolElement.CODEC);
}