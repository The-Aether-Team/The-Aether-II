...
public class AetherIIPoolElementTypes {
    ...
    public static final DeferredHolder<StructurePoolElementType<?>, StructurePoolElementType<DataPoolElement>> DATA = POOL_ELEMENTS.register("data_pool_element", () -> () -> DataPoolElement.CODEC);
}