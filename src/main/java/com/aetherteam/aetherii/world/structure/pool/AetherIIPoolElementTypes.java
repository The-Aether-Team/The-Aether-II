...
public class AetherIIPoolElementTypes {
    ...
    public static final DeferredHolder<StructurePoolElementType<?>, StructurePoolElementType<GuardianTreeEntrancePoolElement>> ENTRANCE = POOL_ELEMENTS.register("entrance_pool_element", () -> () -> GuardianTreeEntrancePoolElement.CODEC);
}