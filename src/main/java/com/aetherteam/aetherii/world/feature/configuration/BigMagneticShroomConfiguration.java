...
public record BigMagneticShroomConfiguration(BlockStateProvider capProvider, BlockStateProvider bottomCapProvider, BlockStateProvider stemProvider, Optional<Holder<PlacedFeature>> groundFeature, FeatureSize minimumSize, boolean tall) implements FeatureConfiguration {
    public static final Codec<BigMagneticShroomConfiguration> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ...
            PlacedFeature.CODEC.optionalFieldOf("ground_feature").forGetter(BigMagneticShroomConfiguration::groundFeature),
