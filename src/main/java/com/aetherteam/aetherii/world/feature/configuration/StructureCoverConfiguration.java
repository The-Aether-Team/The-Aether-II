...
public record StructureCoverConfiguration(BlockStateProvider block, DensityFunction noise, float radius, int height, float inclineFactor, float scatterFactor) implements FeatureConfiguration {
