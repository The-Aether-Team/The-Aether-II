...
public record NoiseLakeConfiguration(DensityFunction lakeNoise, DensityFunction lakeFloorNoise, DensityFunction lakeBarrierNoise, double noiseStartValue, ConstantInt height, BlockStateProvider underwaterBlock, double coastNoiseStartValue, BlockStateProvider coastBlock, DensityFunction coastNoise, boolean frozen) implements FeatureConfiguration {
