...
public record NoiseLakeConfiguration(DensityFunction lakeNoise, DensityFunction lakeFloorNoise, DensityFunction lakeBarrierNoise, double noiseStartValue, ConstantInt height, BlockStateProvider underwaterBlock, double coastNoiseStartValue, BlockStateProvider coastBlock, DensityFunction coastNoise, NoiseLakeFeature.Type type, boolean frozen) implements FeatureConfiguration {
    public static final Codec<NoiseLakeConfiguration> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ...
            Codec.DOUBLE.fieldOf("coast_noise_start_value").forGetter(NoiseLakeConfiguration::coastNoiseStartValue),
            BlockStateProvider.CODEC.fieldOf("coast_block").forGetter(NoiseLakeConfiguration::coastBlock),
            DensityFunction.HOLDER_HELPER_CODEC.fieldOf("coast_noise").forGetter(NoiseLakeConfiguration::coastNoise),
