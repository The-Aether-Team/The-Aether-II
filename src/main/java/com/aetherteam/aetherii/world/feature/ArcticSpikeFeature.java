...
//
//        BlockPos origin = AbstractCoastFeature.findOrigin(level, pos, AetherIITags.Blocks.ARCTIC_ICE_SPIKE_GENERATES_ON, BlockTags.PLANKS); //todo these should be able to generate on only dirt and stuff
//
//        if (origin != null) {
