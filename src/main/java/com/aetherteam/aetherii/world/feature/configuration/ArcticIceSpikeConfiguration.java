...
public record ArcticIceSpikeConfiguration(BlockStateProvider block, float baseRadius, int additionalRadius, float baseSlopeIntensity, int additionalSlopeIntensity, HolderSet<Block> validBlocks) implements FeatureConfiguration {
    public static final Codec<ArcticIceSpikeConfiguration> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ...
            RegistryCodecs.homogeneousList(Registries.BLOCK).fieldOf("valid_blocks").forGetter(ArcticIceSpikeConfiguration::validBlocks)
