...
public record ArcticIceSpikeConfiguration(BlockStateProvider block, float baseRadius, int additionalRadius, int baseHeight, int additionalHeight, TagKey<Block> validBlocks) implements FeatureConfiguration {
