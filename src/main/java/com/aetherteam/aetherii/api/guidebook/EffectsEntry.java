...
public class EffectsEntry extends GuidebookEntry {
    ...
    public static final Codec<EffectsEntry> DIRECT_CODEC =
            RecordCodecBuilder.create(in -> in.group(
                    ...
                    EffectsEntry.ITEM.mapCodec().codec().listOf().fieldOf("items").forGetter(EffectsEntry::getItems)
    ...
    public static final StreamCodec<FriendlyByteBuf, Holder<EffectsEntry>> STREAM_CODEC = ByteBufCodecs.holderRegistry(AetherIIRegistries.EFFECTS_ENTRY);
    ...
    public static class Mutable extends EffectsEntry implements MutableEntry {
        ...
        public static final StreamCodec<FriendlyByteBuf, EffectsEntry.Mutable> STREAM_CODEC = StreamCodec.composite(
