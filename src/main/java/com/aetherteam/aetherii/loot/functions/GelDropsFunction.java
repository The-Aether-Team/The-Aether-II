...
public class GelDropsFunction extends LootItemConditionalFunction {
    public static final MapCodec<GelDropsFunction> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
    ...
    private GelDropsFunction(List<LootItemCondition> conditions, NumberProvider value) {
        super(conditions);
        this.value = value;
    }
    ...
    @Override
    public LootItemFunctionType<GelDropsFunction> getType() {
