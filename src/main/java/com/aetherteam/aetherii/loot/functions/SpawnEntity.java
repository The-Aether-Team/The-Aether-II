...
public class SpawnEntity extends LootItemConditionalFunction {
    public static final MapCodec<SpawnEntity> CODEC = RecordCodecBuilder.mapCodec(instance -> commonFields(instance)
    ...
    protected SpawnEntity(List<LootItemCondition> conditions, EntityTypePredicate entityType, IntProvider count) {
        super(conditions);
    ...
    public static LootItemConditionalFunction.Builder<?> builder(EntityTypePredicate entityType, IntProvider count) {
        return LootItemConditionalFunction.simpleBuilder((lootItemConditions) -> new SpawnEntity(lootItemConditions, entityType, count));
    }

    @Override
    public LootItemFunctionType getType() {
        return AetherIILootFunctions.SPAWN_ENTITY.get();
    }
}