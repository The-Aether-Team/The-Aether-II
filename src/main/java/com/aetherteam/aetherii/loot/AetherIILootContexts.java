...
public class AetherIILootContexts {
    public static final LootContextParamSet SHEARING = LootContextParamSetsAccessor.callRegister("aether_ii:shearing", (builder) -> builder.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ORIGIN).build());
