...
public class AetherIILoot {
    ...
    private static final ResourceKey<Registry<LootTable>> LOOT_TABLE_REGISTRY = ResourceKey.createRegistryKey(new ResourceLocation("minecraft", "loot_table"));
    public static final Set<ResourceKey<LootTable>> IMMUTABLE_LOOT_TABLES = Collections.unmodifiableSet(LOOT_TABLES);

    public static Set<ResourceLocation> immutableLootTableLocations() {
        Set<ResourceLocation> locations = new HashSet<>();
        LOOT_TABLES.forEach((key) -> locations.add(key.location()));
    ...
    private static ResourceKey<LootTable> register(String id) {
        return register(ResourceKey.create(LOOT_TABLE_REGISTRY, new ResourceLocation(AetherII.MODID, id)));
    }
