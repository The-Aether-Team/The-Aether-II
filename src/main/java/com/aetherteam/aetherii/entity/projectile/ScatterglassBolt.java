...
public class ScatterglassBolt extends AbstractArrow {
    ...
    private ItemStack pickupStack = SCATTERGLASS_BOLT;
    ...
    public ScatterglassBolt(Level level, double x, double y, double z, ItemStack pickupStack, ItemStack weaponStack) {
        super(AetherIIEntityTypes.SCATTERGLASS_BOLT.get(), x, y, z, level);
    ...
    public ScatterglassBolt(Level level, LivingEntity owner, ItemStack pickupStack, ItemStack weaponStack) {
        super(AetherIIEntityTypes.SCATTERGLASS_BOLT.get(), owner, level);
        this.pickupStack = pickupStack.copy();
    }
    ...
    protected ItemStack getPickupItem() {
        return this.pickupStack.isEmpty() ? SCATTERGLASS_BOLT.copy() : this.pickupStack.copy();
    }
}
