...
public class ZephyrWebbingBall extends Fireball implements ItemSupplier {
    ...
    public ZephyrWebbingBall(Level level, LivingEntity shooter, double accelX, double accelY, double accelZ) {
        super(AetherIIEntityTypes.ZEPHYR_WEBBING_BALL.get(), shooter, accelX, accelY, accelZ, level);
        this.setNoGravity(true);
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (entity instanceof LivingEntity livingEntity) {
            if (livingEntity.isBlocking()) {
                ...
                AetherIIDataAttachments.get(livingEntity, AetherIIDataAttachments.EFFECTS_SYSTEM).addBuildup(livingEntity, this, this.getOwner(), EffectBuildupPresets.WEBBED, 425);
            }
        }
    }
