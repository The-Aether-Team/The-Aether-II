...
public class CellingNodeEvaluator extends WalkNodeEvaluator {
    ...
    protected Node findAcceptedNode(int p_263032_, int p_263066_, int p_263105_) {
        Node node = null;
        BlockPathTypes pathtype = this.getCachedBlockType(p_263032_, p_263066_, p_263105_);
    ...
    protected BlockPathTypes getCachedBlockType(int p_192968_, int p_192969_, int p_192970_) {
        return this.pathTypesByPosCache
                .computeIfAbsent(
                        BlockPos.asLong(p_192968_, p_192969_, p_192970_), p_330157_ -> this.getBlockPathType(this.level, p_192968_, p_192969_, p_192970_, this.mob)
                );
    }
