...
public class CellingMoveControl extends MoveControl {
    ...
    public boolean isWalkableUpper() {
        ...
        if (pathnavigation != null) {
            ...
            BlockPos pos = BlockPos.containing(this.mob.getX(), (double) this.mob.getBlockY() + 1, this.mob.getZ());
            if (nodeevaluator != null && nodeevaluator.getBlockPathType(this.mob.level(), pos.getX(), pos.getY(), pos.getZ(), this.mob) != BlockPathTypes.OPEN) {
                return false;
            }
        }
