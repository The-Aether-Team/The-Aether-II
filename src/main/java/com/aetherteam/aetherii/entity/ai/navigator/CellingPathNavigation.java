...
public class CellingPathNavigation extends GroundPathNavigation {
    ...
    @Override
    public boolean canCutCorner(BlockPathTypes p_326808_) {
    ...
    @Override
    protected boolean hasValidPathType(BlockPathTypes p_326937_) {
        return super.hasValidPathType(p_326937_) || p_326937_ == BlockPathTypes.OPEN;
    }
