...
public final class EntityUtil {
    ...
    public static void copyRotations(Entity entity, Entity source) {
        entity.setYRot(Mth.rotLerp(1.0F / 3.0F, source.getYRot(), source.yRotO));
        entity.setXRot(Mth.rotLerp(1.0F / 3.0F, source.getXRot(), source.xRotO));
        entity.setYBodyRot(Mth.rotLerp(1.0F / 3.0F, source.getYRot(), source.yRotO));
        entity.setYHeadRot(Mth.rotLerp(1.0F / 3.0F, source.getYRot(), source.yRotO));
    }
    ...
    public static <T extends Entity> T clone(final T entity) {
        ...
        entity.save(tag);
        Optional<T> newEnt = (Optional<T>) EntityType.create(tag, entity.level());
