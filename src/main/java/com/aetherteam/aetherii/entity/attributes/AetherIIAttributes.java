...
public class AetherIIAttributes {
    ...
    public static final DeferredHolder<Attribute, Attribute> MOA_STRENGTH = ATTRIBUTES.register("moa_strength", () -> new BaseRangedAttribute("attributes.aether_ii.moa_strength", 3.0, 1.0, 1024.0));
    public static final DeferredHolder<Attribute, Attribute> MOA_SPEED = ATTRIBUTES.register("moa_speed", () -> new BaseRangedAttribute("attributes.aether_ii.moa_speed", 3.0, 0.0, 1024.0));
