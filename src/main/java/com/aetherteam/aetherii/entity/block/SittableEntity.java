...
public class SittableEntity extends Entity {
    ...
    protected void addAdditionalSaveData(CompoundTag tag) {
        BlockState.CODEC.encodeStart(NbtOps.INSTANCE, this.blockState).result().ifPresent(value -> tag.put("BlockState", value));
    }

    @Override
    protected void readAdditionalSaveData(CompoundTag tag) {
        this.blockState = tag.contains("BlockState") ? BlockState.CODEC.parse(NbtOps.INSTANCE, tag.get("BlockState")).result().orElse(Blocks.SAND.defaultBlockState()) : Blocks.SAND.defaultBlockState();
    }
