...
public class CarrionSprout extends PlantMob implements PlantCuttingMob {
    ...
    private void handleTrigger(Entity entity) {
        ...
        if (this.isTrapTrigger()) {
            if (entity instanceof LivingEntity livingEntity) {
                livingEntity.forceAddEffect(new MobEffectInstance(AetherIIMobEffects.CARRION_TRAP.get(), 1, 0, false, false, false), this);
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_TRAP_ID, false);
        this.entityData.define(DATA_TRAP_TRIGGER_ID, false);
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide()) {
            ...
            if (LevelUtil.isDarkOutside(this.level()) && !this.isTrapState()) {
                this.setTrapState(true);
            } else if (LevelUtil.isBrightOutside(this.level()) && this.isTrapState()) {
