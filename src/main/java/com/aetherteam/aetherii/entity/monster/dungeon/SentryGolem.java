...
public class SentryGolem extends PathfinderMob implements RangedAttackMob, CooldownEntity, FakeShiftEntity {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_RANGED_ID, false);
    }
    ...
    public void handleEntityEvent(byte p_21375_) {
        if (p_21375_ == 4) {
            ...
            this.cooldowns.addCooldown(this.getMainHandItem().getItem(), 60);
        } else {
    ...
    @Override
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnReason, @org.jetbrains.annotations.Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag dataTag) {
        SpawnGroupData data = super.finalizeSpawn(level, difficulty, spawnReason, spawnGroupData, dataTag);
    ...
    protected void populateDefaultEquipmentSlots(RandomSource random, DifficultyInstance difficulty) {
        ItemStack weapon = new ItemStack(AetherIIItems.HAMMER_OF_DEMOLITION.get());
    ...
    public void performRangedAttack(LivingEntity target, float distance) {
        ...
        this.cooldowns.addCooldown(this.getMainHandItem().getItem(), 40);
    ...
    public static class ThrowExplosiveAttackGoal extends Goal {
        ...
        public void tick() {
            ...
            if (this.golem.cooldowns.isOnCooldown(this.golem.getMainHandItem().getItem())) {
            ...
            if (this.attackTime <= 0 && !this.golem.cooldowns.isOnCooldown(this.golem.getMainHandItem().getItem()) && distance <= (double) this.maxAttackRange && canSee) {
