...
public class Taegore extends AetherAnimal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new TaegorePanicGoal(this, 1.9));
        this.goalSelector.addGoal(2, new BreedGoal(this, 1.0));
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.2, Ingredient.of(AetherIITags.Items.TAEGORE_FOOD), false));
        this.goalSelector.addGoal(4, new AvoidEntityGoal<>(this, Player.class, 8.0F, 1.9, 2.2, Entity::isSprinting));
