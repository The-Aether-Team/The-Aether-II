...
public class FlyingCow extends WingedAnimal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, Ingredient.of(AetherIITags.Items.FLYING_COW_TEMPTATION_ITEMS), false));
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(AetherIITags.Items.FLYING_COW_TEMPTATION_ITEMS);
    }
