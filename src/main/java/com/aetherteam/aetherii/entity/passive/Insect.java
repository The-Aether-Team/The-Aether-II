...
public class Insect extends PathfinderMob {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_REST, false);
    }
    ...
    public static boolean checkInsectSpawnRules(EntityType<? extends Insect> animal, LevelAccessor level, MobSpawnType spawnReason, BlockPos pos, RandomSource random) {
    ...
    public void addAdditionalSaveData(CompoundTag tag) {
        ...
        tag.putBoolean("Rest", this.isRest());
        tag.putBoolean("need_rest", this.isNeedRest());
        tag.putInt("next_action", this.needNextAction);
    }

    @Override
    public void readAdditionalSaveData(CompoundTag tag) {
        super.readAdditionalSaveData(tag);
        this.setRest(tag.contains("Rest") ? tag.getBoolean("Rest") : this.isRest());
        this.needRest = tag.contains("need_rest") && tag.getBoolean("need_rest");
        this.needNextAction = tag.contains("next_action") ? tag.getInt("next_action") : this.needNextAction;
    }
