...
public class DiscoveryDescriptionScreen extends Screen {
    private static final AetherIIWidgetSprites ARROW_LEFT_TEXTURES = new AetherIIWidgetSprites(
            new ResourceLocation(AetherII.MODID, "guidebook/arrow_left"),
            new ResourceLocation(AetherII.MODID, "guidebook/arrow_left"));
    private static final AetherIIWidgetSprites ARROW_RIGHT_TEXTURES = new AetherIIWidgetSprites(
            new ResourceLocation(AetherII.MODID, "guidebook/arrow_right"),
            new ResourceLocation(AetherII.MODID, "guidebook/arrow_right"));
    ...
    private AetherIIImageButton previousButton, nextButton;
    ...
    protected void init() {
        ...
        this.previousButton = this.addRenderableWidget(new AetherIIImageButton(this.textPosition - 53, this.height - 28, 16, 16, ARROW_LEFT_TEXTURES, (button) -> {
            if (this.currentPageNumber > 0) {
                this.currentPageNumber--;
            }
        }));
        this.nextButton = this.addRenderableWidget(new AetherIIImageButton(this.textPosition + this.textWidth + 47, this.height - 28, 16, 16, ARROW_RIGHT_TEXTURES, (button) -> {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        com.aetherteam.aetherii.client.gui.AetherIIGuiGraphics.blitSprite(guiGraphics, Guidebook.DESCRIPTION_BORDER_LEFT_SPRITE, this.textPosition - 50, 30, 10, 120);
        com.aetherteam.aetherii.client.gui.AetherIIGuiGraphics.blitSprite(guiGraphics, Guidebook.DESCRIPTION_BORDER_RIGHT_SPRITE, this.textPosition + this.textWidth + 50, 30, 10, 120);
