...
public class HolystoneSmokerScreen extends AbstractRecipeBookScreen<HolystoneSmokerMenu> {
    ...
    public HolystoneSmokerScreen(HolystoneSmokerMenu menu, Inventory inventory, Component title) {
        super(menu, new HolystoneSmokerRecipeBookComponent(menu, TABS), inventory, title);
    }
    ...
    protected void renderBg(GuiGraphicsExtractor guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (this.menu.isLit()) {
            ...
            guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, Identifier.withDefaultNamespace("container/smoker/lit_progress"), 14, 14, 0, 14 - l, i + 56, j + 36 + 14 - l, 14, l);
        }

        int j1 = Mth.ceil(this.menu.getBurnProgress() * 24.0F);
        guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, Identifier.withDefaultNamespace("container/smoker/burn_progress"), 24, 16, 0, 0, i + 79, j + 34, j1, 16);
    }
}