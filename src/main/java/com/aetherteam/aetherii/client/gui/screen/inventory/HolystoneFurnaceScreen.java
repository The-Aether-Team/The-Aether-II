...
public class HolystoneFurnaceScreen extends AbstractFurnaceScreen<HolystoneFurnaceMenu> {
    ...
    private static final ResourceLocation LIT_PROGRESS_TEXTURE = new ResourceLocation("gui/sprites/container/furnace/lit_progress");
    private static final ResourceLocation BURN_PROGRESS_TEXTURE = new ResourceLocation("gui/sprites/container/furnace/burn_progress");
