...
public class GuidebookStatusScreen extends Screen implements Guidebook {
    private static final ResourceLocation GUIDEBOOK_STATUS_LEFT_PAGE_LOCATION = new ResourceLocation(AetherII.MODID, "textures/gui/guidebook/status/guidebook_status_left.png");
    private static final ResourceLocation GUIDEBOOK_STATUS_RIGHT_PAGE_LOCATION = new ResourceLocation(AetherII.MODID, "textures/gui/guidebook/status/guidebook_status_right.png");
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, leftPos + x + xOffset + (width / 2), topPos + y + yOffset + height, 30, (leftPos + x + xOffset + (width / 2)) - this.xMouse, (topPos + y + yOffset + (height / 2)) - this.yMouse, this.minecraft.player);
    ...
    public void renderGuidebookLeftPage(Screen screen, GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        com.aetherteam.aetherii.client.gui.AetherIIGuiGraphics.blitSprite(guiGraphics, Guidebook.HEARTS_SPRITE, x, y + 22, 16, 16);
        ...
        com.aetherteam.aetherii.client.gui.AetherIIGuiGraphics.blitSprite(guiGraphics, Guidebook.ARMOR_SPRITE, x, y + 38, 16, 16);
        ...
        guiGraphics.renderItem(AetherIIItems.GLINT_COIN.get().getDefaultInstance(), x, y + 53);
    ...
    protected void extractMenuBackground(GuiGraphics graphics) {
    }

    protected void extractBlurredBackground(GuiGraphics graphics) {
    }
