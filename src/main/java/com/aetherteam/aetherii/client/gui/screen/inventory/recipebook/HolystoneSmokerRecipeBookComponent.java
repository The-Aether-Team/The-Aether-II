...
public class HolystoneSmokerRecipeBookComponent extends FurnaceRecipeBookComponent {
    ...
    public HolystoneSmokerRecipeBookComponent(AbstractFurnaceMenu menu, List<TabInfo> tabInfos) {
