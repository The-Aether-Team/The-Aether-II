...
public class GuidebookRewardsScreen extends Screen implements Guidebook {
    private static final ResourceLocation GUIDEBOOK_REWARDS_LEFT_PAGE_LOCATION = new ResourceLocation(AetherII.MODID, "textures/gui/guidebook/rewards/guidebook_rewards_left.png");
    private static final ResourceLocation GUIDEBOOK_REWARDS_RIGHT_PAGE_LOCATION = new ResourceLocation(AetherII.MODID, "textures/gui/guidebook/rewards/guidebook_rewards_right.png");
