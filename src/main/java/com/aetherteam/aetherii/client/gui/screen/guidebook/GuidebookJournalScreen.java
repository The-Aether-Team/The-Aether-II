...
public class GuidebookJournalScreen extends Screen implements Guidebook {
    private static final ResourceLocation GUIDEBOOK_JOURNAL_LEFT_PAGE_LOCATION = new ResourceLocation(AetherII.MODID, "textures/gui/guidebook/journal/guidebook_journal_left.png");
    private static final ResourceLocation GUIDEBOOK_JOURNAL_RIGHT_PAGE_LOCATION = new ResourceLocation(AetherII.MODID, "textures/gui/guidebook/journal/guidebook_journal_right.png");
    ...
    protected void extractMenuBackground(GuiGraphics partialTick) { }

    protected void extractBlurredBackground(GuiGraphics guiGraphics) { }
