...
public class AudioHooks { //todo creative music override
                ...
                if (!(Minecraft.getInstance().screen instanceof WinScreen)) {
                    if (isAetherBossMusicActive()) {
                        ...
                        if (boss != null && boss.getHealth() > 0) {
                            ...
                            if (bossMusic != null) {
                                musicInfo = new Music(boss.getBossMusic(), volume);
                            }
                        }
                    } else {
                        ...
                        if (Minecraft.getInstance().player.position().y <= 80) {
                            musicInfo = new Music(AETHER_CAVES, volume);
                        } else {
                            if (day) {
                                ...
                                if (optional.isPresent()) {
                                    ...
                                    musicInfo = new Music(optional1.orElse(null), volume);
                                } else {
                                    musicInfo = new Music(Musics.GAME, volume);
                                }
                            } else if (sunset) {
                                musicInfo = new Music(AETHER_SUNSET, volume);
                            } else if (night) {
                                musicInfo = new Music(AETHER_NIGHT, volume);
                            } else if (sunrise) {
                                musicInfo = new Music(AETHER_SUNRISE, volume);
                            }
                        }
                    }
                }
    ...
    public static boolean isAetherBossMusic(Music music) {
        if (music != null && music != null && music.event().getKey() != null) {
