...
public class ArkeniumTalotonEyesLayer extends EyesLayer<LivingEntityRenderState, ArkeniumTalotonModel> {
    ...
    public ArkeniumTalotonEyesLayer(RenderLayerParent<LivingEntityRenderState, ArkeniumTalotonModel> parent) {
        super(parent);
    }
