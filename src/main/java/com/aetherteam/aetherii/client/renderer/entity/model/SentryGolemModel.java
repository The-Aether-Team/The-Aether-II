...
public class SentryGolemModel extends EntityModel<SentryGolemRenderState> implements ArmedModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 23).addBox(-0.5F, -2.0F, -5.0F, 15.0F, 8.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(0, 17).addBox(1.5F, -4.0F, -5.0F, 11.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 12).addBox(5.0F, -3.0F, -1.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(24, 44).addBox(5.0F, 6.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 41).addBox(3.0F, 6.5F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 51).addBox(2.0F, 8.5F, -4.0F, 10.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-7.0F, -0.5F, 0.0F));

        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -3.0F, -4.0F, 7.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, -3.5F, 0.0F));

        PartDefinition left_shoulder = body.addOrReplaceChild("left_shoulder", CubeListBuilder.create(), PartPose.offset(14.0F, 0.0F, 0.0F));
        ...
        PartDefinition right_shoulder = body.addOrReplaceChild("right_shoulder", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(50, 25).mirror().addBox(-2.0F, -1.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(66, 25).mirror().addBox(-1.0F, 4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(17.0F, 1.0F, 0.5F, 0.0873F, 0.0F, -0.1309F));
        ...
        PartDefinition right_arm = body.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(88, 25).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(104, 25).addBox(-1.0F, 4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, 1.0F, 0.5F, 0.0873F, 0.0F, 0.1309F));
        ...
        PartDefinition right_arm_bottom = right_arm.addOrReplaceChild("right_arm_bottom", CubeListBuilder.create().texOffs(88, 34).addBox(-2.5F, -1.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(114, 31).addBox(-2.0F, 6.0F, -1.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(114, 37).addBox(-1.0F, 6.0F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
    ...
    public void setupAnim(SentryGolemRenderState golem) {
        ...
        this.right_leg.xRot = Mth.cos(golem.walkAnimationPos * 0.6662F) * 1.4F * golem.walkAnimationSpeed;
        this.left_leg.xRot = Mth.cos(golem.walkAnimationPos * 0.6662F + Mth.PI) * 1.4F * golem.walkAnimationSpeed;

        AnimationUtils.bobModelPart(this.right_arm, golem.ageInTicks, 1.0F);
        AnimationUtils.bobModelPart(this.left_arm, golem.ageInTicks, -1.0F);
    }
