...
public class GravititeTalutonEyesLayer extends EyesLayer<GravititeTalutonRenderState, GravititeTalutonModel> {
    private static final RenderType GRAVITITE_TALUTON_EYES = RenderTypes.eyes(Identifier.fromNamespaceAndPath(AetherII.MODID, "textures/entity/mobs/gravitite_taluton/gravitite_taluton_eyes.png"));
