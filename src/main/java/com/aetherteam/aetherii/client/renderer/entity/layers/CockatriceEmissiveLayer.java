...
public class CockatriceEmissiveLayer extends EyesLayer<Cockatrice, CockatriceModel> {
    private static final RenderType COCKATRICE_MARKINGS = RenderType.eyes(new ResourceLocation(AetherII.MODID, "textures/entity/mobs/cockatrice/cockatrice_emissive.png"));
