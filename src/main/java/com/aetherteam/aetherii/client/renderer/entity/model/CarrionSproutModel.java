...
public class CarrionSproutModel extends HierarchicalModel<CarrionSprout> {
    ...
    @Override
    public void setupAnim(CarrionSprout entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        if (entity.trapActiveAnimationState.isStarted()) {
            this.flowerRoot.y = 0.5F;
            this.flower.xRot -= 0.45F;
            this.flower2.xRot -= 0.45F;
            this.flower3.xRot -= 0.45F;
            this.flower4.xRot -= 0.45F;
        }
    }
