...
public class MagneticKirridModel extends AbstractKirridModel {
	...
	public MagneticKirridModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_plate_3_r1 = head_plate.addOrReplaceChild("head_plate_3_r1", CubeListBuilder.create().texOffs(41, 64).addBox(2.0F, -10.0F, -1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(13, 64).addBox(-5.0F, -10.0F, -1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(22, 5).addBox(-4.0F, -5.0F, -1.0F, 8.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5672F, 0.0F, 0.0F));
		...
		PartDefinition head_plate_broken = head.addOrReplaceChild("head_plate_broken", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, -2.5F));

		PartDefinition head_plate_3_r2 = head_plate_broken.addOrReplaceChild("head_plate_3_r2", CubeListBuilder.create().texOffs(13, 64).addBox(-5.0F, -10.0F, -1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 120).addBox(-4.0F, -5.0F, -1.0F, 8.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5672F, 0.0F, 0.0F));
