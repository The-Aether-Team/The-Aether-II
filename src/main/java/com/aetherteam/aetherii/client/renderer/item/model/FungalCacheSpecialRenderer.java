...
public class FungalCacheSpecialRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation(AetherII.MODID, "textures/entity/fungal_cache/fungal_cache.png");
    ...
    public record Unbaked(float openness) {
        ...
        public FungalCacheSpecialRenderer bake(EntityModelSet modelSet) {
            return new FungalCacheSpecialRenderer(new FungalCacheModel(modelSet.bakeLayer(AetherIIModelLayers.FUNGAL_CACHE)), this.openness);
        }
    }
}
