...
public class AbandonedBagSpecialRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation(AetherII.MODID, "textures/entity/abandoned_bag/abandoned_bag.png");
    ...
    public record Unbaked(float openness) {
        ...
        public AbandonedBagSpecialRenderer bake(EntityModelSet modelSet) {
            return new AbandonedBagSpecialRenderer(new AbandonedBagModel(modelSet.bakeLayer(AetherIIModelLayers.ABANDONED_BAG)), this.openness);
        }
    }
}
