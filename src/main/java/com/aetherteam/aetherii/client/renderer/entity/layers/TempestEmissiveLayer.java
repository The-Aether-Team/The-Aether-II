...
public class TempestEmissiveLayer extends EyesLayer<Tempest, TempestModel> {
    private static final RenderType TEMPEST_MARKINGS = RenderType.eyes(new ResourceLocation(AetherII.MODID, "textures/entity/mobs/tempest/tempest_emissive.png"));
