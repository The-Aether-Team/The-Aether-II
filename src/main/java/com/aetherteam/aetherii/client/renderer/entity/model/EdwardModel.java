...
public class EdwardModel extends HierarchicalModel<Edward> implements ArmedModel, HeadedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = chest.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
...
//		this.armright1.z = 0.0F;
//		this.armright1.x = -5.0F;
//		this.armleft1.z = 0.0F;
//		this.armleft1.x = 5.0F;
...
//		this.legright1.z = 0.0F;
//		this.legleft1.z = 0.0F;
//		this.legright1.y = 12.0F;
//		this.legleft1.y = 12.0F;
//		this.head.y = 0.0F;
//		this.waist.y = 4.0F;
//		this.armleft1.y = 2.0F;
//		this.armright1.y = 2.0F;

		AnimationUtils.bobModelPart(this.armright1, ageInTicks, -1.0F);
		AnimationUtils.bobModelPart(this.armleft1, ageInTicks, 1.0F);

//		this.hatlayer.copyFrom(this.head);
	}
