...
public class EdwardRenderer extends MobRenderer<Edward, EdwardModel> {
    private static final ResourceLocation EDWARD_TEXTURE = new ResourceLocation(AetherII.MODID, "textures/entity/npcs/edward/edward.png");
    ...
    @Override
    public ResourceLocation getTextureLocation(Edward edward) {
