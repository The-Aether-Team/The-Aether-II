...
public class EmissiveModel extends BlockModelWrapper {
    public EmissiveModel(List<BakedQuad> quads, ModelRenderProperties properties, @Nullable RenderTypes renderTypes) {
    ...
    public record Unbaked(Identifier model) implements ItemModel.Unbaked {
        ...
        public ItemModel bake(ItemModel.BakingContext context) {
            ...
            RenderTypes renderType = renderTypeGroup == null ? null : renderTypeGroup.entity();
