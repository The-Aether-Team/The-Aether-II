...
public class CloudSkiffRenderer extends EntityRenderer<CloudSkiff, CloudSkiffRenderState> {
    ...
    public void extractRenderState(CloudSkiff entity, CloudSkiffRenderState reusedState, float partialTick) {
        ...
        reusedState.steering = Mth.lerp(partialTick, entity.getSteeringOld() * Mth.DEG_TO_RAD, entity.getSteering() * Mth.DEG_TO_RAD);
        reusedState.wingLift = Mth.lerp(partialTick, entity.getWingLiftOld() * Mth.DEG_TO_RAD, entity.getWingLift() * Mth.DEG_TO_RAD);
    }
}
