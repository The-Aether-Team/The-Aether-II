...
import com.aetherteam.aetherii.client.renderer.entity.animation.AerwhaleAnimations;
...
public class AerwhaleModel extends EntityModel<LivingEntityRenderState> {
    ...
    public AerwhaleModel(ModelPart root) {
        super(root);
        this.glideAnimation = AerwhaleAnimations.glide.bake(root);
    ...
    public void setupAnim(LivingEntityRenderState renderState) {
        ...
        this.glideAnimation.applyWalk(renderState.ageInTicks, 1.0F, 1.0F, 1.0F);
    }
}
