...
public class SkephidRenderer<T extends Skephid> extends MobRenderer<T, SkephidModel<T>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(AetherII.MODID, "textures/entity/mobs/skephid/skephid.png");
    ...
    @Override
    protected void setupRotations(T entity, PoseStack poseStack, float ageInTick, float rotationYaw, float partialTicks) {
        float trans = 9F / 16F;
        if (entity.getPose() != Pose.SLEEPING) {
            ...
            super.setupRotations(entity, poseStack, ageInTick, rotationYaw, partialTicks);
        }
    }
