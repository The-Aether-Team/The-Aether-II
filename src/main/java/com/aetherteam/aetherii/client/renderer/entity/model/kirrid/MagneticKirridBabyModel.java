...
public class MagneticKirridBabyModel extends AbstractKirridBabyModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition plate = head.addOrReplaceChild("plate", CubeListBuilder.create().texOffs(1, 0).addBox(-2.5F, -7.0F, -5.3F, 5.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.3203F, 0.0F, 0.0F));
