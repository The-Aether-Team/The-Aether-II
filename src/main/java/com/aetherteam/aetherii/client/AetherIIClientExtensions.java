...
//                poseStack.scale(1.0F, 1.0F, 1.0F + f12 * 0.2F);
    ...
    public static void registerClientItemExtensions(RegisterClientExtensionsEvent event) {
        ...
        event.registerMobEffect(HIDE_EFFECT, AetherIIEffects.NATURAL_CAMOUFLAGE.get(), AetherIIEffects.ELECTRIC_SHOCK.get(), AetherIIEffects.CARRION_TRAP.get(), AetherIIEffects.GRAVITATIONAL_PULL.get());
    }
}
