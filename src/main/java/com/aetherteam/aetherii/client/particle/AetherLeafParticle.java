...
public class AetherLeafParticle extends TextureSheetParticle {
    ...
    public record SkyrootFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double v3, double v4, double v5) {
            return new AetherLeafParticle(clientLevel, x, y, z, this.spriteSet().get(0, 1), (float) 155 / 255, (float) 192 / 255, (float) 109 / 255);
        }
    }
    ...
    public record SkyplaneFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double v3, double v4, double v5) {
            return new AetherLeafParticle(clientLevel, x, y, z, this.spriteSet().get(0, 1), (float) 110 / 255, (float) 121 / 255, (float) 179 / 255);
        }
    }
    ...
    public record SkybirchFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 124 / 255, (float) 169 / 255, (float) 190 / 255);
        }
    }
    ...
    public record SkypineFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 197 / 255, (float) 161 / 255, (float) 216 / 255);
        }
    }
    ...
    public record WisprootFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 158 / 255, (float) 187 / 255, (float) 209 / 255);
        }
    }
    ...
    public record WisptopFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 207 / 255, (float) 188 / 255, (float) 226 / 255);
        }
    }
    ...
    public record GreatrootFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 132 / 255, (float) 148 / 255, (float) 92 / 255);
        }
    }
    ...
    public record GreatoakFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 184 / 255, (float) 151 / 255, (float) 196 / 255);
        }
    }
    ...
    public record GreatboaFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 116 / 255, (float) 117 / 255, (float) 166 / 255);
        }
    }
    ...
    public record AmberootFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 240 / 255, (float) 231 / 255, (float) 101 / 255);
        }
    }
    ...
    public record IrradiatedFactory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AetherLeafParticle(level, x, y, z, this.spriteSet().get(0, 1), (float) 208 / 255, (float) 184 / 255, (float) 109 / 255);
        }
    }
}
