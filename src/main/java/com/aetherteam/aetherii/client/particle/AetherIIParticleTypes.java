...
public class AetherIIParticleTypes {
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<ColorParticleOption>> DART = register("dart", false, ColorParticleOption::codec, ColorParticleOption::streamCodec);
