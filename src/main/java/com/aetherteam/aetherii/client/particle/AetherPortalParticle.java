...
public class AetherPortalParticle extends PortalParticle {
    public AetherPortalParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, TextureAtlasSprite spriteSet) {
        super(level, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed, spriteSet);
    ...
    public record Factory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource randomSource) {
            AetherPortalParticle particle = new AetherPortalParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet().get(randomSource));
            return particle;
        }
    }
}