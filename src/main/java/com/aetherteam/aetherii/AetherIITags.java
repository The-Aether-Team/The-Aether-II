...
public class AetherIITags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> TOOLS_SHIELD = tag("tools/shields");
    ...
    public static class Fluids {
        ...
        private static TagKey<Fluid> tag(String name) {
            return TagKey.create(Registries.FLUID, new ResourceLocation(AetherII.MODID, name));
        }
    }
    ...
    public static class Structures {
        ...
        private static TagKey<Structure> tag(String name) {
            return TagKey.create(Registries.STRUCTURE, new ResourceLocation(AetherII.MODID, name));
        }
    }
    ...
    public static class MobEffects {
        ...
        private static TagKey<MobEffect> tag(String name) {
            return TagKey.create(Registries.MOB_EFFECT, new ResourceLocation(AetherII.MODID, name));
        }
    }
    ...
    public static class SoundEvents {
        ...
        private static TagKey<SoundEvent> tag(String name) {
            return TagKey.create(Registries.SOUND_EVENT, new ResourceLocation(AetherII.MODID, name));
        }
    }
}
