...
public class EntityDart extends Entity implements IProjectile
{
	...
	private static final DataParameter<Byte> DART_TYPE = EntityDataManager.createKey(EntityBolt.class, DataSerializers.BYTE);
	...
	protected void entityInit()
	{
		...
		this.dataManager.register(DART_TYPE, (byte) 0);
	}
	...
	{
		return ItemDartType.fromOrdinal(this.dataManager.get(DART_TYPE));
	}

	public void setDartType(ItemDartType type)
	{
		this.dataManager.set(DART_TYPE, (byte) type.ordinal());
	}
