...
public class EntityBurrukai extends EntityAetherAnimal implements IEntityEyesComponentProvider
{
	...
	public EntityBurrukai(EntityType<? extends AnimalEntity> type, World world)
	{
		super(type, world);
	}
	...
	protected void registerGoals()
	{
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 1.2D, false, Ingredient.fromItems(ItemsAether.brettl_grass)));
	...
	{
		return new EntityBurrukai(EntityTypesAether.BURRUKAI, this.world);
	}

	@Override
	public boolean isBreedingItem(final ItemStack stack)
	{
		return stack.getItem() == ItemsAether.brettl_grass;
	}
