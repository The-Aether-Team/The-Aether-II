...
import com.gildedgames.aether.api.biology.GeneRegion;
...
public class MoaGenePool implements GenePool
{
	...
	private GeneRegion<DataGene<Color>> keratin, feathers, patterns, eyes;
	...
	public void transformFromSeed(int seed)
	{
		...
		this.patterns = new GeneRegion<>("moaBiology.patterns", MoaGenePoolDataSet.PATTERNS.pickRandom(r));
	...
	public List<GeneRegion> getGeneRegions()
	{
		if (this.geneRegions == null)
		{
			...
			this.geneRegions.add(this.patterns);
	...
	public void transformFromParents(int seed, int fatherSeed, int motherSeed)
	{
		...
		this.patterns = new GeneRegion<>("moaBiology.patterns", BiologyUtil.evaluateInheritedGene(r, father.patterns, mother.patterns));
	...
	public GeneRegion<DataGene<Color>> getPatterns()
	{
