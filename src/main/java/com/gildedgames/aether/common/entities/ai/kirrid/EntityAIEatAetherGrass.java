...
public class EntityAIEatAetherGrass extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            return this.entityWorld.getBlockState(blockpos).getBlock() == BlocksAether.tall_aether_grass && this.entityWorld.getBlockState(blockpos.down()).getBlock() == BlocksAether.aether_grass;
        }
    }
    ...
    public void updateTask()
    {
        ...
        if (this.eatingGrassTimer == 4)
        {
            ...
            if (this.entityWorld.getBlockState(blockpos).getBlock() == BlocksAether.tall_aether_grass)
            {
