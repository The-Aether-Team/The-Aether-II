...
public class AIDetonateClose extends EntityAI<EntityLiving>
{
	...
	{
		this.entity().playSound(SoundsAether.detonating, 1.0F,
	...
	public boolean shouldExecute()
	{
		return this.entity().getAttackTarget() != null
				&& this.entity().getAttackTarget().getDistanceToEntity(this.entity()) <= this.distanceRequired;
	}
	...
	public void updateTask()
	{
		...
		{
			this.entity().playSound(SoundsAether.detonate, 1.0F,
					(this.entity().getRNG().nextFloat() - this.entity().getRNG().nextFloat()) * 0.2F + 1.0F);
