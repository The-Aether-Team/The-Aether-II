...
public class BlockAngelstoneBrick extends BlockCustom implements IBlockVariants
{
	...
	public static final PropertyVariant PROPERTY_VARIANT = PropertyVariant.create("variant", NORMAL, BASE_BRICKS, BASE_PILLAR, CAPSTONE_BRICKS, CAPSTONE_PILLAR, FLAGSTONES, KEYSTONE);

	public BlockAngelstoneBrick()
	{
		super(Material.ROCK);
