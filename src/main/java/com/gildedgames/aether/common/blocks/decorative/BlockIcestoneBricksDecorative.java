...
public class BlockIcestoneBricksDecorative extends BlockDecorative
{
	...
	public BlockIcestoneBricksDecorative()
	{
		super(Material.ROCK, BlocksAether.icestone_bricks);
