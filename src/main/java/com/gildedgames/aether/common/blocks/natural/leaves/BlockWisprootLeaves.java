...
public class BlockWisprootLeaves extends BlockColoredLeaves
{
	...
	protected ItemStack getSaplingItem()
	{
		...
		{
			case GREEN:
				return new ItemStack(BlocksAether.aether_wisproot_sapling, 1, BlockAetherWisprootSapling.GREEN.getMeta());
			case BLUE:
				return new ItemStack(BlocksAether.aether_wisproot_sapling, 1, BlockAetherWisprootSapling.BLUE.getMeta());
			case DARK_BLUE:
				return new ItemStack(BlocksAether.aether_wisproot_sapling, 1, BlockAetherWisprootSapling.DARK_BLUE.getMeta());
		}
	...
	{
		return BlocksAether.light_skyroot_log;
	}
}
