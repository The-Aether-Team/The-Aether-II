...
public class BlockAetherPortal extends BlockBreakable
{
	...
	public void randomDisplayTick(World world, BlockPos pos, IBlockState state, Random rand)
	{
		...
		{
			world.playSound(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, Aether.getResourcePath("aeportal.portal"), 0.5F, rand.nextFloat() * 0.4F + 0.8F, false);
		}
	...
	public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity)
	{
		if (entity instanceof EntityPlayerMP)
		{
			...
			int transferToID = player.dimension == Aether.aetherDimId() ? 0 : Aether.aetherDimId();
