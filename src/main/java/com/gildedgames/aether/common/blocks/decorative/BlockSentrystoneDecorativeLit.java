...
public class BlockSentrystoneDecorativeLit extends BlockDecorative
{
	public static final BlockVariant BASE_BRICKS = new BlockVariant(0, "base_bricks"),
			...
			LIGHTSTONE = new BlockVariant(4, "lightstone"),
			KEYSTONE = new BlockVariant(5, "keystone");

	public static final PropertyVariant PROPERTY_VARIANT = PropertyVariant
			.create("variant", BASE_BRICKS, BASE_PILLAR, CAPSTONE_BRICKS, CAPSTONE_PILLAR, LIGHTSTONE, KEYSTONE);

	public BlockSentrystoneDecorativeLit(Block.Properties properties)
	{
		super(properties);
	}
