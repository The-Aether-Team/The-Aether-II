...
public class WorldEvents
{
	...
	public static void onWorldAttachCapabilities(final AttachCapabilitiesEvent<World> event)
	{
		...
		final ISpawnSystem spawnSystem = new SpawnSystem(world, getSpawnHandlers(world));

		event.addCapability(AetherCore.getResource("SpawnSystem"), new SpawnSystemProvider(spawnSystem));
	}

	private static List<ISpawnHandler> getSpawnHandlers(final World world)
	{
	...
	public static void onWorldTick(final WorldTickEvent event)
	{
		if (event.phase == Phase.END)
		{
			...
			if (!world.isRemote)
			{
				final ISpawnSystem system = event.world.getCapability(AetherCapabilities.SPAWN_SYSTEM, null);
