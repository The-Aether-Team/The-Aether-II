...
public class LootDefinitions
{
	...
	public static final LootPool LABYRINTH_FINAL_BOSS = new LootPool()
	{
		...
		Loot[] loot = new Loot[]
		{
			...
			new SingleStackLoot(new ItemStack(ItemsAether.glamoured_holystone_chip)),
			new SingleStackLoot(new ItemStack(ItemsAether.glamoured_zephyr_husk)),
			new SingleStackLoot(new ItemStack(ItemsAether.glamoured_ice_shard)),
			...
			new SingleStackLoot(new ItemStack(ItemsAether.soul_shard)),
			...
			new SingleStackLoot(new ItemStack(ItemsAether.glamoured_aerogel_chip)),
