...
public class BiomeIrradiatedForests extends BiomeAetherBase
{
	...
	public List<WorldDecoration> createBasicDecorations(Random rand)
	{
        ...
        decorations.add(GenUtil.createFlowerDecorations(rand, flowers, Lists.newArrayList(BlocksAether.irradiated_flower.getDefaultState())));
	...
	public List<WorldDecoration> createTreeDecorations(Random rand)
	{
		...
		treeDecorations.add(new WorldDecorationSimple(30, 0.0F, f.TREE, new PositionerSurface(), new BlueprintWorldGen(GenerationAether.AMBEROOT_TREE)));
