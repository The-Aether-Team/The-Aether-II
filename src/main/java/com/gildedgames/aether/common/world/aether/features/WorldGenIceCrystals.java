	...
	public boolean generate(WorldSlice slice, Random rand, BlockPos pos)
	{
		...
		for (int attempts = 0; attempts < 128; attempts++)
		{
			...
			if (slice.isAirBlock(randomPos))
			{
				...
				{
					slice.setBlockState(randomPos, this.crystalState.withProperty(BlockIceCrystal.PROPERTY_VARIANT, BlockIceCrystal.STALAGMITE));
				...
				{
					slice.setBlockState(randomPos, this.crystalState.withProperty(BlockIceCrystal.PROPERTY_VARIANT, BlockIceCrystal.STALACTITE));
