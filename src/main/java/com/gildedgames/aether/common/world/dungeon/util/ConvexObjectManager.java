...
class ConvexObjectManager
{
	...
	{
		this.recycledFaceStack = new Stack<ConvexFace>();
		this.connectorStack = new Stack<FaceConnector>();
		this.emptyBufferStack = new Stack<VertexBuffer>();
		this.deferredFaceStack = new Stack<DeferredFace>();
	}
}