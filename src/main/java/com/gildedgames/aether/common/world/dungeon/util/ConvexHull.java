...
public class ConvexHull
{
	...
	{
		this.fullInput = (List<int[]>) ((ArrayList<int[]>) points).clone();
		this.currentInput = points;
		this.convexHull = new ArrayList<int[]>();
		this.marked = new boolean[points.size()];

		this.convexFaces = new ArrayList<ConvexFace>();
		this.affectedFaceBuffer = new ArrayList<ConvexFace>();
		this.unprocessedFaces = new FaceList();
		this.traverseStack = new Stack<ConvexFace>();
		this.singularVertices = new HashSet<int[]>();
		this.coneFaceBuffer = new ArrayList<DeferredFace>();
	...
	{
		List<int[]> extremes = new ArrayList<int[]>(6);//Get the extremes of the input data
	...
	protected List<int[]> findInitialPoints(List<int[]> extremes)
	{
		...
		List<int[]> initialPoints = new ArrayList<int[]>();
