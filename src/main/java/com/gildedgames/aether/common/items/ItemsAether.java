...
public class ItemsAether
{
	...
	public static void preInit()
	{
		...
		ItemEffects.register(ItemsAether.iron_ring, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(0.5F)));
		ItemEffects.register(ItemsAether.gold_ring, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(0.0F, 1.0F, false)));
		ItemEffects.register(ItemsAether.iron_pendant, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(3.0F)));
		ItemEffects.register(ItemsAether.gold_pendant, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(2.0F, 4.0F, false)));
		ItemEffects.register(ItemsAether.zanite_ring, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(0.5F, 1.0F, true)));
		ItemEffects.register(ItemsAether.zanite_pendant, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(3.0F, 4.0F, false)));
		...
		ItemEffects.register(ItemsAether.bone_ring, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(2.0F)));
		...
		ItemEffects.register(ItemsAether.barbed_iron_ring, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(1.0F)));
		ItemEffects.register(ItemsAether.barbed_gold_ring, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(1.0F, 3.0F, false)));
		...
		ItemEffects.register(ItemsAether.plague_coil, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(2.0F, 6.0F, false)).add(EntityEffects.MODIFY_MAX_HEALTH, new ModifyMaxHealthEffect.Instance(-2.0F)));
		...
		ItemEffects.register(ItemsAether.life_coil, new Effects().add(EntityEffects.MODIFY_MAX_HEALTH, new ModifyMaxHealthEffect.Instance(2.0F)).add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(-4.0F)));
		ItemEffects.register(ItemsAether.iron_barbed_wire, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(0.2F)));
		...
		ItemEffects.register(ItemsAether.bone_shard, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(0.3F)));
		...
		ItemEffects.register(ItemsAether.gold_barbed_wire, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(0.1F, 0.5F, true)));
		...
		ItemEffects.register(ItemsAether.zanite_studded_choker, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(4.0F)));
		...
		ItemEffects.register(ItemsAether.arkenium_studded_choker, new Effects().add(EntityEffects.MODIFY_DAMAGE2, new ModifyDamageEffect.Instance(5.0F)));
