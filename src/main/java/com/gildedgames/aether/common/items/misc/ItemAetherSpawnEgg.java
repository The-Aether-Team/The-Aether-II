...
public class ItemAetherSpawnEgg extends Item
{
	...
	public String getItemStackDisplayName(ItemStack stack)
	{
		...
		if (s1 != null)
		{
			s = s + " " + I18n.translateToLocal("entity.aether." + s1 + ".name");
		}
	...
	{
		if (!EntitiesAether.entityEggs.containsKey(entityID) || entityID == null)
		{
			return null;
		}
		else
		{
			...
			for (int i = 0; i < 1; ++i)
			{
				entity = ItemAetherSpawnEgg.createEntityByID(entityID, worldIn);
	...
	public static Entity createEntityByID(String id, World world)
	{
		...
		try
		{
			...
			if (oclass != null)
			{
				entity = (Entity) oclass.getConstructor(new Class[] { World.class }).newInstance(world);
			}
		}
	...
	{
		for (AetherSpawnEggInfo info : EntitiesAether.entityEggs.values())
		{
			ItemStack itemstack = new ItemStack(itemIn, 1);
			applyEntityIdToItemStack(itemstack, info.getSpawnedID());
