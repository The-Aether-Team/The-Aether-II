...
public class EdisonDialog
{
	...
	public static class Nodes
	{
		...
		public static final IDialogNode BUSY = DialogNodeFactory.build("busy").text("edison.them.busy")
				.closeButton("edison.us.goodbye").flush();

		public static final IDialogNode OUTPOST_START = DialogNodeFactory.build("outpost_start").text("edison.them.outpost_start")
		...
		public static final IDialogNode WHO_ARE_YOU = DialogNodeFactory.build("who_are_you").text("edison.them.who_are_you").backToRootAction().flush();

		public static final IDialogNode WHAT_IS_THIS_PLACE = DialogNodeFactory.build("what_is_this_place").text("edison.them.what_is_this_place")
				.button("edison.us.the_world_were_in", "the_world_were_in")
				.button("edison.us.this_outpost", "this_outpost").flush();

		public static final IDialogNode THE_WORLD_WERE_IN = DialogNodeFactory.build("the_world_were_in").text("edison.them.the_world_were_in", 2).backToRootAction().flush();

		public static final IDialogNode THIS_OUTPOST = DialogNodeFactory.build("this_outpost").text("edison.them.this_outpost", 2).backToRootAction().flush();

		public static final IDialogNode WHY_AM_I_HERE = DialogNodeFactory.build("why_am_i_here").text("edison.them.why_am_i_here", 4).backToRootAction().flush();
