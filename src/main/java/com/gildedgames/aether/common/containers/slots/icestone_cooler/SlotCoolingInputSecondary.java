...
public class SlotCoolingInputSecondary extends SlotOffset
{
    public SlotCoolingInputSecondary(IInventory inventoryIn, int index, int xPosition, int yPosition, int trueIndex)
    {
