...
public class CurrencyAetherInit
{
	...
	public static void onServerAboutToStart()
	{
		...
		c.registerValue(new ItemStack(ItemsAether.secret_skyroot_door_item, 1, OreDictionary.WILDCARD_VALUE),
				c.getValue(new ItemStack(ItemsAether.skyroot_door_item, 1, OreDictionary.WILDCARD_VALUE), ShopCurrencyGilt.class), ShopCurrencyGilt.class);
