...
import com.gildedgames.aether.common.blocks.construction.BlockArkeniumDoor;
...
public class AetherBlockModels
{
	...
	private static void registerStateMappers()
	{
		...
		ModelLoader.setCustomStateMapper(BlocksAether.arkenium_door, new StateMap.Builder().ignore(BlockArkeniumDoor.POWERED).build());
