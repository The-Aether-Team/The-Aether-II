...
public class ModelCarrionSproutLodHigh extends ModelCarrionSproutBase
{
	...
	protected RendererModel bud_base_teeth_1;

	protected RendererModel bud_base_teeth_2;

	protected RendererModel bud_front_teeth_1;

	protected RendererModel bud_front_teeth_2;

	protected RendererModel bud_back_teeth_2;

	protected RendererModel bud_back_teeth_1;

	protected RendererModel bud_left_teeth_2;

	protected RendererModel bud_left_teeth_1;

	protected RendererModel bud_right_teeth_2;

	protected RendererModel bud_right_teeth_1;

	public ModelCarrionSproutLodHigh()
	{
		this.bud_left_teeth_2 = new RendererModel(this, 15, 6);
		this.bud_left_teeth_2.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.bud_left_teeth_2.addBox(-3.0F, -8.0F, 0.0F, 0, 8, 2, 0.0F);
		this.bud_right_teeth_2 = new RendererModel(this, 15, 6);
		this.bud_right_teeth_2.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.bud_right_teeth_2.addBox(-3.0F, -8.0F, 0.0F, 0, 8, 2, 0.0F);
		this.bud_base_teeth_2 = new RendererModel(this, 20, 6);
		...
		this.bud_front_teeth_2 = new RendererModel(this, 15, 6);
