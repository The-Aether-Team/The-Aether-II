...
public class ModelBurrukai extends ModelBaseAether
{
	...
	public ModelBurrukai()
	{
		...
		this.HindLegRightHoofIn.addBox(-0.9F, 20.0F, 0.1F, 3, 2, 3, 0.0F);
		...
		this.HindLegLeftHoofOut.addBox(-2.1F, 20.0F, 0.1F, 3, 2, 3, 0.0F);
		...
		this.TorsoShoulderPlateLeftFront.addBox(7.5F, -7.0F, -0.5F, 4, 12, 11, 0.0F);
		...
		this.HeadAntlerBottomLeft1.addBox(2.5F, 10.0F, -1.5F, 6, 2, 2, 0.0F);
		...
		this.TorsoRear.addBox(-3.5F, 3.0F, 11.0F, 7, 14, 16, 0.0F);
		...
		this.TorsoShoulderPlateRightFront.addBox(-11.5F, -7.0F, -0.5F, 4, 12, 11, 0.0F);
		...
		this.HeadAntlerTopLeft2.addBox(5.0F, -3.0F, -2.0F, 9, 3, 3, 0.0F);
		...
		this.HeadAntlerTopRight1.addBox(-14.0F, 12.0F, -1.5F, 9, 2, 2, 0.0F);
		...
		this.TorsoFrontFurRight.addBox(-9.0F, -2.8F, -1.0F, 18, 10, 13, 0.0F);
		...
		this.HeadAntlerTopLeft1.addBox(5.0F, 12.0F, -1.5F, 9, 2, 2, 0.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity)
	{
		...
		this.HindLegRightCalf.offsetY = leftSwingX / 7f - .1f;
