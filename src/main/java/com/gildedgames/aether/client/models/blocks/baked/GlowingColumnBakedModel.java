...
public class GlowingColumnBakedModel implements IBakedModel
{

	private VertexFormat format;

	private TextureAtlasSprite top, top_overlay, side, side_overlay;

	public GlowingColumnBakedModel(VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter, ResourceLocation top, ResourceLocation side, ResourceLocation top_overlay, ResourceLocation side_overlay)
	{
		this.format = format;

		this.top = bakedTextureGetter.apply(top);
		this.side = bakedTextureGetter.apply(side);

		this.top_overlay = bakedTextureGetter.apply(top_overlay);
		this.side_overlay = bakedTextureGetter.apply(side_overlay);
	}
	...
	@Override
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing sideFacing, long rand)
	{
		if (sideFacing != null)
		{
