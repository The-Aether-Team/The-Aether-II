...
public class ModelFangrin extends EntityModel<EntityFangrin>
{
	private final RendererModel Torso_Front;

	private final RendererModel Torso_Back;
	...
	private final RendererModel Cheek_Right;

	private final RendererModel Cheek_Left;
	...
	private final RendererModel Brow_Right;

	private final RendererModel Brow_Left;

	private final RendererModel Nose_Top;

	private final RendererModel Nose_Bottom;

	private final RendererModel Shell_Front;

	private final RendererModel Shell_Left;

	private final RendererModel Shell_Right;

	private final RendererModel Shell_Top;

	private final RendererModel Shell_Back;

	private final RendererModel Shell_Tail;

	private final RendererModel Back_Leg_Left;

	private final RendererModel Back_Foot_Left;

	private final RendererModel Back_Leg_Right;

	private final RendererModel Back_Foot_Right;

	private final RendererModel Tail_Base;
	...
	public ModelFangrin()
	{
		...
		this.Torso_Front = new RendererModel(this, 32, 13);
		...
		this.Torso_Back = new RendererModel(this, 32, 32);
		...
		this.Left_Leg = new RendererModel(this, 0, 13);
		...
		this.Left_Foot = new RendererModel(this, 0, 22);
		...
		this.Right_Leg = new RendererModel(this, 0, 13);
		...
		this.Right_Foot = new RendererModel(this, 0, 22);
		...
		this.Cheek_Right = new RendererModel(this, 0, 31);
		...
		this.Cheek_Left = new RendererModel(this, 0, 31);
		...
		this.Ear_Right = new RendererModel(this, 58, 3);
		...
		this.Ear_Left = new RendererModel(this, 58, 3);
		...
		this.Jaw = new RendererModel(this, 32, 2);
		...
		this.Brow_Right = new RendererModel(this, 30, 2);
		...
		this.Brow_Left = new RendererModel(this, 30, 2);
		...
		this.Nose_Top = new RendererModel(this, 32, 6);
		...
		this.Nose_Bottom = new RendererModel(this, 34, 8);
		...
		this.Shell_Front = new RendererModel(this, 68, 1);
		...
		this.Shell_Left = new RendererModel(this, 68, 32);
		...
		this.Shell_Right = new RendererModel(this, 68, 32);
		...
		this.Shell_Top = new RendererModel(this, 70, 11);
		...
		this.Shell_Back = new RendererModel(this, 102, 0);
		...
		this.Shell_Tail = new RendererModel(this, 80, 25);
		...
		this.Back_Leg_Left = new RendererModel(this, 14, 13);
		...
		this.Back_Foot_Left = new RendererModel(this, 14, 22);
		...
		this.Back_Leg_Right = new RendererModel(this, 14, 13);
		...
		this.Back_Foot_Right = new RendererModel(this, 14, 22);
		...
		this.Tail_Base = new RendererModel(this, 92, 23);
		...
		this.Tail_End = new RendererModel(this, 94, 32);
	...
	@Override
	public void render(EntityFangrin entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch,
			float scale)
	{
	...
	@Override
	public void setRotationAngles(EntityFangrin entity, float par1, float par2, float par3, float par4, float par5, float par6)
	{
	...
	private void rotateWith(RendererModel base, RendererModel rotating)
	{
