 ...
 */
public class ModelEdisonSitting extends EntityModel<EntityEdison>
{
	public final RendererModel head;

	public final RendererModel scarffront;

	public final RendererModel chest;

	public final RendererModel abdomen;

	public final RendererModel pelvis;

	public final RendererModel belt;

	public final RendererModel leftupperarm;

	public final RendererModel leftforearm;

	public final RendererModel rightupperarm;

	public final RendererModel rightforearm;

	public final RendererModel leftupperleg;

	public final RendererModel leftlowerlef;

	public final RendererModel rightupperleg;

	public final RendererModel rightlowerleg;

	public final RendererModel pouch;

	public final RendererModel vialback;

	public final RendererModel vialfront;
	...
	public ModelEdisonSitting()
	{
		...
		this.earleft = new RendererModel(this, 48, 7);
		...
		this.scarffront = new RendererModel(this, 16, 16);
		...
		this.rightforearm = new RendererModel(this, 0, 64);
		...
		this.rightlowerleg = new RendererModel(this, 0, 85);
		...
		this.chest = new RendererModel(this, 17, 26);
		...
		this.vialback = new RendererModel(this, 12, 101);
		...
		this.pouch = new RendererModel(this, 0, 101);
		...
		this.leftupperleg = new RendererModel(this, 44, 75);
		...
		this.vialfront = new RendererModel(this, 12, 101);
		...
		this.rightupperarm = new RendererModel(this, 0, 56);
		...
		this.abdomen = new RendererModel(this, 20, 37);
		...
		this.leftlowerlef = new RendererModel(this, 36, 85);
		...
		this.leftupperarm = new RendererModel(this, 48, 56);
		...
		this.rightupperleg = new RendererModel(this, 0, 75);
		...
		this.pelvis = new RendererModel(this, 20, 54);
		...
		this.earright = new RendererModel(this, 8, 7);
		...
		this.belt = new RendererModel(this, 18, 47);
		...
		this.leftforearm = new RendererModel(this, 40, 64);
	...
	@Override
	public void render(EntityEdison entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
