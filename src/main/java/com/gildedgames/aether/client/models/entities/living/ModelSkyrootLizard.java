 ...
 */
public class ModelSkyrootLizard extends EntityModel
{
	public RendererModel body;
	public RendererModel neck_1;
	public RendererModel tail_1;
	public RendererModel leg_front_left_1;
	public RendererModel leg_front_right_1;
	public RendererModel leg_back_left_1;
	public RendererModel leg_back_right_1;
	public RendererModel neck_2;
	public RendererModel neck_1_flaps;
	public RendererModel neck_2_flaps;
	public RendererModel head_1;
	public RendererModel head_2;
	public RendererModel earflap_left;
	public RendererModel earflap_right;
	public RendererModel tongue;
	public RendererModel tail_2;
	public RendererModel tail_1_flaps;
	public RendererModel tail_3;
	public RendererModel tail_2_flaps;
	public RendererModel tail_3_flaps;
	public RendererModel leg_front_left_2;
	public RendererModel foot_front_left;
	public RendererModel claw_front_left_1;
	public RendererModel claw_front_left_2;
	public RendererModel claw_front_left_3;
	public RendererModel leg_front_right_2;
	public RendererModel foot_front_right;
	public RendererModel claw_front_right_1;
	public RendererModel claw_front_right_2;
	public RendererModel claw_front_right_3;
	public RendererModel leg_back_left_2;
	public RendererModel foot_back_left;
	public RendererModel claw_back_left_1;
	public RendererModel claw_back_left_2;
	public RendererModel claw_back_left_3;
	public RendererModel leg_front_right_2_1;
	public RendererModel foot_front_right_1;
	public RendererModel claw_front_right_1_1;
	public RendererModel claw_front_right_2_1;
	public RendererModel claw_front_right_3_1;

	public ModelSkyrootLizard() {
		this.textureWidth = 64;
		this.textureHeight = 128;
		this.foot_front_left = new RendererModel(this, 49, 93);
		...
		this.leg_back_right_1 = new RendererModel(this, 0, 21);
		...
		this.foot_back_left = new RendererModel(this, 49, 13);
		...
		this.claw_front_right_2 = new RendererModel(this, 8, 97);
		...
		this.leg_front_left_1 = new RendererModel(this, 42, 84);
		...
		this.tail_1 = new RendererModel(this, 20, 19);
		...
		this.neck_1 = new RendererModel(this, 20, 45);
		...
		this.leg_back_left_1 = new RendererModel(this, 42, 21);
		...
		this.tail_3 = new RendererModel(this, 22, 0);
		...
		this.claw_front_right_3 = new RendererModel(this, 8, 97);
		...
		this.claw_back_left_3 = new RendererModel(this, 50, 11);
		...
		this.tail_2 = new RendererModel(this, 21, 9);
		...
		this.leg_front_right_2_1 = new RendererModel(this, 2, 17);
		...
		this.claw_front_right_2_1 = new RendererModel(this, 8, 11);
		...
		this.tongue = new RendererModel(this, 24, 84);
		this.tongue.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.tongue.addBox(-1.5F, 0.5F, -10.5F, 3, 0, 5, 0.0F);
		this.claw_front_left_2 = new RendererModel(this, 50, 97);
		...
		this.head_2 = new RendererModel(this, 22, 76);
		...
		this.claw_front_right_3_1 = new RendererModel(this, 8, 11);
		...
		this.body = new RendererModel(this, 14, 30);
		this.body.setRotationPoint(0.0F, 21.0F, 0.0F);
		this.body.addBox(-3.0F, 0.0F, -6.0F, 6, 3, 12, 0.0F);
		this.leg_front_left_2 = new RendererModel(this, 44, 89);
		...
		this.claw_front_left_3 = new RendererModel(this, 50, 97);
		...
		this.claw_back_left_2 = new RendererModel(this, 50, 11);
		...
		this.head_1 = new RendererModel(this, 20, 67);
		this.head_1.setRotationPoint(0.0F, -0.3F, -7.0F);
		this.head_1.addBox(-2.5F, -1.5F, -6.0F, 5, 2, 7, 0.0F);
		this.earflap_right = new RendererModel(this, 14, 69);
		...
		this.foot_front_right = new RendererModel(this, 7, 93);
