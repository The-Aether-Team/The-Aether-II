 ...
 */
public class ModelSwetHead extends EntityModel<EntitySwet>
{
	public final RendererModel InnerBody;

	public final RendererModel OuterBody;

	public final RendererModel TopLeftTail;

	public final RendererModel TopRightTail;

	public final RendererModel BottomRightTail;

	public final RendererModel BottomLeftTail;

	public final RendererModel BackLeftTail;

	public final RendererModel BackRightTail;

	public ModelSwetHead()
	{
		this.textureWidth = 64;
		this.textureHeight = 64;
		this.InnerBody = new RendererModel(this, 0, 20);
		this.InnerBody.setRotationPoint(0.0F, 15.0F, -2.0F);
		this.InnerBody.addBox(-4.0F, -4.0F, -4.0F, 8, 8, 8, 0.25F);
		this.TopRightTail = new RendererModel(this, 40, 0);
		...
		this.BottomLeftTail = new RendererModel(this, 50, 0);
		...
		this.BottomRightTail = new RendererModel(this, 50, 0);
		...
		this.BackRightTail = new RendererModel(this, 50, 0);
		...
		this.BackLeftTail = new RendererModel(this, 50, 0);
	...
	public void render(final EntitySwet entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5)
	{
		...
		GlStateManager.translatef(this.InnerBody.offsetX, this.InnerBody.offsetY, this.InnerBody.offsetZ);
		GlStateManager.translatef(this.InnerBody.rotationPointX * f5, this.InnerBody.rotationPointY * f5, this.InnerBody.rotationPointZ * f5);
		GlStateManager.scalef(0.8f, 0.8f, 0.8f);
		GlStateManager.translatef(-this.InnerBody.offsetX, -this.InnerBody.offsetY, -this.InnerBody.offsetZ);
		GlStateManager.translatef(-this.InnerBody.rotationPointX * f5, -this.InnerBody.rotationPointY * f5, -this.InnerBody.rotationPointZ * f5);

		final float sc = ((entity.getFoodSaturation() - 1));
		...
		GlStateManager.translatef(0, -s * wiggle, (-sc / (float) Math.cos(f5 * 10) * wiggle) / 2);
