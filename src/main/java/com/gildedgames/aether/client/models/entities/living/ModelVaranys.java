...
public class ModelVaranys extends EntityModel<EntityVaranys>
{
	public final RendererModel body;

	public final RendererModel body_front;

	public final RendererModel body_back;

	public final RendererModel leg_front_left_joint;

	public final RendererModel leg_front_right_joint;

	public final RendererModel head_top;

	public final RendererModel head_bottom;

	public final RendererModel teeth_top;

	public final RendererModel cheek_left;

	public final RendererModel cheek_right;

	public final RendererModel forehead;

	public final RendererModel teeth_bottom;

	public final RendererModel crest1;

	public final RendererModel crest3;

	public final RendererModel crest2;

	public final RendererModel tail1;

	public final RendererModel leg_back_left_top;

	public final RendererModel leg_back_right_top;

	public final RendererModel tail2;

	public final RendererModel tail3;

	public final RendererModel tail4;

	public final RendererModel leg_back_left_bottom;

	public final RendererModel foot_back_left_heel;

	public final RendererModel foot_back_left;

	public final RendererModel toe7;

	public final RendererModel toe8;

	public final RendererModel leg_back_left_bottom_1;

	public final RendererModel foot_back_left_heel_1;

	public final RendererModel foot_back_left_1;

	public final RendererModel toe9;

	public final RendererModel toe10;

	public final RendererModel leg_front_left_top;

	public final RendererModel leg_front_left_bottom;

	public final RendererModel foot_front_left;

	public final RendererModel toe1;

	public final RendererModel toe2;

	public final RendererModel toe3;

	public final RendererModel leg_front_right_top;

	public final RendererModel leg_front_right_bottom;

	public final RendererModel foot_front_right;

	public final RendererModel toe4;

	public final RendererModel toe5;

	public final RendererModel toe6;

	public ModelVaranys()
	{
		this.textureWidth = 128;
		this.textureHeight = 128;
		this.toe6 = new RendererModel(this, 44, 41);
		this.toe6.mirror = true;
		this.toe6.setRotationPoint(-1.0F, 0.8F, -5.0F);
		this.toe6.addBox(-0.5F, 0.0F, -1.6F, 1, 1, 3, 0.0F);
		this.setRotateAngle(this.toe6, 0.2617993877991494F, 0.17453292519943295F, 0.0F);
		this.tail4 = new RendererModel(this, 0, 90);
		this.tail4.setRotationPoint(0.0F, 0.0F, 8.0F);
		this.tail4.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 10, 0.0F);
		this.setRotateAngle(this.tail4, 0.17453292519943295F, 0.0F, 0.0F);
		this.body_back = new RendererModel(this, 0, 32);
		this.body_back.setRotationPoint(0.0F, -3.5F, 5.0F);
		this.body_back.addBox(-5.5F, 0.0F, 0.0F, 11, 7, 9, 0.0F);
		this.setRotateAngle(this.body_back, -0.08726646259971647F, 0.0F, 0.0F);
		this.leg_back_left_bottom_1 = new RendererModel(this, 44, 57);
		...
		this.setRotateAngle(this.leg_back_left_bottom_1, 0.4363323129985824F, 0.0F, 0.0F);
		this.body_front = new RendererModel(this, 0, 17);
		this.body_front.setRotationPoint(0.0F, -3.5F, -5.0F);
		this.body_front.addBox(-5.5F, 0.0F, -8.0F, 11, 7, 8, 0.0F);
		this.setRotateAngle(this.body_front, 0.2617993877991494F, 0.0F, 0.0F);
		this.foot_front_left = new RendererModel(this, 44, 26);
		this.foot_front_left.setRotationPoint(0.0F, 7.0F, 0.0F);
		this.foot_front_left.addBox(-2.0F, 0.0F, -5.0F, 4, 2, 5, 0.0F);
		this.foot_back_left_heel_1 = new RendererModel(this, 44, 65);
		...
		this.setRotateAngle(this.foot_back_left_heel_1, -0.4363323129985824F, 0.0F, 0.0F);
		this.tail2 = new RendererModel(this, 0, 63);
		...
		this.head_top = new RendererModel(this, 68, 0);
		this.head_top.setRotationPoint(0.0F, 2.0F, -8.0F);
		this.head_top.addBox(-3.5F, -3.0F, -11.0F, 7, 4, 12, 0.0F);
		this.setRotateAngle(this.head_top, -0.17453292519943295F, 0.0F, 0.0F);
		this.forehead = new RendererModel(this, 68, 16);
		this.forehead.setRotationPoint(0.0F, -3.0F, -7.0F);
		this.forehead.addBox(-4.0F, 0.0F, 0.0F, 8, 2, 7, 0.0F);
		this.setRotateAngle(this.forehead, 0.2617993877991494F, 0.0F, 0.0F);
		this.toe4 = new RendererModel(this, 44, 33);
		this.toe4.mirror = true;
		this.toe4.setRotationPoint(1.0F, 0.5F, -5.0F);
		this.toe4.addBox(-0.5F, 0.0F, -2.5F, 1, 1, 3, 0.0F);
		this.setRotateAngle(this.toe4, 0.2617993877991494F, -0.17453292519943295F, 0.0F);
		this.head_bottom = new RendererModel(this, 68, 33);
		this.head_bottom.setRotationPoint(0.0F, 1.0F, 0.0F);
		this.head_bottom.addBox(-3.0F, 0.0F, -11.0F, 6, 2, 12, 0.0F);
		this.setRotateAngle(this.head_bottom, 0.3490658503988659F, 0.0F, 0.0F);
		this.toe7 = new RendererModel(this, 44, 72);
		this.toe7.setRotationPoint(-0.5F, 0.0F, -2.0F);
		this.toe7.addBox(-1.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(this.toe7, 0.17453292519943295F, 0.0F, 0.0F);
		this.toe8 = new RendererModel(this, 44, 75);
		this.toe8.setRotationPoint(-0.5F, 0.0F, -2.0F);
		this.toe8.addBox(0.0F, 0.0F, -1.0F, 1, 1, 1, 0.0F);
		this.setRotateAngle(this.toe8, 0.2617993877991494F, 0.0F, 0.0F);
		this.leg_front_left_top = new RendererModel(this, 44, 0);
		this.leg_front_left_top.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.leg_front_left_top.addBox(-3.5F, -1.5F, -3.0F, 7, 9, 5, 0.0F);
		this.setRotateAngle(this.leg_front_left_top, 0.0F, -1.5707963267948966F, -0.8726646259971648F);
		this.crest3 = new RendererModel(this, 118, 20);
		this.crest3.setRotationPoint(-2.0F, 0.0F, 5.5F);
		this.crest3.addBox(-2.0F, -3.0F, -1.0F, 2, 3, 2, 0.0F);
		this.setRotateAngle(this.crest3, 0.0F, 0.0F, -0.6981317007977318F);
		this.leg_back_left_bottom = new RendererModel(this, 44, 57);
		this.leg_back_left_bottom.setRotationPoint(2.99F, 6.5F, -1.5F);
		this.leg_back_left_bottom.addBox(-2.0F, 0.0F, 0.0F, 4, 5, 3, 0.0F);
		this.setRotateAngle(this.leg_back_left_bottom, 0.4363323129985824F, 0.0F, 0.0F);
		this.foot_front_right = new RendererModel(this, 44, 26);
		...
		this.setRotateAngle(this.cheek_right, 0.0F, -0.3490658503988659F, 0.0F);
		this.foot_back_left = new RendererModel(this, 44, 69);
		this.foot_back_left.setRotationPoint(0.5F, 0.6F, -2.0F);
		this.foot_back_left.addBox(-1.5F, 0.0F, -2.0F, 3, 1, 2, 0.0F);
		this.setRotateAngle(this.foot_back_left, 0.08726646259971647F, 0.0F, 0.0F);
		this.leg_front_left_joint = new RendererModel(this, 0, 0);
		this.leg_front_left_joint.setRotationPoint(4.5F, -2.0F, -4.0F);
		this.leg_front_left_joint.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F);
		this.setRotateAngle(this.leg_front_left_joint, 0.0F, -0.17453292519943295F, 0.0F);
		this.foot_back_left_1 = new RendererModel(this, 44, 69);
		...
		this.setRotateAngle(this.foot_back_left_1, 0.08726646259971647F, 0.0F, 0.0F);
		this.leg_front_right_top = new RendererModel(this, 44, 0);
		...
		this.setRotateAngle(this.leg_front_right_top, 0.0F, 1.5707963267948966F, 0.8726646259971648F);
		this.leg_front_right_bottom = new RendererModel(this, 44, 14);
		...
		this.toe2 = new RendererModel(this, 44, 37);
		this.toe2.setRotationPoint(0.0F, 0.6F, -5.0F);
		this.toe2.addBox(-0.5F, 0.0F, -2.0F, 1, 1, 3, 0.0F);
		this.setRotateAngle(this.toe2, 0.2617993877991494F, 0.0F, 0.0F);
		this.crest1 = new RendererModel(this, 98, 18);
		this.crest1.setRotationPoint(2.0F, 0.0F, 5.5F);
		this.crest1.addBox(0.0F, -5.0F, -1.0F, 2, 5, 2, 0.0F);
		this.setRotateAngle(this.crest1, 0.0F, 0.0F, 0.6981317007977318F);
		this.leg_back_right_top = new RendererModel(this, 44, 45);
		...
		this.setRotateAngle(this.leg_back_right_top, 0.0F, 0.3490658503988659F, 0.0F);
		this.tail3 = new RendererModel(this, 0, 77);
		this.tail3.setRotationPoint(0.0F, 0.0F, 8.0F);
		this.tail3.addBox(-2.5F, -2.0F, 0.0F, 5, 4, 9, 0.0F);
		this.setRotateAngle(this.tail3, -0.08726646259971647F, 0.0F, 0.0F);
		this.leg_back_left_top = new RendererModel(this, 44, 45);
		this.leg_back_left_top.setRotationPoint(4.9F, 1.9F, 7.4F);
		this.leg_back_left_top.addBox(0.0F, -1.5F, -2.0F, 5, 8, 4, 0.0F);
		this.setRotateAngle(this.leg_back_left_top, 0.0F, -0.3490658503988659F, 0.0F);
		this.toe1 = new RendererModel(this, 44, 33);
		this.toe1.setRotationPoint(-1.0F, 0.5F, -5.0F);
		this.toe1.addBox(-0.5F, 0.0F, -2.5F, 1, 1, 3, 0.0F);
		this.setRotateAngle(this.toe1, 0.2617993877991494F, 0.17453292519943295F, 0.0F);
		this.toe3 = new RendererModel(this, 44, 41);
		this.toe3.setRotationPoint(1.0F, 0.8F, -5.0F);
		this.toe3.addBox(-0.5F, 0.0F, -1.6F, 1, 1, 3, 0.0F);
		this.setRotateAngle(this.toe3, 0.2617993877991494F, -0.17453292519943295F, 0.0F);
		this.teeth_bottom = new RendererModel(this, 68, 59);
	...
	@Override
	public void render(EntityVaranys entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		this.body.render(f5);
	}
	...
	@Override
	public void setRotationAngles(EntityVaranys entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor)
	{
