...
public class ModelLabyrinthTotem extends EntityModel
{
	...
	public final RendererModel Shape5;

	public final RendererModel Shape6;

	public final RendererModel Shape7;

	public final RendererModel Shape8;

	public final RendererModel Shape9;

	public final RendererModel Shape10;

	public final RendererModel Shape11;
	...
	public ModelLabyrinthTotem()
	{
		...
		this.Shape5 = new RendererModel(this, 2, 0);
		...
		this.Shape6 = new RendererModel(this, 2, 28);
		...
		this.Shape7 = new RendererModel(this, 44, 0);
		...
		this.Shape8 = new RendererModel(this, 0, 28);
		...
		this.Shape8.mirror = true;
		this.Shape9 = new RendererModel(this, 0, 28);
		...
		this.Shape10 = new RendererModel(this, 0, 28);
		...
		this.Shape10.mirror = true;
		this.Shape11 = new RendererModel(this, 0, 28);
