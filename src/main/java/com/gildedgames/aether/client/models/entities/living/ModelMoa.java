...
public class ModelMoa extends ModelBase
{
	...
	public ModelMoa()
	{
		...
		this.setRotation(this.Neck1, -0.0174533F, 0F, 0F);
		...
		this.Jaw.addBox(-3F, -1F, -11F, 6, 1, 8);
		this.Jaw.setRotationPoint(0F, -3F, -4F);
		...
		this.Teeth.addBox(-3F, -2F, -11F, 6, 1, 8);
		this.Teeth.setRotationPoint(0F, -3F, -4F);
		...
		this.Head.addBox(-4F, -8F, -12F, 8, 7, 13);
		this.Head.setRotationPoint(0F, -3F, -4F);
		this.Head.setTextureSize(128, 128);
		this.Head.mirror = true;
		this.setRotation(this.Head, 0F, 0F, 0F);
		this.feather4 = new ModelRenderer(this, 20, 29);
		this.feather4.addBox(3F, -5F, 0F, 1, 2, 5);
		this.feather4.setRotationPoint(0F, -3F, -4F);
		...
		this.feather3.addBox(-4F, -8F, 1F, 1, 2, 5);
		this.feather3.setRotationPoint(0F, -3F, -4F);
		...
		this.feather2.addBox(-4F, -5F, 0F, 1, 2, 5);
		this.feather2.setRotationPoint(0F, -3F, -4F);
		...
		this.feather1.addBox(3F, -8F, 1F, 1, 2, 5);
		this.feather1.setRotationPoint(0F, -3F, -4F);
