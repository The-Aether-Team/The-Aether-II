 ...
 */
public class ModelAerwhale extends EntityModel<EntityAerwhale>
{
	public final RendererModel Head;

	public final RendererModel MiddleBody;

	public final RendererModel LeftFin;

	public final RendererModel RightFin;

	public final RendererModel BottomPartHead;

	public final RendererModel MiddleFin;

	public final RendererModel BackBody;

	public final RendererModel BottomPartMiddlebody;

	public final RendererModel FrontBody;

	public final RendererModel BackfinLeft;

	public final RendererModel BackfinRight;

	public ModelAerwhale()
	{
		this.textureWidth = 512;
		this.textureHeight = 64;
		this.BottomPartHead = new RendererModel(this, 116, 28);
		this.BottomPartHead.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.BottomPartHead.addBox(-13.0F, 4.0F, -15.0F, 26, 6, 30, 0.0F);
		this.BackBody = new RendererModel(this, 228, 32);
		this.BackBody.setRotationPoint(2.0F, 5.0F, 25.0F);
		this.BackBody.addBox(-10.5F, -9.0F, -2.0F, 17, 10, 22, 0.0F);
		this.RightFin = new RendererModel(this, 446, 1);
		...
		this.Head = new RendererModel(this, 408, 18);
		this.Head.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Head.addBox(-12.0F, -9.0F, -14.0F, 24, 18, 28, 0.0F);
		this.BackfinLeft = new RendererModel(this, 261, 5);
		...
		this.MiddleFin = new RendererModel(this, 318, 35);
		...
		this.MiddleBody = new RendererModel(this, 314, 25);
	...
	@Override
	public void render(EntityAerwhale entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		this.Head.render(f5);
	}
	...
	@Override
	public void setRotationAngles(EntityAerwhale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor)
	{
