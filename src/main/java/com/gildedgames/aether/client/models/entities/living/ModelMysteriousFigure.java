 ...
 */
public class ModelMysteriousFigure extends EntityModel<EntityMysteriousFigure>
{
	public final RendererModel chest1;

	public final RendererModel chest2;

	public final RendererModel head1;

	public final RendererModel shoulder_right;

	public final RendererModel plumproot;

	public final RendererModel shoulder_left;

	public final RendererModel waist;

	public final RendererModel leg_right;

	public final RendererModel leg_left;

	public final RendererModel boot_right1;

	public final RendererModel boot_right2;

	public final RendererModel boot_right3;

	public final RendererModel boot_left1;

	public final RendererModel boot_left2;

	public final RendererModel boot_left3;

	public final RendererModel head2;

	public final RendererModel arm_right1;

	public final RendererModel arm_right2;

	public final RendererModel arm_right3;

	public final RendererModel sack;

	public final RendererModel sack_handle;

	public final RendererModel arm_left1;

	public final RendererModel arm_left2;

	public final RendererModel arm_left3;

	public ModelMysteriousFigure()
	{
		this.textureWidth = 64;
		this.textureHeight = 64;
		this.shoulder_left = new RendererModel(this, 27, 11);
		...
		this.boot_left2 = new RendererModel(this, 44, 14);
		...
		this.head2 = new RendererModel(this, 0, 6);
		...
		this.arm_left1 = new RendererModel(this, 34, 23);
		...
		this.chest2 = new RendererModel(this, 36, 0);
		...
		this.boot_left3 = new RendererModel(this, 57, 18);
		...
		this.plumproot = new RendererModel(this, 12, 44);
		...
		this.chest1 = new RendererModel(this, 0, 16);
		...
		this.boot_right3 = new RendererModel(this, 57, 18);
		...
		this.arm_right1 = new RendererModel(this, 34, 23);
		...
		this.arm_right2 = new RendererModel(this, 46, 23);
	...
	@Override
	public void render(EntityMysteriousFigure entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
	...
	@Override
	public void setRotationAngles(EntityMysteriousFigure entity, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float scaleFactor)
	{
