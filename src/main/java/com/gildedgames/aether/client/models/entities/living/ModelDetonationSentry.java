...
public class ModelDetonationSentry extends ModelBase
{
	...
	public ModelDetonationSentry()
	{
		...
		this.body_main.addBox(-6F, 13F, -6F, 12, 8, 15);
		...
		this.body_main_top.addBox(-6.5F, 10F, -7F, 13, 3, 17);
		...
		this.body_main_bottom.addBox(-6.5F, 21F, -8F, 13, 3, 18);
		...
		this.body_main_back = new ModelRenderer(this, 0, 0);
		this.body_main_back.addBox(-4F, 7F, -0.5F, 8, 4, 12);
		this.body_main_back.setRotationPoint(0F, 0F, 0F);
		this.body_main_back.setTextureSize(64, 32);
		this.body_main_back.mirror = true;
		this.setRotation(this.body_main_back, -0.2617994F, 0F, 0F);
		...
		this.body_crest_top.addBox(-4.5F, -2F, -1F, 9, 3, 8);
		...
		this.body_crest_left_top.addBox(-1F, -4F, -1F, 10, 7, 2);
		...
		this.body_crest_right_top.addBox(-9F, -4F, -1F, 10, 7, 2);
		...
		this.body_crest_left_bottom.addBox(-0.5F, -2.5F, -0.5F, 6, 8, 2);
		...
		this.body_crest_right_bottom.addBox(-0.5F, -2.5F, -1.5F, 6, 8, 2);
		...
		this.body_bomb_main = new ModelRenderer(this, 0, 0);
		this.body_bomb_main.addBox(-10F, 8F, -14F, 20, 9, 9);
		this.body_bomb_main.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_main.setTextureSize(64, 32);
		this.body_bomb_main.mirror = true;
		this.setRotation(this.body_bomb_main, 0.7853982F, 0F, 0F);
		this.body_bomb_left_corner_top = new ModelRenderer(this, 0, 0);
		this.body_bomb_left_corner_top.addBox(9.5F, 3F, 0.5F, 6, 4, 3);
		this.body_bomb_left_corner_top.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_left_corner_top.setTextureSize(64, 32);
		this.body_bomb_left_corner_top.mirror = true;
		this.setRotation(this.body_bomb_left_corner_top, 0F, 0F, 0.5235988F);
		this.body_bomb_right_corner_top = new ModelRenderer(this, 0, 0);
		this.body_bomb_right_corner_top.addBox(-15.5F, 3F, 0.5F, 6, 4, 3);
		this.body_bomb_right_corner_top.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_right_corner_top.setTextureSize(64, 32);
		this.body_bomb_right_corner_top.mirror = true;
		this.setRotation(this.body_bomb_right_corner_top, 0F, 0F, -0.5235988F);
		this.body_bomb_left_corner_bottom = new ModelRenderer(this, 0, 0);
		this.body_bomb_left_corner_bottom.addBox(-6F, 20F, 0.5F, 6, 4, 3);
		this.body_bomb_left_corner_bottom.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_left_corner_bottom.setTextureSize(64, 32);
		this.body_bomb_left_corner_bottom.mirror = true;
		this.setRotation(this.body_bomb_left_corner_bottom, 0F, 0F, -0.5235988F);
		this.body_bomb_right_corner_bottom = new ModelRenderer(this, 0, 0);
		this.body_bomb_right_corner_bottom.addBox(0F, 20F, 0.5F, 6, 4, 3);
		this.body_bomb_right_corner_bottom.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_right_corner_bottom.setTextureSize(64, 32);
		this.body_bomb_right_corner_bottom.mirror = true;
		this.setRotation(this.body_bomb_right_corner_bottom, 0F, 0F, 0.5235988F);
		this.body_bomb_left_corner_back = new ModelRenderer(this, 0, 0);
		this.body_bomb_left_corner_back.addBox(0.5F, 14F, 8.5F, 6, 3, 4);
		this.body_bomb_left_corner_back.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_left_corner_back.setTextureSize(64, 32);
		this.body_bomb_left_corner_back.mirror = true;
		this.setRotation(this.body_bomb_left_corner_back, 0F, 0.5235988F, 0F);
		this.body_bomb_left_corner_front = new ModelRenderer(this, 0, 0);
		this.body_bomb_left_corner_front.addBox(2.5F, 14F, -9F, 6, 3, 4);
		this.body_bomb_left_corner_front.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_left_corner_front.setTextureSize(64, 32);
		this.body_bomb_left_corner_front.mirror = true;
		this.setRotation(this.body_bomb_left_corner_front, 0F, -0.5235988F, 0F);
		this.body_bomb_right_corner_back = new ModelRenderer(this, 0, 0);
		this.body_bomb_right_corner_back.addBox(-6.5F, 14F, 8.5F, 6, 3, 4);
		this.body_bomb_right_corner_back.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_right_corner_back.setTextureSize(64, 32);
		this.body_bomb_right_corner_back.mirror = true;
		this.setRotation(this.body_bomb_right_corner_back, 0F, -0.5235988F, 0F);
		this.body_bomb_right_corner_front = new ModelRenderer(this, 0, 0);
		this.body_bomb_right_corner_front.addBox(-8.5F, 14F, -9F, 6, 3, 4);
		this.body_bomb_right_corner_front.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_right_corner_front.setTextureSize(64, 32);
		this.body_bomb_right_corner_front.mirror = true;
		this.setRotation(this.body_bomb_right_corner_front, 0F, 0.5235988F, 0F);
		this.body_bomb_left_cap = new ModelRenderer(this, 0, 0);
		this.body_bomb_left_cap.addBox(10F, 9.5F, -12.5F, 1, 6, 6);
		this.body_bomb_left_cap.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_left_cap.setTextureSize(64, 32);
		this.body_bomb_left_cap.mirror = true;
		this.setRotation(this.body_bomb_left_cap, 0.7853982F, 0F, 0F);
		this.body_bomb_right_cap = new ModelRenderer(this, 0, 0);
		this.body_bomb_right_cap.addBox(-11F, 9.5F, -12.5F, 1, 6, 6);
		this.body_bomb_right_cap.setRotationPoint(0F, 0F, 0F);
		this.body_bomb_right_cap.setTextureSize(64, 32);
		this.body_bomb_right_cap.mirror = true;
		this.setRotation(this.body_bomb_right_cap, 0.7853982F, 0F, 0F);
	}
