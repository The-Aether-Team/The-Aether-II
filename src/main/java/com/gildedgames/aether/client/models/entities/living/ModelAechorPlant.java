	...
	public ModelAechorPlant(float f, float f1)
	{
		...
		for (int i = 0; i < petals; i++)
		{
			...
			if (i % 2 == 0)
			{
				...
				this.petal[i].addBox(-4F, -1F, -12F, 8, 1, 9, f - 0.25F);
				this.petal[i].setRotationPoint(0.0F, 1.0F + f1, 0.0F);
			}
			else
			{
				this.petal[i].addBox(-4F, -1F, -13F, 8, 1, 10, f - 0.125F);
				this.petal[i].setRotationPoint(0.0F, 1.0F + f1, 0.0F);
			}

			this.leaf[i] = new ModelRenderer(this, 38, 13);
			this.leaf[i].addBox(-2F, -1F, -9.5F, 4, 1, 8, f - 0.15F);
		...
		for (int i = 0; i < stamens; i++)
		{
			...
			this.stamen[i].addBox(0F, -9F, -1.5F, 1, 6, 1, f - 0.25F);
		...
		this.thorn[0].addBox(-1.75F, 1.25F, -1F, 1, 1, 1, f - 0.25F);
		this.thorn[1].addBox(-1F, 2.25F, 0.75F, 1, 1, 1, f - 0.25F);
		this.thorn[2].addBox(0.75F, 1.25F, 0F, 1, 1, 1, f - 0.25F);
		this.thorn[3].addBox(0F, 2.25F, -1.75F, 1, 1, 1, f - 0.25F);
	}
