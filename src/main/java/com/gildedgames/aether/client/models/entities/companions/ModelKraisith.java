...
public class ModelKraisith extends EntityModel<EntityKraisith>
{
	private final RendererModel Body_Main;

	private final RendererModel Body_Base;

	private final RendererModel Front_Leg_Left;

	private final RendererModel Front_Leg_Right;

	private final RendererModel Back_Leg_Right;

	private final RendererModel Back_Leg_Left;

	private final RendererModel Tail_1;

	private final RendererModel Tail_2;

	private final RendererModel Tail_Spines_1;

	private final RendererModel Tail_Spines_2;

	private final RendererModel Neck;

	private final RendererModel Head_Main;

	private final RendererModel Head_Top_Left;

	private final RendererModel Head_Top_Right;

	private final RendererModel Head_Bottom_Left;

	private final RendererModel Head_Bottom_Right;

	private final RendererModel Body_Stem;

	private final RendererModel Left_Shell_Main;

	private final RendererModel Right_Shell_Main;

	private final RendererModel Left_Shell_Front;

	private final RendererModel Right_Shell_Front;

	private final RendererModel Left_Shell_Back;

	private final RendererModel Right_Shell_Back;

	private final RendererModel Left_Shell_Top;

	private final RendererModel Right_Shell_Top;

	private final RendererModel Left_Shell_Bottom;

	private final RendererModel Right_Shell_Bottom;
	...
	public ModelKraisith()
	{
		...
		this.Body_Main = new RendererModel(this, 50, 28);
		...
		this.Body_Base = new RendererModel(this, 44, 43);
		...
		this.Front_Leg_Left = new RendererModel(this, 65, 57);
		...
		this.Front_Leg_Right = new RendererModel(this, 55, 57);
		...
		this.Back_Leg_Right = new RendererModel(this, 45, 57);
		...
		this.Back_Leg_Left = new RendererModel(this, 75, 57);
		...
		this.Tail_1 = new RendererModel(this, 84, 45);
		...
		this.Tail_2 = new RendererModel(this, 102, 48);
		...
		this.Tail_Spines_1 = new RendererModel(this, 84, 37);
		...
		this.Tail_Spines_2 = new RendererModel(this, 102, 43);
		...
		this.Neck = new RendererModel(this, 58, 15);
		...
		this.Head_Main = new RendererModel(this, 58, 3);
		...
		this.Head_Top_Left = new RendererModel(this, 70, 0);
		...
		this.Head_Top_Right = new RendererModel(this, 48, 0);
		...
		this.Head_Bottom_Left = new RendererModel(this, 70, 9);
		...
		this.Head_Bottom_Right = new RendererModel(this, 48, 9);
		...
		this.Body_Stem = new RendererModel(this, 50, 22);
		...
		this.Left_Shell_Main = new RendererModel(this, 12, 13);
		...
		this.Right_Shell_Main = new RendererModel(this, 12, 13);
		...
		this.Left_Shell_Front = new RendererModel(this, 38, 18);
		...
		this.Right_Shell_Front = new RendererModel(this, 38, 18);
		...
		this.Left_Shell_Back = new RendererModel(this, 0, 18);
		...
		this.Right_Shell_Back = new RendererModel(this, 0, 18);
		...
		this.Left_Shell_Top = new RendererModel(this, 12, 0);
		...
		this.Right_Shell_Top = new RendererModel(this, 12, 0);
		...
		this.Left_Shell_Bottom = new RendererModel(this, 12, 33);
		...
		this.Right_Shell_Bottom = new RendererModel(this, 12, 33);
	...
	@Override
	public void render(EntityKraisith entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch,
			float scale)
	{
	...
	@Override
	public void setRotationAngles(EntityKraisith entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
