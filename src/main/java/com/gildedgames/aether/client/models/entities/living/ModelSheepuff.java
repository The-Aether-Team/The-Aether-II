...
public class ModelSheepuff extends ModelBase
{
	...
	public ModelSheepuff()
	{
		...
		this.headMain = new ModelRenderer(this, 65, 37);
		this.headMain.setRotationPoint(0.0F, -1.6F, -5.9F);
		this.headMain.addBox(-3.5F, -3.5F, -4.0F, 7, 7, 4, 0.0F);
		...
		this.hornLeftCurlBase.setRotationPoint(1.6F, 2.5F, 0.0F);
		...
		this.hornRightCurlBase.setRotationPoint(-2.5F, 2.5F, 0.0F);
