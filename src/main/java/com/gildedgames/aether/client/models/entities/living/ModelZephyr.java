...
public class ModelZephyr extends ModelBase
{
	...
	public ModelZephyr()
	{
		...
		this.setRotateAngle(Head2, 0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotateAngle(Head11, 0.2974288761615753F, -0.0F, 0.0F);
		...
		this.setRotateAngle(BodyShell13, -0.17453292519943295F, 0.08726646259971647F, 0.0F);
		...
		this.setRotateAngle(Head3, 0.7853981852531433F, -0.7853981852531433F, 0.0F);
		...
		this.setRotateAngle(Head4, 0.7853981852531433F, 0.7853981852531433F, 0.0F);
		...
		this.setRotateAngle(Body7, 0.08063421144213803F, 0.33667401270970615F, -0.2778564169174973F);
		...
		this.setRotateAngle(Head6, 0.2617993950843811F, -0.0F, -0.6981316804885863F);
		...
		this.setRotateAngle(MRLeg3, 0.0F, -0.0F, -0.2617993877991494F);
		...
		this.setRotateAngle(BodyShell10, -0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(Head5, 0.2617993950843811F, -0.0F, 0.6981316804885863F);
		this.Jaw3 = new ModelRenderer(this, 0, 21);
		this.Jaw3.setRotationPoint(0.0F, -1.4F, -0.1F);
		this.Jaw3.addBox(0.8F, 0.5F, -1.5F, 0, 3, 3, 0.0F);
		this.setRotateAngle(Jaw3, -0.0F, 0.08726646259971647F, -0.17453292519943295F);
		...
		this.setRotateAngle(Jaw4, 0.0F, -0.08726646259971647F, 0.17453292519943295F);
		...
		this.setRotateAngle(BLLeg2, 0.017453292519943295F, -0.2617993877991494F, 0.7853981633974483F);
		...
		this.setRotateAngle(JawShell4, 0.0F, 0.17453292519943295F, -0.2617993877991494F);
		...
		this.setRotateAngle(Shell5, 0.2617993877991494F, -0.3490658503988659F, -0.3490658503988659F);
		...
		this.setRotateAngle(HeadShell6, -0.08726646259971647F, -0.2617993877991494F, 0.0F);
		...
		this.setRotateAngle(Body6, 0.38034173732879695F, -0.2839675431162167F, -0.6403868480256188F);
		...
		this.setRotateAngle(BodyShell2, -0.2617993877991494F, 0.2617993877991494F, 0.0F);
		...
		this.setRotateAngle(BRLeg1, 0.06684611035138283F, 0.056025068989017976F, 0.08726646259971647F);
		...
		this.setRotateAngle(JawShell2, 0.17453292519943295F, 0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(Shell1, -0.17453292519943295F, 0.17453292519943295F, -0.3490658503988659F);
		...
		this.setRotateAngle(MRLeg1, 0.0F, -0.0F, 0.08726646259971647F);
		...
		this.setRotateAngle(Body8, 0.08063421144213803F, -0.33667401270970615F, 0.2778564169174973F);
		...
		this.setRotateAngle(JawShell1, -0.08726646259971647F, 0.0F, 0.0F);
		...
		this.setRotateAngle(FLLeg1, -0.06981317007977318F, 0.05235987755982988F, 0.08726646259971647F);
		...
		this.setRotateAngle(BodyShell9, -0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(BLLeg1, 0.06981317007977318F, -0.05235987755982988F, 0.08726646259971647F);
		...
		this.setRotateAngle(BodyShell5, -0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(MLLeg3, 0.0F, -0.0F, 0.2617993877991494F);
		...
		this.setRotateAngle(Body5, 0.38034173732879695F, 0.2839675431162167F, 0.6403868480256188F);
		...
		this.setRotateAngle(MLLeg1, 0.0F, -0.0F, 0.08726646259971647F);
		...
		this.setRotateAngle(BodyShell6, -0.2617993877991494F, -0.2617993877991494F, 0.0F);
		...
		this.setRotateAngle(HeadShell2, 0.08726646259971647F, 0.2617993877991494F, 0.2617993877991494F);
		...
		this.setRotateAngle(BRLeg2, 0.017453292519943295F, 0.2617993877991494F, -0.7853981633974483F);
		...
		this.setRotateAngle(Body3, -0.06722259481424472F, -0.3930658138789867F, -0.4751909408299354F);
		...
		this.setRotateAngle(MLLeg2, 0.0F, -0.0F, 0.7853981633974483F);
		...
		this.setRotateAngle(FLLeg3, -0.12217304763960307F, 0.20943951023931953F, 0.2617993877991494F);
		...
		this.setRotateAngle(FRLeg1, -0.06684611035138283F, -0.056025068989017976F, 0.08726646259971647F);
		...
		this.setRotateAngle(BodyShell11, -0.17453292519943295F, -0.08726646259971647F, 0.0F);
		...
		this.setRotateAngle(Shell3, -0.17453292519943295F, -0.17453292519943295F, 0.3490658503988659F);
		...
		this.setRotateAngle(Body2, -0.06722259481424472F, 0.3930658138789867F, 0.4751909408299354F);
		...
		this.setRotateAngle(HeadShell5, -0.08726646259971647F, 0.2617993877991494F, 0.0F);
		...
		this.setRotateAngle(FRLeg2, -0.017453292519943295F, -0.2617993877991494F, -0.7853981633974483F);
		...
		this.setRotateAngle(JawShell3, 0.17453292519943295F, -0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(Head12, 0.2094395160675048F, -0.0F, 0.0F);
		...
		this.setRotateAngle(Head1, 0.43633231520652765F, -0.0F, 0.0F);
		...
		this.setRotateAngle(BodyShell8, 0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(HeadShell3, 0.08726646259971647F, -0.2617993877991494F, -0.2617993877991494F);
		...
		this.setRotateAngle(Shell6, 0.2617993877991494F, 0.3490658503988659F, 0.3490658503988659F);
		...
		this.setRotateAngle(HeadShell4, -0.2792526803190927F, 0.0F, 0.0F);
		...
		this.setRotateAngle(MRLeg2, 0.0F, -0.0F, -0.7853981633974483F);
		...
		this.setRotateAngle(BodyShell4, 0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(FLLeg2, -0.017453292519943295F, 0.2617993877991494F, 0.7853981633974483F);
		...
		this.setRotateAngle(BodyShell12, -0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(BLLeg3, 0.12217304763960307F, -0.20943951023931953F, 0.2617993877991494F);
		...
		this.setRotateAngle(BRLeg3, 0.12217304763960307F, 0.20943951023931953F, -0.2617993877991494F);
		...
		this.setRotateAngle(JawShell5, 0.0F, -0.17453292519943295F, 0.2617993877991494F);
		...
		this.setRotateAngle(FRLeg3, -0.12217304763960307F, -0.20943951023931953F, -0.2617993877991494F);
