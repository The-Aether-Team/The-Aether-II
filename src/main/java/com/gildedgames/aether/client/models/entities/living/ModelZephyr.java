 ...
 */
public class ModelZephyr extends EntityModel<EntityZephyr>
{
	...
	public final RendererModel Jaw1;

	public final RendererModel Head11;

	public final RendererModel Head12;

	public final RendererModel Body1;

	public final RendererModel Body2;

	public final RendererModel Body3;

	public final RendererModel Body4;

	public final RendererModel Body5;

	public final RendererModel Body6;

	public final RendererModel Body7;

	public final RendererModel Body8;

	public final RendererModel FLLeg1;

	public final RendererModel MLLeg1;

	public final RendererModel BLLeg1;

	public final RendererModel FRLeg1;

	public final RendererModel MRLeg1;

	public final RendererModel BRLeg1;

	public final RendererModel Tail1;

	public final RendererModel HeadShell1;

	public final RendererModel HeadShell4;

	public final RendererModel HeadShell2;

	public final RendererModel HeadShell3;

	public final RendererModel HeadShell5;

	public final RendererModel HeadShell6;

	public final RendererModel Jaw2;

	public final RendererModel Jaw3;

	public final RendererModel Jaw4;

	public final RendererModel JawShell1;

	public final RendererModel JawShell2;

	public final RendererModel JawShell3;

	public final RendererModel JawShell4;

	public final RendererModel JawShell5;

	public final RendererModel BodyShell1;

	public final RendererModel Shell1;

	public final RendererModel Shell3;

	public final RendererModel Shell5;

	public final RendererModel Shell6;

	public final RendererModel BodyShell2;

	public final RendererModel BodyShell6;

	public final RendererModel BodyShell3;

	public final RendererModel BodyShell4;

	public final RendererModel BodyShell5;

	public final RendererModel BodyShell7;

	public final RendererModel BodyShell8;

	public final RendererModel BodyShell9;

	public final RendererModel Shell2;

	public final RendererModel Shell4;

	public final RendererModel BodyShell10;

	public final RendererModel BodyShell11;

	public final RendererModel BodyShell12;

	public final RendererModel BodyShell13;

	public final RendererModel FLLeg2;

	public final RendererModel FLLeg3;

	public final RendererModel MLLeg2;

	public final RendererModel MLLeg3;

	public final RendererModel BLLeg2;

	public final RendererModel BLLeg3;

	public final RendererModel FRLeg2;

	public final RendererModel FRLeg3;

	public final RendererModel MRLeg2;

	public final RendererModel MRLeg3;

	public final RendererModel BRLeg2;

	public final RendererModel BRLeg3;

	public final RendererModel Tail2;

	public final RendererModel TailShell1;

	public final RendererModel TailShell2;

	public ModelZephyr()
	{
		this.textureWidth = 124;
		this.textureHeight = 64;
		this.Head2 = new RendererModel(this, 0, 19);
...
//		this.setRotateAngle(this.Head2, 0.2617993950843811F, -0.0F, 0.0F);
		this.Head11 = new RendererModel(this, 0, 14);
		...
		this.BodyShell13 = new RendererModel(this, 101, 4);
		...
		this.Head3 = new RendererModel(this, 0, 12);
		...
		this.Head4 = new RendererModel(this, 0, 12);
		...
		this.Tail1 = new RendererModel(this, 18, 11);
		...
		this.Body7 = new RendererModel(this, 118, 48);
		...
		this.Head6 = new RendererModel(this, 10, 10);
		...
		this.MRLeg3 = new RendererModel(this, 6, 10);
		...
		this.TailShell2 = new RendererModel(this, 32, 44);
		...
		this.Jaw2 = new RendererModel(this, 0, 22);
		...
		this.BodyShell10 = new RendererModel(this, 52, 0);
		...
		this.Head5 = new RendererModel(this, 10, 10);
		...
		this.Jaw3 = new RendererModel(this, 0, 21);
		...
		this.Jaw4 = new RendererModel(this, 0, 21);
		...
		this.BLLeg2 = new RendererModel(this, 6, 8);
		...
		this.JawShell4 = new RendererModel(this, 19, 31);
		...
		this.Shell5 = new RendererModel(this, 0, 52);
		...
		this.HeadShell6 = new RendererModel(this, 108, 41);
		...
		this.Body6 = new RendererModel(this, 32, 0);
		...
		this.BodyShell2 = new RendererModel(this, 36, 35);
		...
		this.BRLeg1 = new RendererModel(this, 0, 8);
		...
		this.Tail2 = new RendererModel(this, 18, 19);
		...
		this.Shell1 = new RendererModel(this, 42, 27);
		...
		this.MRLeg1 = new RendererModel(this, 0, 8);
		...
		this.Body8 = new RendererModel(this, 112, 48);
		...
		this.JawShell1 = new RendererModel(this, 22, 27);
		...
		this.Jaw1 = new RendererModel(this, 3, 19);
		...
		this.Body4 = new RendererModel(this, 18, 7);
		...
		this.FLLeg1 = new RendererModel(this, 0, 8);
		...
		this.BodyShell9 = new RendererModel(this, 108, 19);
		...
		this.BLLeg1 = new RendererModel(this, 0, 8);
		...
		this.BodyShell5 = new RendererModel(this, 108, 19);
		...
		this.MLLeg3 = new RendererModel(this, 6, 10);
		...
		this.Body5 = new RendererModel(this, 32, 0);
		...
		this.BodyShell6 = new RendererModel(this, 36, 35);
		...
		this.HeadShell2 = new RendererModel(this, 0, 33);
		...
		this.BRLeg2 = new RendererModel(this, 6, 8);
		...
		this.Body3 = new RendererModel(this, 18, 0);
		...
		this.MLLeg2 = new RendererModel(this, 6, 8);
		...
		this.FLLeg3 = new RendererModel(this, 6, 10);
		...
		this.FRLeg1 = new RendererModel(this, 0, 8);
		...
		this.BodyShell11 = new RendererModel(this, 101, 4);
		...
		this.Shell3 = new RendererModel(this, 42, 27);
		...
		this.Body2 = new RendererModel(this, 18, 0);
		...
		this.HeadShell5 = new RendererModel(this, 108, 41);
		...
		this.FRLeg2 = new RendererModel(this, 6, 8);
		...
		this.JawShell3 = new RendererModel(this, 22, 35);
		...
		this.Head12 = new RendererModel(this, 32, 8);
		...
		this.HeadShell3 = new RendererModel(this, 0, 33);
		...
		this.Shell6 = new RendererModel(this, 0, 52);
		...
		this.HeadShell4 = new RendererModel(this, 0, 40);
		...
		this.BodyShell4 = new RendererModel(this, 106, 29);
		...
		this.FLLeg2 = new RendererModel(this, 6, 8);
		...
		this.BodyShell12 = new RendererModel(this, 52, 0);
		...
		this.BLLeg3 = new RendererModel(this, 6, 10);
		...
		this.BodyShell7 = new RendererModel(this, 94, 36);
		...
		this.JawShell5 = new RendererModel(this, 19, 31);
		...
		this.FRLeg3 = new RendererModel(this, 6, 10);
	...
	@Override
	public void render(final EntityZephyr entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5)
	{
		...
		GlStateManager.translatef(0.025f, -1.35f,0);
