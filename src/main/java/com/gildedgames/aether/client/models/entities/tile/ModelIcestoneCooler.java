...
public class ModelIcestoneCooler extends EntityModel
{
	final RendererModel LidBase1;

	final RendererModel LidBase2;

	final RendererModel LidBase3;

	final RendererModel LidBase4;

	final RendererModel LidHingeRight;

	final RendererModel LidHingeLeft;

	final RendererModel LidHandleBarRight;

	final RendererModel LidHandleBarLeft;

	final RendererModel LidHandle;

	final RendererModel LidTopCenter;

	final RendererModel LidTop1;

	final RendererModel LidTop2;

	final RendererModel LidTop3;

	final RendererModel LidTop4;

	final RendererModel ChamberFront;

	final RendererModel ChamberFrontLeft;

	final RendererModel ChamberFrontRight;

	final RendererModel ChamberBack;

	final RendererModel ChamberBackLeft;

	final RendererModel ChamberBackRight;

	final RendererModel ChamberLeft;

	final RendererModel ChamberRight;

	final RendererModel ChamberBase;

	final RendererModel ChamberAccentFront;

	final RendererModel ChamberAccentBack;

	final RendererModel ChamberAccentLeft;

	final RendererModel ChamberAccentRight;
	...
	public ModelIcestoneCooler()
	{
		...
		this.LidBase1 = new RendererModel(this, 0, 0);
		...
		this.LidBase2 = new RendererModel(this, 0, 0);
		...
		this.LidBase3 = new RendererModel(this, 0, 0);
		...
		this.LidBase4 = new RendererModel(this, 0, 0);
		...
		this.LidHingeRight = new RendererModel(this, 58, 0);
		...
		this.LidHingeLeft = new RendererModel(this, 58, 0);
		...
		this.LidHandleBarRight = new RendererModel(this, 50, 3);
		...
		this.LidHandleBarLeft = new RendererModel(this, 50, 3);
		...
		this.LidHandle = new RendererModel(this, 54, 10);
		...
		this.LidTopCenter = new RendererModel(this, 26, 0);
		...
		this.LidTop1 = new RendererModel(this, 31, 7);
		...
		this.LidTop2 = new RendererModel(this, 31, 7);
		...
		this.LidTop3 = new RendererModel(this, 31, 7);
		...
		this.LidTop4 = new RendererModel(this, 31, 7);
		...
		this.ChamberFront = new RendererModel(this, 0, 15);
		...
		this.ChamberFrontLeft = new RendererModel(this, 0, 15);
		...
		this.ChamberFrontRight = new RendererModel(this, 0, 15);
		...
		this.ChamberBack = new RendererModel(this, 0, 15);
		...
		this.ChamberBackLeft = new RendererModel(this, 0, 15);
		...
		this.ChamberBackRight = new RendererModel(this, 0, 15);
		...
		this.ChamberLeft = new RendererModel(this, 0, 15);
		...
		this.ChamberRight = new RendererModel(this, 0, 15);
		...
		this.ChamberBase = new RendererModel(this, 18, 16);
		...
		this.ChamberAccentFront = new RendererModel(this, 50, 25);
		...
		this.ChamberAccentBack = new RendererModel(this, 50, 25);
		...
		this.ChamberAccentLeft = new RendererModel(this, 50, 25);
		...
		this.ChamberAccentRight = new RendererModel(this, 50, 25);
