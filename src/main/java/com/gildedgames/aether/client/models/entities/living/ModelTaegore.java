...
public class ModelTaegore extends ModelBaseAether
{
	...
	public ModelTaegore() {
		...
		this.LegFrontLeft2.addBox(-2.0F, 1.0F, -0.5F, 3, 11, 3, 0.0F);
		...
		this.LegFrontRight2.addBox(-1.0F, 1.0F, -0.5F, 3, 11, 3, 0.0F);
		...
		this.LegBackRight2.addBox(-0.5F, 2.0F, -0.5F, 3, 8, 3, 0.0F);
		...
		this.LegBackLeft2.addBox(-2.5F, 2.0F, -0.5F, 3, 8, 3, 0.0F);
		...
		this.BodyMain.setRotationPoint(0.0F, -1.0F, 2.0F);
		...
		this.setRotateAngle(LegBackLeft1, -0.31869712141416456F, 0.0F, 0.0F);
