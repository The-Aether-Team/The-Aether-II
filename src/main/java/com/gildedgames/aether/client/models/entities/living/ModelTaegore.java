...
public class ModelTaegore extends ModelBase
{
	...
	public ModelTaegore()
	{
		...
		this.setRotateAngle(this.HeadSnoutRight, 0.29792770331543206F, -0.39112828537192923F, -0.09442231253289324F);
		...
		this.setRotateAngle(this.HeadCrestBase, 0.5026548245743669F, 0.7272786993060372F, 0.35377823937925057F);
		...
		this.setRotateAngle(this.FrontLegLeftToeOut, 0.0F, -0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HeadCrestLeft, 0.2617993877991494F, -0.0F, 0.17453292519943295F);
		...
		this.setRotateAngle(this.HeadRuffRight, 0.0F, -0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.FrontLegRightToeOut, 0.0F, 0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HeadJawBack, -0.12932889757277982F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.HeadBrowLeft, 0.0F, -0.6981317007977318F, 0.0F);
		...
		this.setRotateAngle(this.HeadEarLeft, 0.2617993877991494F, -0.0F, -1.0471975511965976F);
		...
		this.setRotateAngle(this.HeadRuffLeft, 0.0F, 0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HeadBrowRight, 0.0F, 0.6981317007977318F, 0.0F);
		...
		this.setRotateAngle(this.HindLegLeftToeIn, 0.0F, 0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.TorsoFront, 0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.FrontLegLeftToeIn, 0.0F, 0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HindLegRightToeIn, 0.0F, -0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HeadRuffTop, 0.6108652381980153F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.HeadSnoutRidge, 0.8726646259971648F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.HeadEyeLeft, 0.0F, -0.7853981633974483F, 0.0F);
		...
		this.setRotateAngle(this.HeadSnoutLeft, 0.29792770331543206F, 0.39112828537192923F, 0.09442231253289324F);
		...
		this.setRotateAngle(this.HeadCrestRight, 0.2617993877991494F, -0.0F, -0.17453292519943295F);
		...
		this.setRotateAngle(this.HindLegLeftToeOut, 0.0F, -0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HindLegRightToeOut, 0.0F, 0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HeadCrestMiddle, 0.2617993877991494F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.HeadTuskRight, 0.0F, -0.0F, -0.17453292519943295F);
		...
		this.setRotateAngle(this.HeadEarRight, 0.2617993877991494F, -0.0F, 1.0471975511965976F);
		...
		this.setRotateAngle(this.TorsoSpine, -0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.HeadEyeRight, 0.0F, 0.7853981633974483F, 0.0F);
		...
		this.setRotateAngle(this.HeadThroat, -0.11152653920243764F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.HeadTuskLeft, 0.0F, -0.0F, 0.17453292519943295F);
		...
		this.setRotateAngle(this.FrontLegRightToeIn, 0.0F, -0.4363323129985824F, 0.0F);
		...
		this.setRotateAngle(this.HeadSnout, 0.2617993877991494F, -0.0F, 0.0F);
