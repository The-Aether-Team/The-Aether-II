...
public class InventoryContent<E extends NBT> implements ContentFactory<GuiFrame>
{
	...
	public InventoryContent(Inventory<E> inventory, Function<Integer, GuiFrame> slotIconFactory, Function<Integer, GuiFrame> slotOverlayFactory, Function<Integer, SlotParser<E>> slotParserFactory, IconParser<E> iconParser)
	{
