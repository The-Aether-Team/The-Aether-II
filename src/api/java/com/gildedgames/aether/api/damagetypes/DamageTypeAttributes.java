...
{
	public static final IAttribute SLASH_DAMAGE_LEVEL = new RangedAttribute(null, "aether.slashDamageLevel", 0.0D, 0.0D, 2048.0D);

	public static final IAttribute PIERCE_DAMAGE_LEVEL = new RangedAttribute(null, "aether.pierceDamageLevel", 0.0D, 0.0D, 2048.0D);

	public static final IAttribute IMPACT_DAMAGE_LEVEL = new RangedAttribute(null, "aether.impactDamageLevel", 0.0D, 0.0D, 2048.0D);
